-- +=========================================================================+
-- | $Header: fusionapps/fin/gl/bin/GlInterface.ctl /st_fusionapps_pt-v2mib/12 2023/01/13 16:57:47 jenchen Exp $ |
-- +=========================================================================+
...
-- | Bug 34771806 - SUPPORT MULTILINE DESCRIPTIONS (\N) IN IMPORT JOURNALS
...
(
   ...
   REFERENCE1   CHAR(400),
   REFERENCE2   CHAR(960)		  "REPLACE(:REFERENCE2,'\\n','\n')",
   REFERENCE3   CHAR(400),
   REFERENCE4   CHAR(400),
   REFERENCE5   CHAR(960)		  "REPLACE(:REFERENCE5,'\\n','\n')",
   REFERENCE6   CHAR(400),
   REFERENCE7   CHAR(400),
   ...
   GROUP_ID,
   ATTRIBUTE_CATEGORY   CHAR(600)   "REPLACE(:ATTRIBUTE_CATEGORY,'\\n','\n')",
   ATTRIBUTE1           CHAR(600)	"REPLACE(:ATTRIBUTE1,'\\n','\n')",
   ATTRIBUTE2           CHAR(600)	"REPLACE(:ATTRIBUTE2,'\\n','\n')",
   ATTRIBUTE3           CHAR(600)	"REPLACE(:ATTRIBUTE3,'\\n','\n')",
   ATTRIBUTE4           CHAR(600)	"REPLACE(:ATTRIBUTE4,'\\n','\n')",
   ATTRIBUTE5           CHAR(600)	"REPLACE(:ATTRIBUTE5,'\\n','\n')",
   ATTRIBUTE6           CHAR(600)	"REPLACE(:ATTRIBUTE6,'\\n','\n')",
   ATTRIBUTE7           CHAR(600)	"REPLACE(:ATTRIBUTE7,'\\n','\n')",
   ATTRIBUTE8           CHAR(600)	"REPLACE(:ATTRIBUTE8,'\\n','\n')",
   ATTRIBUTE9           CHAR(600)	"REPLACE(:ATTRIBUTE9,'\\n','\n')",
   ATTRIBUTE10           CHAR(600)	"REPLACE(:ATTRIBUTE10,'\\n','\n')",
   ATTRIBUTE11           CHAR(600)	"REPLACE(:ATTRIBUTE11,'\\n','\n')",
   ATTRIBUTE12           CHAR(600)	"REPLACE(:ATTRIBUTE12,'\\n','\n')",
   ATTRIBUTE13           CHAR(600)	"REPLACE(:ATTRIBUTE13,'\\n','\n')",
   ATTRIBUTE14           CHAR(600)	"REPLACE(:ATTRIBUTE14,'\\n','\n')",
   ATTRIBUTE15           CHAR(600)	"REPLACE(:ATTRIBUTE15,'\\n','\n')",
   ATTRIBUTE16           CHAR(600)	"REPLACE(:ATTRIBUTE16,'\\n','\n')",
   ATTRIBUTE17           CHAR(600)	"REPLACE(:ATTRIBUTE17,'\\n','\n')",
   ATTRIBUTE18           CHAR(600)	"REPLACE(:ATTRIBUTE18,'\\n','\n')",
   ATTRIBUTE19           CHAR(600)	"REPLACE(:ATTRIBUTE19,'\\n','\n')",
   ATTRIBUTE20           CHAR(600)	"REPLACE(:ATTRIBUTE20,'\\n','\n')",
   ATTRIBUTE_CATEGORY3   CHAR(600)	"REPLACE(:ATTRIBUTE_CATEGORY3,'\\n','\n')",	
   ...
   GLOBAL_ATTRIBUTE_CATEGORY           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE_CATEGORY,'\\n','\n')",
   GLOBAL_ATTRIBUTE1           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE1,'\\n','\n')",
   GLOBAL_ATTRIBUTE2           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE2,'\\n','\n')",
   GLOBAL_ATTRIBUTE3           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE3,'\\n','\n')",
   GLOBAL_ATTRIBUTE4           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE4,'\\n','\n')",
   GLOBAL_ATTRIBUTE5           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE5,'\\n','\n')",
   GLOBAL_ATTRIBUTE6           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE6,'\\n','\n')",
   GLOBAL_ATTRIBUTE7           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE7,'\\n','\n')",
   GLOBAL_ATTRIBUTE8           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE8,'\\n','\n')",
   GLOBAL_ATTRIBUTE9           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE9,'\\n','\n')",
   GLOBAL_ATTRIBUTE10           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE10,'\\n','\n')",
   GLOBAL_ATTRIBUTE11           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE11,'\\n','\n')",
   GLOBAL_ATTRIBUTE12           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE12,'\\n','\n')",
   GLOBAL_ATTRIBUTE13           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE13,'\\n','\n')",
   GLOBAL_ATTRIBUTE14           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE14,'\\n','\n')",
   GLOBAL_ATTRIBUTE15           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE15,'\\n','\n')",
   GLOBAL_ATTRIBUTE16           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE16,'\\n','\n')",
   GLOBAL_ATTRIBUTE17           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE17,'\\n','\n')",
   GLOBAL_ATTRIBUTE18           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE18,'\\n','\n')",
   GLOBAL_ATTRIBUTE19           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE19,'\\n','\n')",
   GLOBAL_ATTRIBUTE20           CHAR(600) "REPLACE(:GLOBAL_ATTRIBUTE20,'\\n','\n')",
