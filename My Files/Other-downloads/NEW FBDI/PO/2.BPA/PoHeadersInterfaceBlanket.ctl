...
,CAT_ADMIN_AUTH_ENABLED_FLAG    char(1)
,RETRO_PRICE_APPLY_UPDATES_FLAG char(1)
,RETRO_PRICE_COMM_UPDATES_FLAG   char(1)
...
,AGING_PERIOD_DAYS
,AGING_ONSET_POINT            char(30)
,CONSUMPTION_ADVICE_FREQUENCY char(30)
,CONSUMPTION_ADVICE_SUMMARY   char(30)
,DEFAULT_CONSIGNMENT_LINE_FLAG  char(1)
,PAY_ON_USE_FLAG                 char(1)
,BILLING_CYCLE_CLOSING_DATE	"to_date(:BILLING_CYCLE_CLOSING_DATE, 'YYYY/MM/DD')"
...
,USE_ORDER_DATE_IN_PRICING_FLAG	char(1)
,SOURCING_PRIORITY              "fun_load_interface_utils_pkg.replace_decimal_char(:SOURCING_PRIORITY)"
