...
--**
--**
--** FILENAME  :  xxmx_gl_account_transforms_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  --------------------------------------------------
--**   1.0  20-JUL-2023    Shaik Latheef  	 Created GL Account Transforms tables for Maximise.
--** 
--*********************************************************************************************
--**
...
PROMPT *****************************************************************
PROMPT **
PROMPT ** Installing Database Objects for Maximise GL Account Transforms
PROMPT **
PROMPT *****************************************************************
PROMPT
PROMPT
...
--
-- *****************************
-- **GL ACCOUNT TRANSFORMS Table
-- *****************************
CREATE TABLE XXMX_CORE.XXMX_GL_ACCOUNT_TRANSFORMS
   (
	APPLICATION_SUITE            NOT NULL VARCHAR2(5);
	APPLICATION                  NOT NULL VARCHAR2(5);
	BUSINESS_ENTITY              NOT NULL VARCHAR2(100);
	SUB_ENTITY                   NOT NULL VARCHAR2(100);
	...
	CLIENT_COMMENTS                       VARCHAR2(4000);
	XFM_TABLE                             VARCHAR2(100);
	GL_ACCCOUNT_DESC                      VARCHAR2(100);
	STATUS                                VARCHAR2(100);
...
PROMPT ***************************************************************************
PROMPT **                                
PROMPT ** Completed Installing Database Objects for Maximise GL Account Transforms
PROMPT **                                
PROMPT ***************************************************************************
PROMPT
PROMPT
