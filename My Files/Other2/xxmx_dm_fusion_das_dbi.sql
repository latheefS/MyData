...
--**
--**
--** FILENAME  :  xxmx_dm_fusion_das_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  --------------------------------------------
--**   1.0  20-JUL-2023    Shaik Latheef  	 Created Data Access Set tables for Maximise.
--** 
--***************************************************************************************
--**
...
PROMPT ************************************************************
PROMPT **
PROMPT ** Installing Database Objects for Maximise Data Access Sets
PROMPT **
PROMPT ************************************************************
PROMPT
PROMPT
...
--
PROMPT
PROMPT Dropping Table XXMX_DM_FUSION_DAS
PROMPT
--
...
--
PROMPT
PROMPT Creating Table XXMX_DM_FUSION_DAS
PROMPT
--
...
--
-- ***********************
-- **DATA ACCESS SET Table
-- ***********************
CREATE TABLE XXMX_CORE.XXMX_DM_FUSION_DAS
   (
	ACCESS_SET_ID               VARCHAR2(100),
	DAS_NAME                    VARCHAR2(100),
	ACCESS_PRIVILEGE_CODE       VARCHAR2(100),
...
PROMPT **********************************************************************
PROMPT **                                
PROMPT ** Completed Installing Database Objects for Maximise Data Access Sets
PROMPT **                                
PROMPT **********************************************************************
PROMPT
PROMPT
