...
--**
--**
--** FILENAME  :  xxmx_dm_asset_books_in_scope_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  ----------------------------------------
--**   1.0  20-JUL-2023    Shaik Latheef  	 Created Asset Books tables for Maximise.
--** 
--***********************************************************************************
--**
...
PROMPT *******************************************************
PROMPT **
PROMPT ** Installing Database Objects for Maximise Asset Books
PROMPT **
PROMPT *******************************************************
PROMPT
PROMPT
...
--
PROMPT
PROMPT Dropping Table XXMX_DM_ASSET_BOOKS_IN_SCOPE
PROMPT
--
...
--
PROMPT
PROMPT Creating Table XXMX_DM_ASSET_BOOKS_IN_SCOPE
PROMPT
--
...
PROMPT *****************************************************************
PROMPT **                                
PROMPT ** Completed Installing Database Objects for Maximise Asset Books
PROMPT **                                
PROMPT *****************************************************************
PROMPT
PROMPT
