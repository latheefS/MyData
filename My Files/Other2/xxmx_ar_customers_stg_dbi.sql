...
PROMPT
PROMPT
DROP TABLE xxmx_hz_cust_acct_sites_stg;
DROP TABLE xxmx_hz_cust_site_uses_stg;
DROP TABLE xxmx_hz_cust_acct_relate_stg;
DROP TABLE xxmx_hz_party_classifs_stg;
DROP TABLE xxmx_hz_org_contacts_stg;
DROP TABLE xxmx_hz_contact_points_stg;
DROP TABLE xxmx_hz_org_contact_roles_stg;
DROP TABLE xxmx_hz_cust_accounts_stg;
DROP TABLE xxmx_hz_cust_acct_contacts_stg;
DROP TABLE xxmx_iby_cust_bank_accts_stg;
DROP TABLE xxmx_ra_cust_rcpt_methods_stg;
DROP TABLE xxmx_hz_locations_stg;
DROP TABLE xxmx_hz_party_sites_stg;
DROP TABLE xxmx_hz_party_site_uses_stg;
DROP TABLE xxmx_hz_parties_stg;
DROP TABLE xxmx_hz_person_language_stg;
DROP TABLE xxmx_hz_cust_profiles_stg;
DROP TABLE xxmx_hz_relationships_stg;
DROP TABLE xxmx_hz_role_resps_stg;
DROP TABLE xxmx_ar_cust_banks_stg;
...
--------------------------------------------------------
--  DDL for Table xxmx_ar_cust_banks_stg
--------------------------------------------------------
