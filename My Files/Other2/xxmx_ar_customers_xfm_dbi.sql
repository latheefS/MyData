...
--**
--**
--** FILENAME  :  xxmx_ar_customers_xfm_dbi.sql
--**
...
PROMPT
PROMPT
DROP TABLE xxmx_hz_cust_acct_sites_xfm;
DROP TABLE xxmx_hz_cust_site_uses_xfm;
DROP TABLE xxmx_hz_cust_acct_relate_xfm;
DROP TABLE xxmx_hz_party_classifs_xfm;
DROP TABLE xxmx_hz_org_contacts_xfm;
DROP TABLE xxmx_hz_contact_points_xfm;
DROP TABLE xxmx_hz_org_contact_roles_xfm;
DROP TABLE xxmx_hz_cust_accounts_xfm;
DROP TABLE xxmx_hz_cust_acct_contacts_xfm;
DROP TABLE xxmx_iby_cust_bank_accts_xfm;
DROP TABLE xxmx_ra_cust_rcpt_methods_xfm;
DROP TABLE xxmx_hz_locations_xfm;
DROP TABLE xxmx_hz_party_sites_xfm;
DROP TABLE xxmx_hz_party_site_uses_xfm;
DROP TABLE xxmx_hz_parties_xfm;
DROP TABLE xxmx_hz_person_language_xfm;
DROP TABLE xxmx_hz_cust_profiles_xfm;
DROP TABLE xxmx_hz_relationships_xfm;
DROP TABLE xxmx_hz_role_resps_xfm;
DROP TABLE xxmx_ar_cust_banks_xfm;
...
--------------------------------------------------------
--  DDL for Table xxmx_ar_cust_banks_xfm
--------------------------------------------------------
