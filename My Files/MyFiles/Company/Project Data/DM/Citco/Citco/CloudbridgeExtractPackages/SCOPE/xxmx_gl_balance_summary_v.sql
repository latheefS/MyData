...
--**
--**
--** FILENAME  :  xxmx_gl_balance_summary_v.sql
--**
...
--**
  ...
  CREATE OR REPLACE VIEW "XXMX_CORE"."XXMX_GL_BALANCE_SUMMARY_V" ("LEDGER_ID", "PERIOD_NAME", "CURRENCY_CODE", "CODE_COMBINATION_ID", "ENTERED_DR", "ENTERED_CR", "ACCOUNTED_DR", "ACCOUNTED_CR") AS 
