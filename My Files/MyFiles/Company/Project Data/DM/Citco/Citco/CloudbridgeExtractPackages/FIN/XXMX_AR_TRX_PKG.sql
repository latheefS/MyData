...
AS
     ...
     **                                         instead.
	 **  1.15  10-FEB-2021  Shireesha T.R       Commented XFM Procedures 
     **
     ******************************************************************************
     **
...
AS
    ...
    /*      CURSOR StgTable_cur
          ...
          IS
               --
               SELECT  *
               FROM     xxmx_stg.xxmx_ar_trx_lines_stg
          ...
          IS
               ...
               SELECT  migration_set_id
                      ...
                      ,miscellaneous_charge
                      ,commercial_discount
               FROM    xxmx_xfm.xxmx_ar_trx_lines_xfm
               WHERE   1 = 1
	...
	*/		   
     ...
     /*     CURSOR PartiallyPaidTrxs_cur
          ...
          IS
               ...
               FROM      xxmx_xfm.xxmx_ar_trx_lines_xfm   xatlx
                        ,xxmx_core.xxmx_ar_trx_scope_v    xatsv
               WHERE    xatlx.migration_set_id    = pt_MigrationSetID
               AND          xatsv.customer_trx_id     = xatlx.xxmx_customer_trx_id  

	*/		   
			   /* CUSTOMER_TRX_ID Join from STG table to Scope View */
							...
							*/				   
								...
								*/		
                                ...
                                /*        IF   UpdTrxLineAmount_rec.original_line_quantity > 1
                                        ...
                                        --
                                        --
                                        UPDATE xxmx_xfm.xxmx_ar_trx_lines_xfm
	...
	*/ 
    ...
    /*      CURSOR StgTable_cur
          ...
          IS
               ...
               AND     xatsv.customer_trx_id     = xatlx.xxmx_customer_trx_id 
			*/
			/* CUSTOMER_TRX_ID Join from XFM table to Scope View */
            /*   AND     xatsv.partially_paid_flag = 'Y'
          ...
          IS
               ...
               AND       xatdx.migration_set_id          = pt_MigrationSetID
               AND       xatdx.amount                   <> 0
               AND       xatdx.amount                    = xatdx.xxmx_orig_amount
			*/	
			   /* Distribution amount has not been updated previously */
	...
	*/ 
        ...
        /*  CURSOR StgTable_cur
          ...
          IS
               ...
               AND       xatsx.sales_credit_amount_split  = xatsx.xxmx_orig_sc_amount_split 
		*/	   
			   /* Salescredit amount has not been updated previously */
 ...
 */          --
          ...
          */
          ...
          --
          --
          --** DSF 27/10/2020 - Removed Client Schema Name config parameter as schema names will always be "xxmx_stg", "xxmx_xfm" and "xxmx_core".
          /*
     ...
     --
     --
	 --** Commented by Shireesha,this was developed by SMBC
     /* 
     **********************
     ** PROCEDURE: xfm_main
     **********************
