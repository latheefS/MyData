--------------------------------------------------------
--  DDL for Materialized View XXMX_PURCHASE_ORDER_SCOPE_V
--------------------------------------------------------
...
*/
    ...
    ,eligible_PO_types_list
     ...
     FROM    eligible_org_id_list                        eoil
            ...
            ,PO_HEADERS_all@XXMX_EXTRACT       po
     WHERE   1 = 1
  ...
  GRANT SELECT ON "XXMX_CORE"."XXMX_PURCHASE_ORDER_SCOPE_V" TO "XXMX_READONLY";
