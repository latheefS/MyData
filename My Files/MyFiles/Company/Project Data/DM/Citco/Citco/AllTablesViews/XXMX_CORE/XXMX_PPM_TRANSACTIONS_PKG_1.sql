...
--***************************************************************************************************
	...
	*****************************************************************/
    ...
    g_migration_date                          DATE   := '30-NOV-2023'; -- Added by Govardhan on 20Jan23
    gvn_RowCount                              NUMBER;
...
--
        ...
        IS
                 ...
                 --where a.expenditure_item_date <= to_date('30-JUN-2022','DD-MON-YYYY')
                 union 
...
--DELETE costs after cutover period
    ...
    FROM
        ...
        LEFT JOIN xxmx_pa_draft_invoices_all      pdi ON rev.draft_invoice_num = pdi.draft_invoice_num
    ...
    and s.gl_date > to_date('30-NOV-2023');
        ...
        IS
            ...
            from (select distinct          sourcename                 
                  ...
                  where a.BILL_TRNS_AMOUNT <> 0 
                    --and a.completion_date <= to_date('30-JUN-2022','DD-MON-YYYY')
...
and to_date(o.completion_date,'DD-MON-RR')  < to_date('01-NOV-2023')
;
...
--Delete future dated closed AR events. 
    ...
    and   to_date(s.completion_date,'DD-MON-RR')  > to_date('30-NOV-2023');
...
--DELETE all events after cutover period
    ...
    and   s.attribute_date10 > to_date('30-NOV-2023');
...
/*
    ...
    where s.attribute10 = 'BILLING'
    and   s.attribute7 not in ( 'UNBILLED', 'REVACC')
    and s.attribute3 not in (
    select distinct to_char(e.event_id) attribute3
    FROM
        xxmx_pa_events              e
        LEFT JOIN xxmx_pa_draft_invoice_items pdii ON pdii.project_id = e.project_id
                                                    AND pdii.event_num = e.event_num
