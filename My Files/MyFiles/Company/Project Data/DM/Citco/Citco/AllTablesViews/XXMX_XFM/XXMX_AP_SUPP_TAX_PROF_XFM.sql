--------------------------------------------------------
--  DDL for Table XXMX_AP_SUPP_TAX_PROF_XFM
--------------------------------------------------------

  CREATE TABLE "XXMX_XFM"."XXMX_AP_SUPP_TAX_PROF_XFM" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_XFM" ;
  GRANT DELETE ON "XXMX_XFM"."XXMX_AP_SUPP_TAX_PROF_XFM" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_XFM"."XXMX_AP_SUPP_TAX_PROF_XFM" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_XFM"."XXMX_AP_SUPP_TAX_PROF_XFM" TO "XXMX_READONLY";
  GRANT SELECT ON "XXMX_XFM"."XXMX_AP_SUPP_TAX_PROF_XFM" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_XFM"."XXMX_AP_SUPP_TAX_PROF_XFM" TO "XXMX_CORE";
