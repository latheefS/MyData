...
--------------------------------------------------------
  ...
  SELECT
    ...
    FROM
        ...
        xxmx_stg.xxmx_ppm_prj_lbrcost_stg l
    WHERE
        e.expenditure_item_id (+) = l.attribute1
;
  GRANT SELECT ON "XXMX_CORE"."XXMX_PPM_PRJ_LBRCOST_RECON" TO "XXMX_READONLY";
