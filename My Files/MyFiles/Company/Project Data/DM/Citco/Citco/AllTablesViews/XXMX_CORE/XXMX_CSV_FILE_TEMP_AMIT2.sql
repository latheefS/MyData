--------------------------------------------------------
--  DDL for Table XXMX_CSV_FILE_TEMP_AMIT2
--------------------------------------------------------

  CREATE TABLE "XXMX_CORE"."XXMX_CSV_FILE_TEMP_AMIT2" 
   (	"ID" NUMBER(10,0), 
 ...
 LOB ("LINE_CONTENT") STORE AS SECUREFILE (
  ...
  PCTINCREASE 0
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
  GRANT SELECT ON "XXMX_CORE"."XXMX_CSV_FILE_TEMP_AMIT2" TO "XXMX_READONLY";
