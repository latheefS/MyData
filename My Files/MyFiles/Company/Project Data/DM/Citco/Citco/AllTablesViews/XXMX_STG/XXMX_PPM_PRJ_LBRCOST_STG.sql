--------------------------------------------------------
--  DDL for Table XXMX_PPM_PRJ_LBRCOST_STG
--------------------------------------------------------
  ...
  CREATE TABLE "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" 
   (	"FILE_SET_ID" VARCHAR2(30 BYTE), 
	...
	"TRANSACTION_TYPE" VARCHAR2(20 BYTE) DEFAULT 'LABOR', 
	...
	"BILL_GROUP" VARCHAR2(100 BYTE), 
	"AR_INVOICE_NUMBER" VARCHAR2(100 BYTE), 
	"PROJECT_CURRENCY_CODE" VARCHAR2(100 BYTE), 
	"PROJECT_RAW_COST" VARCHAR2(100 BYTE)
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_STG" ;
  GRANT SELECT ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_READONLY";
  GRANT FLASHBACK ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT READ ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE" WITH GRANT OPTION;
  GRANT INSERT ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT ALTER ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_PPM_PRJ_LBRCOST_STG" TO "XXMX_READONLY";
