--------------------------------------------------------
--  DDL for Table XXMX_PER_APL_PEOPLE_F_STG
--------------------------------------------------------

  CREATE TABLE "XXMX_CORE"."XXMX_PER_APL_PEOPLE_F_STG" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
  GRANT SELECT ON "XXMX_CORE"."XXMX_PER_APL_PEOPLE_F_STG" TO "XXMX_READONLY";
