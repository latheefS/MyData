...
--------------------------------------------------------
  ...
  CREATE TABLE "XXMX_XFM"."XXMX_JOBS_F_XFM" 
   (	"MIGRATION_SET_ID" NUMBER, 
	...
	"PROGRESSION_JOB_ID" VARCHAR2(264 BYTE), 
	"EFFECTIVE_START_DATE" DATE, 
	"EFFECTIVE_END_DATE" DATE, 
	"JOB_CODE" VARCHAR2(60 BYTE), 
	"BUSINESS_GROUP_ID" VARCHAR2(264 BYTE), 
	"SET_CODE" VARCHAR2(264 BYTE), 
	"BENCHMARK_JOB_ID" VARCHAR2(264 BYTE), 
	"JOB_FAMILY_ID" VARCHAR2(264 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_XFM" ;
  GRANT ALTER ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_READONLY";
  GRANT SELECT ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT READ ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_XFM"."XXMX_JOBS_F_XFM" TO "XXMX_CORE";
