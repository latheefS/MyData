--------------------------------------------------------
--  DDL for Table XXMX_AP_SUPP_TAX_PROF_STG
--------------------------------------------------------

  CREATE TABLE "XXMX_STG"."XXMX_AP_SUPP_TAX_PROF_STG" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_STG" ;
  GRANT SELECT ON "XXMX_STG"."XXMX_AP_SUPP_TAX_PROF_STG" TO "XXMX_READONLY";
  GRANT SELECT ON "XXMX_STG"."XXMX_AP_SUPP_TAX_PROF_STG" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_STG"."XXMX_AP_SUPP_TAX_PROF_STG" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_STG"."XXMX_AP_SUPP_TAX_PROF_STG" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_STG"."XXMX_AP_SUPP_TAX_PROF_STG" TO "XXMX_CORE";
