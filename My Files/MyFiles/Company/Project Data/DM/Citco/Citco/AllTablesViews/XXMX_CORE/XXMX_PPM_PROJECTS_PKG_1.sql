...
--***************************************************************************************************
    ...
    gvv_migration_date                        VARCHAR2(30) := '30-NOV-2023';
    ...
    CURSOR src_pa_tasks_cur
       /* (
        ...
        AND    ( pt.completion_date                              IS NULL
                    ...
                    --OR pt.completion_date                          >= to_date('30-JUN-22','DD-MON-RR'))
	...
	CURSOR pa_team_mem_cur 
        ...
        WHERE   ppp.project_id                              = p_project_id
          ...
          --  AND SYSDATE                                     BETWEEN ppp.start_date_active AND NVL(ppp.end_date_active,SYSDATE+1)
            AND to_date(gvv_migration_date,'DD-MON-YYYY')                                     BETWEEN papf.effective_start_date AND NVL(papf.effective_end_date,SYSDATE+1)
            AND to_date(gvv_migration_date,'DD-MON-YYYY')                                     BETWEEN ppp.start_date_active AND NVL(ppp.end_date_active,SYSDATE+1)         
