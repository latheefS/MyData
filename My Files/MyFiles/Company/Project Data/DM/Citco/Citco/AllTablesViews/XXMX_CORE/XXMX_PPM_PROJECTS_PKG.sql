--------------------------------------------------------
--  DDL for Package XXMX_PPM_PROJECTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "XXMX_CORE"."XXMX_PPM_PROJECTS_PKG" AS
     /*
     *****************************************************************************
     **
     ...
     **   Vsn  Change Date  Changed By          Change Description
     ** -----  -----------  ------------------  -----------------------------------
     **   1.0  23-OCT-2021  Dhanu Gundala      Created for Maximise.
     **
     **
     ******************************************************************************
     **
     ...
     */
     ...
     /*
     ********************************
     ** PROCEDURE: batch_projects_data
     ********************************
     */
     --

    --PROCEDURE batch_projects_data(pt_i in varchar2 default null);

    --
     /*
     ********************************
     ** PROCEDURE: batch_project_classifications_data
     ********************************
     */
     --

   -- PROCEDURE batch_project_classifications_data(pt_i in varchar2 default null);
    --
     /*
     ********************************
     ** PROCEDURE: batch_project_team_members_data
     ********************************
     */
     --
    --PROCEDURE batch_project_team_members_data(pt_i in varchar2 default null);
    --
     /*
     ***********************************
