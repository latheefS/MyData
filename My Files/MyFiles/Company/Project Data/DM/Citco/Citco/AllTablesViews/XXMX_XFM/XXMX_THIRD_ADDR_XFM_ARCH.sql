--------------------------------------------------------
--  DDL for Table XXMX_THIRD_ADDR_XFM_ARCH
--------------------------------------------------------

  CREATE TABLE "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" 
   (	"MIGRATION_SET_ID" NUMBER, 
	...
	"BG_ID" NUMBER(15,0), 
	"REGISTRY_ID" VARCHAR2(30 BYTE), 
	"PARTY_ID" NUMBER, 
	"OBJECT_ID" NUMBER, 
	"ORGANIZATIONNAME" VARCHAR2(240 BYTE), 
	"COUNTRY" VARCHAR2(240 BYTE), 
	"ADDRESSLINE1" VARCHAR2(240 BYTE), 
	"ADDRESSLINE2" VARCHAR2(240 BYTE), 
	"ADDRESSLINE3" VARCHAR2(240 BYTE), 
	"ADDRESSLINE4" VARCHAR2(240 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_XFM" ;
  GRANT ALTER ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_READONLY";
  GRANT SELECT ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT READ ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_XFM"."XXMX_THIRD_ADDR_XFM_ARCH" TO "XXMX_CORE";
