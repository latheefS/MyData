--------------------------------------------------------
--  DDL for View XXMX_IBY_PAYEE_BANK_ACCTS_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "XXMX_CORE"."XXMX_IBY_PAYEE_BANK_ACCTS_V" ("EXT_PAYEE_ID", "PAYEE_LEVEL", "PAYEE_PARTY_ID", "ORG_ID", "SUPPLIER_SITE_ID", "INSTRUMENT_PAYMENT_USE_ID", "ORDER_OF_PREFERENCE", "EXT_BANK_ACCOUNT_ID") AS 
...
;
  GRANT SELECT ON "XXMX_CORE"."XXMX_IBY_PAYEE_BANK_ACCTS_V" TO "XXMX_READONLY";
