create or replace PROCEDURE XXMX_IREC_CANDIDATE_XFM_LOAD_PRC
AS
  CURSOR CANDIDATE_DATA_CUR 
     IS SELECT UNIQUE case when length(REPLACE(SUBSTR(can.EMAIL,1,INSTR(can.EMAIL,'@',1,1)-1),'.','_'))>30 
      ...
      and  email in ('saileshkonijeti@gmail.com','agarwalmanoj7662@gmail.com',
'devrasettysai22@gmail.com')
      --  AND ((TRUNC(TO_DATE(submitted,'MM/DD/RRRR HH24:MI')) 
         --   BETWEEN  TRUNC(TO_DATE('03/07/2023','MM/DD/RRRR')) 
          --  AND TRUNC(TO_DATE('03/11/2024','MM/DD/RRRR'))
