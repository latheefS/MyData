  ...
  CREATE TABLE "XXMX_STG"."XXMX_PER_EMAIL_F_STG" 
   (	"MIGRATION_SET_ID" NUMBER, 
	...
	"BG_ID" NUMBER(15,0), 
	"EMAIL_ADDRESS_ID" VARCHAR2(264 BYTE), 
	"PERSON_ID" VARCHAR2(264 BYTE), 
	"EMAIL_TYPE" VARCHAR2(30 BYTE), 
	"DATE_FROM" DATE, 
	"DATE_TO" DATE DEFAULT '31-DEC-4712', 
	"EMAIL_ADDRESS" VARCHAR2(240 BYTE) NOT NULL ENABLE, 
	"METADATA" VARCHAR2(10 BYTE) DEFAULT 'MERGE', 
	"OBJECT_NAME" VARCHAR2(200 BYTE) DEFAULT 'PersonEmail', 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT ALTER ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT READ ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_PER_EMAIL_F_STG" TO "XXMX_READONLY";
