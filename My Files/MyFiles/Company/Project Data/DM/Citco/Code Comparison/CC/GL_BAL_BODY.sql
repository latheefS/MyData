...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Package Body XXMX_GL_BALANCES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "XXMX_CORE"."XXMX_GL_BALANCES_PKG" 
AS
     --
     --**********************
     --** Global Declarations
     ...
     IS
          ...
          IS
             ...
             SELECT  
                      ...
                      ,( SELECT parameter_value 
                        FROM   xxmx_core.xxmx_migration_parameters 
                        WHERE  application_suite = gct_ApplicationSuite --'FIN'--
                        AND    application = gct_Application  --'GL'-- 
                        AND    business_entity = gct_BusinessEntity --'BALANCES'--
