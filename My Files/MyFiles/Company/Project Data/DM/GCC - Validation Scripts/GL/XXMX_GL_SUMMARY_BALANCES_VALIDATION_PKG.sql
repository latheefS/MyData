CREATE OR REPLACE PACKAGE  XXMX_GL_SUMMARY_BAL_VAL_PKG  
AS
     /*
	 ******************************************************************************
     ** FILENAME  :  XXMX_GL_SUMMARY_BAL_VAL_PKG.pls
     **
     ** VERSION   :  1.0
     **
     ** EXECUTE
     ...
     **
     ** PURPOSE   :  This script installs the package specification for the XXMX_GL_SUMMARY_BAL_VAL_PKG custom Procedures.
     **
     ** NOTES     :
     ...
     ******************************************************************************
     **
     ** XXMX_GL_SUMMARY_BAL_VAL_PKG HISTORY
     ** ------------------------------------
     **
     **   Vsn  Change Date  Changed By                 Change Description
     ** -----  -----------  ------------------         -----------------------------------
    ...
    /*
    ******************************
    ** PROCEDURE: VALIDATE_GL_SUMMARY_BALANCES 
    ******************************
    */
    PROCEDURE VALIDATE_GL_SUMMARY_BALANCES
                    (
    ...
    */
    ...
    FUNCTION get_subentity_name
                   ...
                   ,pt_i_table                      IN      xxmx_migration_metadata.stg_table%TYPE
					...
					RETURN VARCHAR2;
END XXMX_GL_SUMMARY_BAL_VAL_PKG;
/
     /*
    ******************************
    ** PACKAGE BODY
    ******************************
    */
CREATE OR REPLACE PACKAGE BODY XXMX_GL_SUMMARY_BAL_VAL_PKG 
AS
     /*
	 ******************************************************************************
     ** FILENAME  :  XXMX_GL_SUMMARY_BAL_VAL_PKG.pls
     ...
     ** AUTHORS   :  Shruti Choudhury
     **
     ** PURPOSE   :  This script installs the package body for the XXMX_GL_SUMMARY_BAL_VAL_PKG custom Procedures.
     **
     ** NOTES     :
     ...
     */
     ...
     gct_PackageName                           CONSTANT xxmx_module_messages.package_name%TYPE       := 'XXMX_GL_SUMMARY_BAL_VAL_PKG';
     ...
     gct_BusinessEntity                        CONSTANT xxmx_migration_metadata.business_entity%TYPE := 'SUMM_BAL';
...
FUNCTION get_subentity_name 
    ...
    */
    ...
    IS
        CURSOR gl_sum_bal_cursor(pt_i_MigrationSetID number)
        IS		 
	 /*
     ...
     */
		SELECT 'Sum of entered credit and debit does not match for summary balances' AS VALIDATION_ERROR_MESSAGE, stg.*
        FROM XXMX_GL_SUMMARY_BALANCES_STG stg
        ...
        AND  NOT EXISTS (SELECT 1 
		                   FROM (
                                 ...
                                 FROM XXMX_GL_SUMMARY_BALANCES_STG xspl
	 ...
	 /*
     ** Validate if ACCOUNTED credit and enetered debit is matching for summary balances: we have considered segment 1 as balancing segment
     */ 
	    UNION ALL
		SELECT 'Sum of accounted credit and debit does not match for summary balances' AS VALIDATION_ERROR_MESSAGE, stg.*
        FROM XXMX_GL_SUMMARY_BALANCES_STG stg
		where migration_set_id = pt_i_MigrationSetID
        AND  NOT EXISTS (SELECT 1 
		                   FROM (
     ...
     */	
        ...
        FROM XXMX_GL_SUMMARY_BALANCES_STG gsbs
		WHERE 1=1
	...
	--	
     ...
     --
       TYPE gl_summary_balances_type IS TABLE OF gl_sum_bal_cursor%ROWTYPE INDEX BY BINARY_INTEGER;
	   gl_sum_bal_tbl gl_summary_balances_type;

	       --************************
          --** Constant Declarations
          --************************
        ct_ProcOrFuncName CONSTANT xxmx_module_messages.proc_or_func_name%TYPE := 'VALIDATE_GL_SUMMARY_BALANCES';
    ...
    BEGIN
		...
		END;
		OPEN gl_sum_bal_cursor(l_migration_set_id);
		LOOP	 
		 FETCH gl_sum_bal_cursor 
		 BULK COLLECT INTO gl_sum_bal_tbl
		 LIMIT xxmx_utilities_pkg.gcn_BulkCollectLimit;

		EXIT WHEN gl_sum_bal_tbl.COUNT=0  ;

		gvv_ProgressIndicator := '0060';

FORALL I in 1..gl_sum_bal_tbl.COUNT 

        INSERT INTO XXMX_GL_SUMMARY_BALANCES_VAL  
        (
        ...
        VALUES 
        (
		 gl_sum_bal_tbl(I).VALIDATION_ERROR_MESSAGE
        ,gl_sum_bal_tbl(I).FILE_SET_ID                      	
        ,gl_sum_bal_tbl(I).MIGRATION_SET_ID                 
		,gl_sum_bal_tbl(I).MIGRATION_SET_NAME                         
	    ,'VALIDATED'        
		, gl_sum_bal_tbl(I).FUSION_STATUS_CODE             
         ,gl_sum_bal_tbl(I).LEDGER_ID                      
         ,gl_sum_bal_tbl(I).ACCOUNTING_DATE                
         ,gl_sum_bal_tbl(I).USER_JE_SOURCE_NAME            
         ,gl_sum_bal_tbl(I).USER_JE_CATEGORY_NAME          
         ,gl_sum_bal_tbl(I).CURRENCY_CODE                  
         ,gl_sum_bal_tbl(I).DATE_CREATED                   
         ,gl_sum_bal_tbl(I).ACTUAL_FLAG                    
         ,gl_sum_bal_tbl(I).SEGMENT1                       
         ,gl_sum_bal_tbl(I).SEGMENT2                       
         ,gl_sum_bal_tbl(I).SEGMENT3                       
         ,gl_sum_bal_tbl(I).SEGMENT4                       
         ,gl_sum_bal_tbl(I).SEGMENT5                       
         ,gl_sum_bal_tbl(I).SEGMENT6                       
         ,gl_sum_bal_tbl(I).SEGMENT7                       
         ,gl_sum_bal_tbl(I).SEGMENT8                       
         ,gl_sum_bal_tbl(I).SEGMENT9                       
         ,gl_sum_bal_tbl(I).SEGMENT10                      
         ,gl_sum_bal_tbl(I).SEGMENT11                      
         ,gl_sum_bal_tbl(I).SEGMENT12                      
         ,gl_sum_bal_tbl(I).SEGMENT13                      
         ,gl_sum_bal_tbl(I).SEGMENT14                      
         ,gl_sum_bal_tbl(I).SEGMENT15                      
         ,gl_sum_bal_tbl(I).SEGMENT16                      
         ,gl_sum_bal_tbl(I).SEGMENT17                      
         ,gl_sum_bal_tbl(I).SEGMENT18                      
         ,gl_sum_bal_tbl(I).SEGMENT19                      
         ,gl_sum_bal_tbl(I).SEGMENT20                      
         ,gl_sum_bal_tbl(I).SEGMENT21                      
         ,gl_sum_bal_tbl(I).SEGMENT22                      
         ,gl_sum_bal_tbl(I).SEGMENT23                      
         ,gl_sum_bal_tbl(I).SEGMENT24                      
         ,gl_sum_bal_tbl(I).SEGMENT25                      
         ,gl_sum_bal_tbl(I).SEGMENT26                      
         ,gl_sum_bal_tbl(I).SEGMENT27                      
         ,gl_sum_bal_tbl(I).SEGMENT28                      
         ,gl_sum_bal_tbl(I).SEGMENT29                      
         ,gl_sum_bal_tbl(I).SEGMENT30                      
         ,gl_sum_bal_tbl(I).ENTERED_DR                     
         ,gl_sum_bal_tbl(I).ENTERED_CR                     
         ,gl_sum_bal_tbl(I).ACCOUNTED_DR                   
         ,gl_sum_bal_tbl(I).ACCOUNTED_CR                   
         ,gl_sum_bal_tbl(I).REFERENCE1                     
         ,gl_sum_bal_tbl(I).REFERENCE2                     
         ,gl_sum_bal_tbl(I).REFERENCE3                     
         ,gl_sum_bal_tbl(I).REFERENCE4                     
         ,gl_sum_bal_tbl(I).REFERENCE5                     
         ,gl_sum_bal_tbl(I).REFERENCE6                     
         ,gl_sum_bal_tbl(I).REFERENCE7                     
         ,gl_sum_bal_tbl(I).REFERENCE8                     
         ,gl_sum_bal_tbl(I).REFERENCE9                     
         ,gl_sum_bal_tbl(I).REFERENCE10                    
         ,gl_sum_bal_tbl(I).STAT_AMOUNT                    
         ,gl_sum_bal_tbl(I).USER_CURRENCY_CONVERSION_TYPE  
         ,gl_sum_bal_tbl(I).CURRENCY_CONVERSION_DATE       
         ,gl_sum_bal_tbl(I).CURRENCY_CONVERSION_RATE       
         ,gl_sum_bal_tbl(I).GROUP_ID                       
         ,gl_sum_bal_tbl(I).ORIGINATING_BAL_SEG_VALUE      
         ,gl_sum_bal_tbl(I).LEDGER_NAME                    
         ,gl_sum_bal_tbl(I).ENCUMBRANCE_TYPE_ID            
         ,gl_sum_bal_tbl(I).JGZZ_RECON_REF                 
         ,gl_sum_bal_tbl(I).PERIOD_NAME                    
         ,gl_sum_bal_tbl(I).LOAD_BATCH    
        );	
END LOOP;
               --
      ...
      --
END VALIDATE_GL_SUMMARY_BALANCES;
...
gvt_Phase     VARCHAR2(15) := 'VALIDATE';	
    ...
    BEGIN
        ct_ProcOrFuncName := 'VALIDATE_BALANCES';
        gvv_ProgressIndicator := '0010';
