  ...
  DROP TABLE XXMX_CORE.XXMX_HZ_PARTIES_VAL ;
  --
  CREATE TABLE XXMX_CORE.XXMX_HZ_PARTIES_VAL
   ...
   --
  DROP TABLE XXMX_CORE.XXMX_HZ_PARTY_SITES_VAL ;
  --
  ...
  ( VALIDATION_ERROR_MESSAGE	    VARCHAR2(3000),
    ...
    --
  DROP TABLE XXMX_CORE.XXMX_HZ_PARTY_SITE_USES_VAL ;
  --
  ...
  ( VALIDATION_ERROR_MESSAGE	      VARCHAR2(3000),
	...
	LOAD_BATCH                        VARCHAR2(300)
      ...
      --
  DROP TABLE XXMX_CORE.XXMX_HZ_CUST_ACCOUNTS_VAL ;
  --
  ...
  ( VALIDATION_ERROR_MESSAGE	VARCHAR2(3000),
	...
	LOAD_BATCH	                VARCHAR2(300)
      ...
      --
  DROP TABLE XXMX_CORE.XXMX_HZ_CUST_ACCT_SITES_VAL ;
  --
  ...
  ( VALIDATION_ERROR_MESSAGE	VARCHAR2(3000),
	...
	PARTY_ORIG_SYSTEM_REFERENCE	NUMBER(15)
       ...
       --
  DROP TABLE XXMX_CORE.XXMX_HZ_CUST_SITE_USES_VAL ;
  --
  ...
  ( VALIDATION_ERROR_MESSAGE	VARCHAR2(3000),
   ...
   DROP TABLE XXMX_CORE.XXMX_HZ_LOCATIONS_VAL ;
  --
  ...
  ( VALIDATION_ERROR_MESSAGE	    VARCHAR2(3000),
   ...
   --
   DROP TABLE XXMX_CORE.XXMX_HZ_CUST_PROFILES_VAL ;
  --
 ...
 --
   DROP TABLE XXMX_CORE.XXMX_HZ_CONTACT_POINTS_VAL ;
  --
  ...
  DROP TABLE XXMX_CORE.XXMX_HZ_CUST_ACCT_CONTACTS_VAL ;
  --
  ...
  DROP TABLE XXMX_CORE.XXMX_HZ_ORG_CONTACTS_VAL ;
  --
  ...
  DROP TABLE XXMX_CORE.XXMX_HZ_ORG_CONTACT_ROLES_VAL ;
  --
  CREATE TABLE XXMX_CORE.XXMX_HZ_ORG_CONTACT_ROLES_VAL
   (VALIDATION_ERROR_MESSAGE		VARCHAR2(3000),
	...
	PARTY_ORIG_SYSTEM_REFERENCE		VARCHAR2(240)
     ...
     DROP TABLE XXMX_CORE.XXMX_HZ_RELATIONSHIPS_VAL ;
  --
  ...
  DROP TABLE XXMX_CORE.XXMX_HZ_ROLE_RESPS_VAL ;
  --
  ...
  DROP TABLE XXMX_CORE.XXMX_ZX_TAX_PROFILE_VAL ;
  --
  ...
  DROP TABLE XXMX_CORE.XXMX_ZX_TAX_REGISTRATION_VAL ;
  --
