--------------------------------------------------------
--  DDL for Package Body XXMX_HDL_UTILITIES_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "XXMX_CORE"."XXMX_HDL_UTILITIES_PKG" 
IS
--
--******************************************************************************
--
...
--**   1.3   10/05/2021   Pallavi Kanajar     Visa  Party Org
...
PROCEDURE write_hdl_line (pv_i_file_name      IN VARCHAR2  -- 'WORKER' / 'BANK' / 'BANKBRANCHES'
  ...
  --
          ...
          cv_phone_hdr            CONSTANT  VARCHAR2(400) := 'PersonId(SourceSystemId)|PhoneType|DateFrom|DateTo|PersonNumber|LegislationCode|AreaCode|PhoneNumber|PrimaryFlag';
          ...
          cv_wrk_hire_relation_hdr CONSTANT VARCHAR2(400) := 'PersonId(SourceSystemId)|PersonNumber|DateStart|WorkerType|LegalEmployerName|ActionCode|ReasonCode|PrimaryFlag|EnterpriseSeniorityDate'; --LegalEmployerSeniorityDate|
          cv_wrk_relation_hdr      CONSTANT VARCHAR2(400) := 'PersonId(SourceSystemId)|ActionCode|ReasonCode|TerminateWorkRelationshipFlag|ActualTerminationDate|LastWorkingDate';
         ...
         cv_wrk_add_assign_chg_hdr    CONSTANT  VARCHAR2(800) := 'WorkTermsAssignmentId(SourceSystemId)|PeriodOfServiceId(SourceSystemId)|PersonId(SourceSystemId)|EffectiveStartDate|EffectiveEndDate|PersonNumber|EffectiveSequence|EffectiveLatestChange|DateStart|ActionCode|ReasonCode|WorkerType|LegalEmployerName|PrimaryAssignmentFlag|AssignmentStatusTypeCode|BusinessUnitShortCode|AssignmentType|PersonTypeCode|WorkerCategory|FullPartTime|DateProbationEnd|NormalHours|Frequency|PermanentTemporary|JobCode|LocationCode|NoticePeriod|NoticePeriodUOM|HourlySalariedCode|PositionCode|GradeCode|BargainingUnitCode|LabourUnionMemberFlag|ManagerFlag|SystemPersonType|TaxReportingUnit|PeopleGroup|GradeLadderPgmName|PositionOverrideFlag';  -- 1.7
         ...
         cv_profile_item_hdr       CONSTANT  VARCHAR2(2000) :='ProfileId|ProfileCode|ContentItemId|ContentTypeId|DateFrom|DateTo|RatingModelId1|RatingModelCode1|RatingLevelId1|RatingLevelCode1|SectionId';
         ...
         cv_wrk_assign_dff_hdr   CONSTANT  VARCHAR2(1500) := 'WorkTermsAssignmentId(SourceSystemId)|PeriodOfServiceId(SourceSystemId)|PersonId(SourceSystemId)|EffectiveStartDate|EffectiveEndDate|PersonNumber|EffectiveSequence|EffectiveLatestChange|DateStart|ActionCode|ReasonCode|WorkerType|LegalEmployerName|PrimaryAssignmentFlag|AssignmentStatusTypeCode|BusinessUnitShortCode|AssignmentType|PersonTypeCode|WorkerCategory|AssignmentCategory|FullPartTime|DateProbationEnd|NormalHours|Frequency|PermanentTemporary|JobCode|LocationCode|NoticePeriod|NoticePeriodUOM|HourlySalariedCode|PositionCode|GradeCode|BargainingUnitCode|LabourUnionMemberFlag|ManagerFlag|SystemPersonType|TaxReportingUnit|PeopleGroup|GradeLadderPgmName|ReportingEstablishment|PositionOverrideFlag|DefaultExpenseAccount|FLEX:PER_ASG_DF|headCountClassification(PER_ASG_DF=Global Data Elements)|payrollProviderId(PER_ASG_DF=Global Data Elements)|companyRecharge_Display(PER_ASG_DF=Global Data Elements)';  --|qtsRoute(PER_ASG_DF=Global Data Elements)|apprentice(PER_ASG_DF=Global Data Elements)|apprenticeStartDate(PER_ASG_DF=Global Data Elements)|apprenticeEndDate(PER_ASG_DF=Global Data Elements)|ContractType(PER_ASG_DF=Global Data Elements)|TermTimecontractedWeeks(PER_ASG_DF=Global Data Elements)|smbc10YearIncrease(PER_ASG_DF=Global Data Elements)|MileageStatusAsg(PER_ASG_DF=Global Data Elements)|excessMileageExpiryDate(PER_ASG_DF=Global Data Elements)|payPoint(PER_ASG_DF=Global Data Elements)';
