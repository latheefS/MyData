--------------------------------------------------------
--  DDL for Package Body XXMX_AR_CUSTOMERS_CM_PKG_03102023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "XXMX_CORE"."XXMX_AR_CUSTOMERS_CM_PKG_03102023" AS
-- =============================================================================
-- | VERSION1 |
-- =============================================================================
--
...
is
        ...
        cursor c_rule is
            select territory_code,attribute_code
                from    xxmx_fusion_address_format 
        ...
        cursor c_no_rule is
            select distinct country 
                ...
                ( select territory_code from xxmx_fusion_address_format);
begin
    if p_stage not in ('STG','XFM') then
        ...
        gvv_ProgressIndicator := '-CM0010';
        v_sql := 'select distinct territory_code,attribute_code from xxmx_fusion_address_format  '||
        ...
        v_sql := 'select distinct country from xxmx_hz_locations_'||p_stage||
            ' where country not in ( select territory_code from xxmx_fusion_address_format)';
...
END xxmx_ar_customers_cm_pkg_03102023;
