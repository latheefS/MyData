--------------------------------------------------------
--  DDL for Package XXMX_AR_CUST_EXT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "XXMX_CORE"."XXMX_AR_CUST_EXT_PKG" AUTHID CURRENT_USER
AS
--//=====================================================================================================
--// Version1
--// $Id:$
--//=====================================================================================================
--// Object Name        :: xxmx_ar_cust_ext_pkg.pkh
--//
...
--//=====================================================================================================
     ...
     /*
     ********************************
     ** PROCEDURE: transform_profiles - Hook procedure for applying transformation rules after copying from STG and applying simple transforms
     ********************************
     */
