...
--------------------------------------------------------
  ...
  SELECT -- Added to extract Costs against Open AR Invoices
            ...
            ,nvl((select MEANING from pa_lookups@xxmx_extract where lookup_type = 'UNIT'
AND LOOKUP_CODE = pa_costs.unit_of_measure),(select MEANING from pa_lookups@xxmx_extract p, pa_expenditure_types@xxmx_extract et where lookup_type = 'UNIT'
AND LOOKUP_CODE = pa_costs.unit_of_measure
and LOOKUP_CODE = et.unit_of_measure
and et.expenditure_type =pa_costs.expenditure_type))                                                                                            unit_of_measure
           ...
           -- ,NULL                                                                                                      gl_date
            ...
            ,NULL                                                                                                             attribute6
            ,NULL                                                                                                             attribute7
            ,to_char(pa_costs.INVOICE_DATE,'DD-MON-YYYY')                                                                     attribute8
            ,NULL                                                                                                             attribute9
            ...
            ,pa_costs.ar_invoice_number
            ,pa_costs.project_currency_code
            ,pa_costs.project_raw_cost            
            FROM  xxmx_ppm_projects_stg                               ppa
			     ,xxmx_open_ar_costs                                  pa_costs
                 ,XXMX_PA_EXPENDITURE_ITEMS_ALL                       e
                 --,xxmx_open_ar_exp_items e
            WHERE 1                                       = 1
