--------------------------------------------------------
--  DDL for View XXMX_JOBVITE_JOB_DESC_HDL_V
--------------------------------------------------------
...
and profile_code in (select position_code from xxmx_position_cloud)  and profile_code <>'LT5400-LT01-326-03'
UNION ALL
...
WHERE POSITION_DESCRIPTION IS NOT NULL and profile_code in (select position_code from xxmx_position_cloud)  and profile_code <>'LT5400-LT01-326-03'
UNION ALL
