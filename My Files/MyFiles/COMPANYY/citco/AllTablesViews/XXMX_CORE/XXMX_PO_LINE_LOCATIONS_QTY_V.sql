--------------------------------------------------------
--  DDL for View XXMX_PO_LINE_LOCATIONS_QTY_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "XXMX_CORE"."XXMX_PO_LINE_LOCATIONS_QTY_V" ("PO_HEADER_ID", "PO_LINE_ID", "LINE_NUM", "LINE_LOCATION_ID", "UNIT_PRICE", "QTY_CANCELLED", "QTY_BILLED", "ORIG_QTY_ORDERED", "NEW_QTY_ORDERED", "ORIG_QTY_DELIVERED", "NEW_QTY_DELIVERED") AS 
  select "PO_HEADER_ID","PO_LINE_ID","LINE_NUM","LINE_LOCATION_ID","UNIT_PRICE","QTY_CANCELLED","QTY_BILLED","ORIG_QTY_ORDERED","NEW_QTY_ORDERED","ORIG_QTY_DELIVERED","NEW_QTY_DELIVERED" from (  select pl.po_header_id
          ,pl.po_line_id
          ,pl.line_num
    ...
    group by pl.po_header_id
            ...
            ,pl.line_num
            ,pll.line_location_id
    order by pl.po_header_id
            ,pl.po_line_id
            ,pl.line_num
            ,pll.line_location_id) where NEW_QTY_ORDERED>0
;
  GRANT SELECT ON "XXMX_CORE"."XXMX_PO_LINE_LOCATIONS_QTY_V" TO "XXMX_READONLY";
