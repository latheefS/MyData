...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  AS SELECT * FROM xxmx_hcm_workers_scope;

   COMMENT ON MATERIALIZED VIEW "XXMX_CORE"."XXMX_HCM_CURRENT_PERSON_MV"  IS 'snapshot table for snapshot XXMX_CORE.XXMX_HCM_CURRENT_PERSON_MV';
