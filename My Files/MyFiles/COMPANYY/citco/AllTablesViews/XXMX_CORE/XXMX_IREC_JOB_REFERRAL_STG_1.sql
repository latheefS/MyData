--------------------------------------------------------
--  DDL for Package Body XXMX_IREC_JOB_REFERRAL_STG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "XXMX_CORE"."XXMX_IREC_JOB_REFERRAL_STG" AS
--*****************************************************************************
--**
