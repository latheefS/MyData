--------------------------------------------------------
--  DDL for View XXMX_PPM_ALL_ORG_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "XXMX_CORE"."XXMX_PPM_ALL_ORG_V" ("BU_NAME", "BATCHNAME", "UNIT_ID") AS 
  select distinct b."BU_NAME",b."BATCHNAME",f.bu_id unit_id
        from (
          select distinct  a.organization_name bu_name, 'ALL' batchname from  XXMX_PPM_projects_stg a
