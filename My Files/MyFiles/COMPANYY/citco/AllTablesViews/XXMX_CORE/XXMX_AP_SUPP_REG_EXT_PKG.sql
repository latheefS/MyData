--------------------------------------------------------
--  DDL for Package XXMX_AP_SUPP_REG_EXT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "XXMX_CORE"."XXMX_AP_SUPP_REG_EXT_PKG" 
AS
--
     --
     /*
     ...
     ** AUTHORS   :  <<Author Name>>
     **
     ** PURPOSE   :  This script installs the package for the Maximise Supplier Third Party Registrations
     **              Data Migration.
     **
     ** NOTES     :
     **
     ...
     **   Vsn  Change Date  Changed By          Change Description
     ** -----  -----------  ------------------  -----------------------------------
     ** <<  1.0  DATE        Author Name  Created for Maximise.>>
     **
     **
     ******************************************************************************
     **
     ...
     ** if you have more than one subentity , please define procedures for each subentity
     ** keep parameters as is
     ******************************
     */
     --
     PROCEDURE ap_supp_party_site_reg
	-- Repeat this procedure for each subentity under business entity
                    (
