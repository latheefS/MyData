--------------------------------------------------------
--  DDL for Table XXMX_MIGRATION_PARAMETERS
--------------------------------------------------------

  CREATE TABLE "XXMX_CORE"."XXMX_MIGRATION_PARAMETERS" 
   (	"PARAMETER_ID" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "XXMX_CORE"."XXMX_MIGRATION_PARAMETERS" TO "XXMX_READONLY";
