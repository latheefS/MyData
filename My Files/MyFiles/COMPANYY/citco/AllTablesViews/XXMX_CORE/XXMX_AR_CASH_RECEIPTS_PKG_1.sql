--------------------------------------------------------
--  DDL for Package Body XXMX_AR_CASH_RECEIPTS_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "XXMX_CORE"."XXMX_AR_CASH_RECEIPTS_PKG" 
AS
-- ================================================================================
-- | VERSION1 |
-- ================================================================================
...
--        AND       xfld.bank_origination_number(+)         = ceba.bank_account_num
        ...
        SELECT
            ...
            ,nvl(xacrsv.receipt_amount_remaining  ,0)        AS remittance_amount   --Amended by Milind
            ,acra.cash_receipt_id                             as cash_receipt_id
            ,acra.receipt_number                               AS receipt_number
