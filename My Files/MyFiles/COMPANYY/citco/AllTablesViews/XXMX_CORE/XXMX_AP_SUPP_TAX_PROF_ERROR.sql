--------------------------------------------------------
--  DDL for Table XXMX_AP_SUPP_TAX_PROF_ERROR
--------------------------------------------------------

  CREATE TABLE "XXMX_CORE"."XXMX_AP_SUPP_TAX_PROF_ERROR" 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "XXMX_CORE"."XXMX_AP_SUPP_TAX_PROF_ERROR" TO "XXMX_READONLY";
