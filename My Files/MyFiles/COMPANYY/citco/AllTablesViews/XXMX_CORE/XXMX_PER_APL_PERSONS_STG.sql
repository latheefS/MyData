--------------------------------------------------------
--  DDL for Table XXMX_PER_APL_PERSONS_STG
--------------------------------------------------------

  CREATE TABLE "XXMX_CORE"."XXMX_PER_APL_PERSONS_STG" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
  GRANT SELECT ON "XXMX_CORE"."XXMX_PER_APL_PERSONS_STG" TO "XXMX_READONLY";
