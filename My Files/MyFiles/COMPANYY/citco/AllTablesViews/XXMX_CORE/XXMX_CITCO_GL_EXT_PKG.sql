--------------------------------------------------------
--  DDL for Package XXMX_CITCO_GL_EXT_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "XXMX_CORE"."XXMX_CITCO_GL_EXT_PKG" AUTHID current_user AS
 --
     /*
     ******************************************************************************
     **
     ...
     **
     **
     ** FILENAME  :  xxmx_citco_gl_ext_pkg.sql
     **
     ...
     ** IN SCHEMA :  APPS
     **
     ** AUTHORS   :  Laxmikanth Muppiri
     **
     ** PURPOSE   :  This script installs the package specification for the xxmx_citco_gl_ext_pkg custom Procedures and Functions.
     **
     ** NOTES     :
     **
     *******************************************************************************
