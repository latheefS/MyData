--------------------------------------------------------
--  DDL for View XXMX_PPM_MISCCOST_BATCH_ORG_V
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "XXMX_CORE"."XXMX_PPM_MISCCOST_BATCH_ORG_V" ("BU_NAME", "EXP_BATCH_NAME", "BU_ID") AS 
  select distinct  b."BU_NAME",b."EXP_BATCH_NAME",f.bu_id
        from (
            ...
            union */
             select distinct  a.organization_name bu_name, b.exp_batch_name  
