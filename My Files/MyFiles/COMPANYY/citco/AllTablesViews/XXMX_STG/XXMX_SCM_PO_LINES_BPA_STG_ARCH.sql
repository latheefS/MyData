--------------------------------------------------------
--  DDL for Table XXMX_SCM_PO_LINES_BPA_STG_ARCH
--------------------------------------------------------

  CREATE TABLE "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_STG" ;
  GRANT FLASHBACK ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT READ ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT ALTER ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_SCM_PO_LINES_BPA_STG_ARCH" TO "XXMX_READONLY";
