--------------------------------------------------------
--  DDL for Table XXMX_PER_ADDR_USG_F_STG
--------------------------------------------------------

  CREATE TABLE "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" 
   (	"MIGRATION_SET_ID" NUMBER, 
	...
	"BG_ID" NUMBER(15,0), 
	"PERSON_ADDR_USAGE_ID" VARCHAR2(264 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_STG" ;
  GRANT SELECT ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_READONLY";
  GRANT FLASHBACK ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT READ ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
  GRANT ALTER ON "XXMX_STG"."XXMX_PER_ADDR_USG_F_STG" TO "XXMX_CORE";
