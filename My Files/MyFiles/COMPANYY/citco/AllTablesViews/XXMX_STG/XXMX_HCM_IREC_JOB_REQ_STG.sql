--------------------------------------------------------
--  DDL for Table XXMX_HCM_IREC_JOB_REQ_STG
--------------------------------------------------------
 ...
 LOB ("COMMENTS") STORE AS SECUREFILE (
  ...
  PCTINCREASE 0
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
  GRANT SELECT ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_READONLY";
  GRANT FLASHBACK ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT READ ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
  GRANT ALTER ON "XXMX_STG"."XXMX_HCM_IREC_JOB_REQ_STG" TO "XXMX_CORE";
