--------------------------------------------------------
--  DDL for Table XXMX_AR_CASH_RECEIPTS_STG_ARCH
--------------------------------------------------------

  CREATE TABLE "XXMX_STG"."XXMX_AR_CASH_RECEIPTS_STG_ARCH" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_STG" ;
  GRANT SELECT ON "XXMX_STG"."XXMX_AR_CASH_RECEIPTS_STG_ARCH" TO "XXMX_READONLY";
