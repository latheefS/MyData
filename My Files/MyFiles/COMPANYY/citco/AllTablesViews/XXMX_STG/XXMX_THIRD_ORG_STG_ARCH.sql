--------------------------------------------------------
--  DDL for Table XXMX_THIRD_ORG_STG_ARCH
--------------------------------------------------------

  CREATE TABLE "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" 
   (	"MIGRATION_SET_ID" NUMBER, 
	...
	"BG_ID" NUMBER(15,0), 
	"REGISTRY_ID" VARCHAR2(80 BYTE), 
	"PARTY_ID" NUMBER, 
	"OBJECT_ID" NUMBER, 
	"PERSONNUMBER" VARCHAR2(80 BYTE), 
	"ORGANIZATION_NAME" VARCHAR2(240 BYTE), 
	"PARTY_USAGE_CODE" VARCHAR2(120 BYTE), 
	"DUNS_NUMBER" VARCHAR2(80 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_STG" ;
  GRANT FLASHBACK ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT READ ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT ALTER ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_THIRD_ORG_STG_ARCH" TO "XXMX_READONLY";
