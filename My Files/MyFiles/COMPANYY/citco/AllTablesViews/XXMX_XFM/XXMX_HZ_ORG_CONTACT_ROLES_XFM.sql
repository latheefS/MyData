...
--------------------------------------------------------
  ...
  CREATE TABLE "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_XFM" ;
  GRANT ALTER ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_READONLY";
  GRANT SELECT ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT READ ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_XFM"."XXMX_HZ_ORG_CONTACT_ROLES_XFM" TO "XXMX_CORE";
