--------------------------------------------------------
--  DDL for Table XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH
--------------------------------------------------------

  CREATE TABLE "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" 
   (	"FILE_SET_ID" VARCHAR2(30 BYTE), 
	...
	"USE_NEED_BY_DATE" VARCHAR2(1 BYTE), 
	...
	"AGING_ONSET_POINT" VARCHAR2(30 BYTE), 
	"CONSUMPTION_ADVICE_FREQUENCY" VARCHAR2(30 BYTE), 
	"CONSUMPTION_ADVICE_SUMMARY" VARCHAR2(30 BYTE), 
	"DEFAULT_CONSIGNMENT_LINE_FLAG" VARCHAR2(1 BYTE), 
	"PAY_ON_USE_FLAG" VARCHAR2(1 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_XFM" ;
  GRANT ALTER ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_READONLY";
  GRANT SELECT ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT READ ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_XFM"."XXMX_SCM_PO_HEADERS_BPA_XFM_ARCH" TO "XXMX_CORE";
