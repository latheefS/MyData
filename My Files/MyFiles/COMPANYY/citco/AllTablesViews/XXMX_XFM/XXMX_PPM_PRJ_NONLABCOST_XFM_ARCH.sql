--------------------------------------------------------
--  DDL for Table XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH
--------------------------------------------------------

  CREATE TABLE "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" 
   (	"FILE_SET_ID" VARCHAR2(30 BYTE), 
	...
	"NON_LABOR_RESOURCE_ORG" VARCHAR2(240 BYTE), 
	...
	"CONTRACT_NAME" VARCHAR2(300 BYTE), 
	"CONTRACT_ID" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_XFM" ;
  GRANT ALTER ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_READONLY";
  GRANT SELECT ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT READ ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM_ARCH" TO "XXMX_CORE";
