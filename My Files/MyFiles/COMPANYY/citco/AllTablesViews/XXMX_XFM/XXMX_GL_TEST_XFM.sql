--------------------------------------------------------
--  DDL for Table XXMX_GL_TEST_XFM
--------------------------------------------------------

  CREATE TABLE "XXMX_XFM"."XXMX_GL_TEST_XFM" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_XFM" ;
  GRANT ALTER ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT ALTER ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT DELETE ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT INDEX ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT INSERT ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_READONLY";
  GRANT SELECT ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT SELECT ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT UPDATE ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT REFERENCES ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT READ ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT READ ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT ON COMMIT REFRESH ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT QUERY REWRITE ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT DEBUG ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_STG";
  GRANT FLASHBACK ON "XXMX_XFM"."XXMX_GL_TEST_XFM" TO "XXMX_CORE";
