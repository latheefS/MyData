--------------------------------------------------------
--  DDL for Table XXMX_THIRD_PAYMTHD_XFM_ARCH
--------------------------------------------------------

  CREATE TABLE "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" 
   (	"MIGRATION_SET_ID" NUMBER, 
	...
	"OBJECT_ID" NUMBER, 
	"EFFECTIVE_DATE" DATE, 
	"ORGANIZATION_NAME" VARCHAR2(250 BYTE), 
	"ORGANIZATION_PAYMENT_METHOD" VARCHAR2(80 BYTE), 
	"BANK_ACCOUNT_NUMBER" VARCHAR2(100 BYTE), 
	"SORT_CODE" VARCHAR2(30 BYTE), 
	"BANK_NAME" VARCHAR2(250 BYTE), 
	"BANK_NUMBER" VARCHAR2(250 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "XXMX_XFM" ;
  GRANT ALTER ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_READONLY";
  GRANT SELECT ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT READ ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_XFM"."XXMX_THIRD_PAYMTHD_XFM_ARCH" TO "XXMX_CORE";
