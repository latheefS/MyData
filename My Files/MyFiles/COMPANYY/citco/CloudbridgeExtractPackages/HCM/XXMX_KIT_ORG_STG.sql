CREATE OR REPLACE PACKAGE xxmx_kit_org_stg AS
...
CREATE OR REPLACE PACKAGE BODY xxmx_kit_org_stg AS
    ...
    */
    ...
    gv_i_BusinessEntity           CONSTANT      VARCHAR2(100) DEFAULT 'ORG';
    ...
    BEGIN
        ...
        --main  
		BEGIN 
			SELECT xxmx_kit_util_stg.get_legislation_code(p_bg_id) 
			INTO GVV_LEG_CODE
			FROM DUAL;
		EXCEPTION 
			WHEN OTHERS THEN 
  ...
  BEGIN
		...
		FROM    hr_all_organization_units@MXDM_NVIS_EXTRACT ORG
        WHERE   ORG.business_Group_id = p_bg_id;
/*					
        FROM    hr_all_organization_units@MXDM_NVIS_EXTRACT hr_all_organization_units
    ...
    BEGIN
        ...
        SELECT   pt_i_MigrationSetID                               
                ...
                ,'US' source_lang
        FROM hr_all_organization_units@MXDM_NVIS_EXTRACT hr_all_organization_units
                ,hr_all_organization_units_tl@MXDM_NVIS_EXTRACT hr_all_organization_units_tl
        WHERE   (
                        hr_all_organization_units.organization_id = hr_all_organization_units_tl.organization_id
                AND     hr_all_organization_units.business_group_id  = p_bg_id
    ...
    BEGIN
        ...
        FROM     xxmx_org_units_f_stg xxmx_org_units_f_stg
                ,hr_all_organization_units@MXDM_NVIS_EXTRACT hr_all_organization_units
        WHERE   (
    ...
    BEGIN
        ...
        FROM    hr_organization_information@MXDM_NVIS_EXTRACT hr_organization_information
            ,hr_all_organization_units@MXDM_NVIS_EXTRACT hr_all_organization_units
        WHERE   (
        ...
        AND     (
                ...
                OR      (
                        ...
                        AND     NOT EXISTS
                                    (
                                    SELECT  1
                                    FROM    hr_organization_information@MXDM_NVIS_EXTRACT hrorginfo
    ...
    BEGIN
        ...
        FROM    xxmx_hrt_profile_b_stg profiles
                ...
                ,per_competence_elements@MXDM_NVIS_EXTRACT per_competence_elements
        WHERE   (
                        (
...
---------------------------
    ...
    BEGIN
        ...
        SELECT   pt_i_MigrationSetID                               
				...
				,HP.DUNS_NUMBER_C
		FROM HZ_ORGANIZATION_PROFILES@MXDM_NVIS_EXTRACT haou,
				HZ_PARTIES@MXDM_NVIS_EXTRACT HP
				,HZ_PARTY_USG_ASSIGNMENTS@MXDM_NVIS_EXTRACT HPUA
		...
		SELECT  distinct pt_i_MigrationSetID                               
                ...
                ,p_bg_name
                ,p_bg_id
                ,(SELECT PARTY_NUMBER from Hz_parties@MXDM_NVIS_EXTRACT HP where PARTY_ID = HR.Subject_id)
			   ,HR.Subject_id
			   ,(SELECT PARTY_NAME from Hz_parties@MXDM_NVIS_EXTRACT HP where PARTY_ID = HR.Subject_id)
			   ,HPUA.party_usage_code 
			   ,'NULL'
				--, HR.subject_type 
		FROM hz_parties@MXDM_NVIS_EXTRACT HP,
			 HZ_Relationships@MXDM_NVIS_EXTRACT HR,
			 HZ_person_profiles@MXDM_NVIS_EXTRACT  HPP  ,
             HZ_PARTY_USG_ASSIGNMENTS@MXDM_NVIS_EXTRACT HPUA 
  ...
  END export_Third_party_org;
    ...
    BEGIN
		...
		FROM  HZ_PARTIES@MXDM_NVIS_EXTRACT   HP ,
				iby_external_payees_all@MXDM_NVIS_EXTRACT   epa,
				iby_ext_party_pmt_mthds@MXDM_NVIS_EXTRACT   pm,
				IBY_PAYMENT_METHODS_tl@MXDM_NVIS_EXTRACT   IPMT,
				iby_ext_bank_accounts@MXDM_NVIS_EXTRACT   IEBA,
		...
		UNION 
		SELECT distinct 
				(SELECT party_name from HZ_parties@MXDM_NVIS_EXTRACT where party_id = payee_party_id)
				,epa.DEFAULT_PAYMENT_METHOD_CODE
				,IEBA.BANK_ACCOUNT_NUM				
		FROM 	iby_external_payees_all@MXDM_NVIS_EXTRACT   epa,
				iby_ext_party_pmt_mthds@MXDM_NVIS_EXTRACT   pm,
				IBY_PAYMENT_METHODS_tl@MXDM_NVIS_EXTRACT   IPMT,
				iby_ext_bank_accounts@MXDM_NVIS_EXTRACT   IEBA,
				iby_account_owners@MXDM_NVIS_EXTRACT iao
