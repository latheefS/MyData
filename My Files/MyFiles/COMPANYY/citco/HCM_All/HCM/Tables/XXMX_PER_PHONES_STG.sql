  ...
  CREATE TABLE "XXMX_STG"."XXMX_PER_PHONES_STG" 
   (	"MIGRATION_SET_ID" NUMBER, 
	...
	"PHONE_TYPE" VARCHAR2(30 BYTE) NOT NULL ENABLE, 
	"PHONE_NUMBER" VARCHAR2(60 BYTE) NOT NULL ENABLE, 
	...
	"OBJECT_NAME" VARCHAR2(200 BYTE) DEFAULT 'PersonPhone', 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT ALTER ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT READ ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_PER_PHONES_STG" TO "XXMX_READONLY";
