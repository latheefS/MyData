  ...
  CREATE TABLE "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" 
   (	"MIGRATION_SET_ID" NUMBER, 
	...
	"ASSIGNMENT_NUMBER" VARCHAR2(80 BYTE) NOT NULL ENABLE, 
	...
	"OBJECT_NAME" VARCHAR2(200 BYTE) DEFAULT 'Salary', 
	"SOURCESYSTEMID" VARCHAR2(2000 BYTE), 
	"SOURCESYSTEMOWNER" VARCHAR2(200 BYTE), 
	"PERSONNUMBER" VARCHAR2(80 BYTE) NOT NULL ENABLE, 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT ALTER ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT READ ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_PER_ASG_SALARY_STG" TO "XXMX_READONLY";
