  ...
  CREATE TABLE "XXMX_STG"."XXMX_CITIZENSHIPS_STG" 
   (	"MIGRATION_SET_ID" NUMBER, 
	...
	"BG_ID" NUMBER(15,0), 
	"CITIZENSHIP_ID" VARCHAR2(264 BYTE), 
	...
	"CITIZENSHIP_STATUS" VARCHAR2(30 BYTE) NOT NULL ENABLE, 
	"METADATA" VARCHAR2(10 BYTE) DEFAULT 'MERGE', 
	"OBJECT_NAME" VARCHAR2(200 BYTE) DEFAULT 'PersonCitixenship', 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT ALTER ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT DELETE ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT INDEX ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT INSERT ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT UPDATE ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT REFERENCES ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT READ ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT ON COMMIT REFRESH ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT QUERY REWRITE ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT DEBUG ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT FLASHBACK ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_CORE";
  GRANT SELECT ON "XXMX_STG"."XXMX_CITIZENSHIPS_STG" TO "XXMX_READONLY";
