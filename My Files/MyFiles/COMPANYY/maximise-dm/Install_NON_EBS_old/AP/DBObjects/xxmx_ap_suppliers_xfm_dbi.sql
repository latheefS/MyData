...
PROMPT *************************************************************
PROMPT **
PROMPT ** Installing Database Objects for Maximise GL Data Migration
PROMPT **
PROMPT *************************************************************
PROMPT
PROMPT
...
--------------------------------------------------------
  ...
  CREATE TABLE XXMX_AP_SUPP_ADDRS_xfm 
   ( 
...
--------------------------------------------------------
  ...
  CREATE TABLE XXMX_AP_SUPP_BANK_ACCTS_xfm 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--------------------------------------------------------
  ...
  CREATE TABLE XXMX_AP_SUPP_CONT_ADDRS_xfm 
   ( 
     file_set_id                    VARCHAR2(30), 
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--------------------------------------------------------
  ...
  CREATE TABLE XXMX_AP_SUPP_CONTACTS_xfm 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--------------------------------------------------------
  ...
  CREATE TABLE XXMX_AP_SUPP_PAYEES_xfm 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--------------------------------------------------------
  ...
  CREATE TABLE XXMX_AP_SUPP_PMT_INSTRS_xfm 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--------------------------------------------------------
  ...
  CREATE TABLE XXMX_AP_SUPP_SITE_ASSIGNS_xfm 
   ( 
     file_set_id                    VARCHAR2(30),      
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--------------------------------------------------------
  ...
  CREATE TABLE XXMX_AP_SUPPLIER_SITES_xfm 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--------------------------------------------------------
  ...
  CREATE TABLE XXMX_AP_SUPPLIERS_xfm 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--------------------------------------------------------
  ...
  CREATE TABLE XXMX_AP_SUPP_3RD_PTY_RELS_xfm 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
