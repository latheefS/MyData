...
--**
--**
--** FILENAME  :  xxmx_ppm_proj_xfm_dbi.sql
--**
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PLANRBS_HEADER_XFM
PROMPT
--
DROP TABLE XXMX_XFM.XXMX_PPM_PLANRBS_HEADER_XFM;
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_PPM_PLANRBS_HEADER_XFM
PROMPT
--

CREATE TABLE "XXMX_XFM"."XXMX_PPM_PLANRBS_HEADER_XFM" 
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PRJ_BILLEVENT_XFM
PROMPT
--
DROP TABLE XXMX_XFM.XXMX_PPM_PRJ_BILLEVENT_XFM;
--
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_PRJ_BILLEVENT_XFM
PROMPT
--
CREATE TABLE "XXMX_XFM"."XXMX_PPM_PRJ_BILLEVENT_XFM" 
(	
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PRJ_CLASS_XFM
PROMPT
--
DROP TABLE XXMX_XFM.XXMX_PPM_PRJ_CLASS_XFM;
--
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_PRJ_CLASS_XFM
PROMPT
--


CREATE TABLE "XXMX_XFM"."XXMX_PPM_PRJ_CLASS_XFM" 
(   "FILE_SET_ID"      VARCHAR2(30),
	"MIGRATION_SET_ID" NUMBER,
	"MIGRATION_SET_NAME" VARCHAR2(100 ), 
	"MIGRATION_STATUS" VARCHAR2(50 ), 
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PRJ_LBRCOST_XFM
PROMPT
--
DROP TABLE XXMX_XFM.XXMX_PPM_PRJ_LBRCOST_XFM;
--
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_PRJ_LBRCOST_XFM
PROMPT
--

CREATE TABLE "XXMX_XFM"."XXMX_PPM_PRJ_LBRCOST_XFM" 
(	"FILE_SET_ID"      VARCHAR2(30),
    "MIGRATION_SET_ID" NUMBER,
	"MIGRATION_SET_NAME" VARCHAR2(100 ), 
	"MIGRATION_STATUS" VARCHAR2(50 ), 
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PRJ_MISCCOST_XFM
PROMPT
--
DROP TABLE XXMX_XFM.XXMX_PPM_PRJ_MISCCOST_XFM;
--
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_PRJ_MISCCOST_XFM
PROMPT
--

CREATE TABLE "XXMX_XFM"."XXMX_PPM_PRJ_MISCCOST_XFM" 
(	"FILE_SET_ID"      VARCHAR2(30),
    "MIGRATION_SET_ID" NUMBER,
	"MIGRATION_SET_NAME" VARCHAR2(100 ), 
	"MIGRATION_STATUS" VARCHAR2(50 ), 
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PRJ_NONLABCOST_XFM
PROMPT
--
--
DROP TABLE XXMX_XFM.XXMX_PPM_PRJ_NONLABCOST_XFM;
--
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_PRJ_NONLABCOST_XFM
PROMPT
--


CREATE TABLE "XXMX_XFM"."XXMX_PPM_PRJ_NONLABCOST_XFM" 
(	
    "FILE_SET_ID" VARCHAR2(30 ), 
	"MIGRATION_SET_ID" NUMBER, 
	"MIGRATION_SET_NAME" VARCHAR2(100 ), 
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PRJ_SUPCOST_XFM
PROMPT
--
--
DROP TABLE XXMX_XFM.XXMX_PPM_PRJ_SUPCOST_XFM;
--
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_PRJ_SUPCOST_XFM
PROMPT
--
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PRJ_TASKS_XFM
PROMPT
--
--
DROP TABLE XXMX_XFM.XXMX_PPM_PRJ_TASKS_XFM;
--
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_PRJ_TASKS_XFM
PROMPT
--

CREATE TABLE "XXMX_XFM"."XXMX_PPM_PRJ_TASKS_XFM" 
(	"FILE_SET_ID"      VARCHAR2(30),
    "MIGRATION_SET_ID" NUMBER,
	"MIGRATION_SET_NAME" VARCHAR2(100 ), 
	"MIGRATION_STATUS" VARCHAR2(50 ), 
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PRJ_TEAM_MEM_XFM
PROMPT
--
--
DROP TABLE XXMX_XFM.XXMX_PPM_PRJ_TEAM_MEM_XFM;
--
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_PRJ_TEAM_MEM_XFM
PROMPT
--
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PRJ_TRX_CONTROL_XFM
PROMPT
--
--
DROP TABLE XXMX_XFM.XXMX_PPM_PRJ_TRX_CONTROL_XFM;
--
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_PRJ_TRX_CONTROL_XFM
PROMPT
--


CREATE TABLE "XXMX_XFM"."XXMX_PPM_PRJ_TRX_CONTROL_XFM" 
(   "FILE_SET_ID"      VARCHAR2(30),
	"MIGRATION_SET_ID" NUMBER,
	"MIGRATION_SET_NAME" VARCHAR2(100 ), 
	"MIGRATION_STATUS" VARCHAR2(50 ), 
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_PROJECTS_XFM
PROMPT
--
--
DROP TABLE XXMX_XFM.XXMX_PPM_PROJECTS_XFM;
--
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_PROJECTS_XFM
PROMPT
--
--

  CREATE TABLE "XXMX_XFM"."XXMX_PPM_PROJECTS_XFM" 
   ("FILE_SET_ID"      VARCHAR2(30),	
    "MIGRATION_SET_ID" NUMBER,
	"MIGRATION_SET_NAME" VARCHAR2(100 ), 
	"MIGRATION_STATUS" VARCHAR2(50 ), 
...
--
PROMPT
PROMPT Dropping Table XXMX_PPM_RESOURCES_XFM
PROMPT
--
--
DROP TABLE XXMX_XFM.XXMX_PPM_RESOURCES_XFM;
--
--
PROMPT
PROMPT Creating Table XXMX_PPM_RESOURCES_XFM
PROMPT
--
...
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PROJECTS_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PRJ_TASKS_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PRJ_TRX_CONTROL_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PRJ_LBRCOST_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PRJ_SUPCOST_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PRJ_MISCCOST_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PRJ_NONLABCOST_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PRJ_BILLEVENT_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_RESOURCES_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PLANRBS_HEADER_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PRJ_TEAM_MEM_XFM TO xxmx_core;
GRANT ALL ON  XXMX_XFM.XXMX_PPM_PRJ_CLASS_XFM TO xxmx_core;
--
--
PROMPT ***********************
...
Create or replace synonym xxmx_CORE.XXMX_PPM_PROJECTS_XFM FOR XXMX_XFM.XXMX_PPM_PROJECTS_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_PRJ_TASKS_XFM FOR XXMX_XFM.XXMX_PPM_PRJ_TASKS_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_PRJ_TRX_CONTROL_XFM FOR XXMX_XFM.XXMX_PPM_PRJ_TRX_CONTROL_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_PRJ_LBRCOST_XFM FOR XXMX_XFM.XXMX_PPM_PRJ_LBRCOST_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_PRJ_SUPCOST_XFM FOR XXMX_XFM.XXMX_PPM_PRJ_SUPCOST_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_PRJ_MISCCOST_XFM FOR XXMX_XFM.XXMX_PPM_PRJ_MISCCOST_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_PRJ_NONLABCOST_XFM FOR XXMX_XFM.XXMX_PPM_PRJ_NONLABCOST_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_PRJ_BILLEVENT_XFM FOR XXMX_XFM.XXMX_PPM_PRJ_BILLEVENT_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_RESOURCES_XFM FOR XXMX_XFM.XXMX_PPM_RESOURCES_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_PLANRBS_HEADER_XFM FOR XXMX_XFM.XXMX_PPM_PLANRBS_HEADER_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_PRJ_TEAM_MEM_XFM FOR XXMX_XFM.XXMX_PPM_PRJ_TEAM_MEM_XFM;
Create or replace synonym xxmx_CORE.XXMX_PPM_PRJ_CLASS_XFM FOR XXMX_XFM.XXMX_PPM_PRJ_CLASS_XFM;
