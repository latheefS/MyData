...
--***************************************************************************************
    ...
    gv_i_BusinessEntity                                 VARCHAR2(100)                              := 'PRJ_BILL_EVNT';
...
--              AND peia.cc_cross_charge_type <> 'IC'
       ...
       --************************
       --
        cv_ProcOrFuncName                   CONSTANT  xxmx_module_messages.proc_or_func_name%TYPE := 'src_pa_misc_cost';
        cv_Phase                            CONSTANT    xxmx_module_messages.phase%TYPE  := 'EXTRACT';
...
--              AND peia.cc_cross_charge_type <> 'IC'
       ...
       --************************
       --
        cv_ProcOrFuncName                   CONSTANT  xxmx_module_messages.proc_or_func_name%TYPE := 'src_pa_lbr_cost';
        cv_Phase                            CONSTANT    xxmx_module_messages.phase%TYPE  := 'EXTRACT';
