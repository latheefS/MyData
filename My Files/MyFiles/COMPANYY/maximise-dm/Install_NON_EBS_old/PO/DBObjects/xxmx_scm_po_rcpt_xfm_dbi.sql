...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  08-FEB-2023  Soundarya Kamatagi  Created PO Receipt XFM tables for Maximise.
--** 
--**************************************************************************************
--**
...
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_RCPT_HDR_XFM
PROMPT
--
EXEC DropTable('XXMX_SCM_PO_RCPT_HDR_XFM')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_RCPT_TXN_XFM									
PROMPT
--
EXEC DropTable('XXMX_SCM_PO_RCPT_TXN_XFM')
--
PROMPT
PROMPT
PROMPT ******************
...
PROMPT
PROMPT Creating Table XXMX_SCM_PO_RCPT_HDR_XFM
PROMPT
--
...
-- **************************
CREATE TABLE XXMX_XFM.XXMX_SCM_PO_RCPT_HDR_XFM
   (
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_RCPT_TXN_XFM
PROMPT
--
...
-- ******************************
CREATE TABLE XXMX_XFM.XXMX_SCM_PO_RCPT_TXN_XFM
   (
	    FILE_SET_ID                                     VARCHAR2(30),
	    MIGRATION_SET_ID                                NUMBER,
	    MIGRATION_SET_NAME                              VARCHAR2(100),
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_PO_RCPT_HDR_XFM FOR XXMX_XFM.XXMX_SCM_PO_RCPT_HDR_XFM;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_PO_RCPT_TXN_XFM FOR XXMX_XFM.XXMX_SCM_PO_RCPT_TXN_XFM;
...
PROMPT
--
GRANT ALL ON XXMX_XFM.XXMX_SCM_PO_RCPT_HDR_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_PO_RCPT_TXN_XFM TO XXMX_CORE;
--
--
--
PROMPT
...
PROMPT ***********************************************************************************
PROMPT **                                
PROMPT ** Completed Installing Database Objects for Maximise Scm Po Receipt Data Migration
PROMPT **                                
PROMPT ***********************************************************************************
PROMPT
PROMPT
