...
--**                                         Limited version.
--**   1.1  10-JUL-2021  Lokesh Shanbhag     Removed accounts join from customer banks
--******************************************************************************
--**
...
PROMPT
PROMPT
EXEC DropTable ('XXMX_HZ_CUST_ACCT_SITES_STG')
EXEC DropTable ('XXMX_HZ_CUST_SITE_USES_STG')
EXEC DropTable ('XXMX_HZ_CUST_ACCT_RELATE_STG')
EXEC DropTable ('XXMX_HZ_PARTY_CLASSIFS_STG')
EXEC DropTable ('XXMX_HZ_ORG_CONTACTS_STG')
EXEC DropTable ('XXMX_HZ_CONTACT_POINTS_STG')
EXEC DropTable ('XXMX_HZ_ORG_CONTACT_ROLES_STG')
EXEC DropTable ('XXMX_HZ_CUST_ACCOUNTS_STG')
EXEC DropTable ('XXMX_HZ_CUST_ACCT_CONTACTS_STG')
EXEC DropTable ('XXMX_IBY_CUST_BANK_ACCTS_STG')
EXEC DropTable ('XXMX_RA_CUST_RCPT_METHODS_STG')
EXEC DropTable ('XXMX_HZ_LOCATIONS_STG')
EXEC DropTable ('XXMX_HZ_PARTY_SITES_STG')
EXEC DropTable ('XXMX_HZ_PARTY_SITE_USES_STG')
EXEC DropTable ('XXMX_HZ_PARTIES_STG')
EXEC DropTable ('XXMX_HZ_PERSON_LANGUAGE_STG')
EXEC DropTable ('XXMX_HZ_CUST_PROFILES_STG')
EXEC DropTable ('XXMX_HZ_RELATIONSHIPS_STG')
EXEC DropTable ('XXMX_HZ_ROLE_RESPS_STG')
EXEC DropTable ('XXMX_AR_CUST_BANKS_STG')
...
--
--------------------------------------------------------
--  DDL for Table xxmx_hz_cust_acct_sites_stg

--Migration_set_id is generated in the maximise Code, Hence not Mandatory
--File_set_id is mandatory for Data File (non-Ebs Source)
--------------------------------------------------------

  CREATE TABLE xxmx_hz_cust_acct_sites_stg 
   ( 
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_cust_site_uses_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_cust_site_uses_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),	    
     ...
     CUST_SITEUSE_ORIG_SYS_REF NUMBER, 
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_cust_acct_relate_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_cust_acct_relate_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),	    
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_party_classifs_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_party_classifs_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
     MIGRATION_STATUS	VARCHAR2(50),	 
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_org_contacts_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_org_contacts_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),	    
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_contact_points_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_contact_points_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),	    
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_org_contact_roles_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_org_contact_roles_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
      MIGRATION_STATUS	VARCHAR2(50),	
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_cust_accounts_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_cust_accounts_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),	    
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_cust_acct_contacts_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_cust_acct_contacts_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),	    
...
--------------------------------------------------------
--  DDL for Table xxmx_iby_cust_bank_accts_stg
--------------------------------------------------------

  CREATE TABLE xxmx_iby_cust_bank_accts_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),
   ...
   --------------------------------------------------------
--  DDL for Table xxmx_ra_cust_rcpt_methods_stg
--------------------------------------------------------

  CREATE TABLE xxmx_ra_cust_rcpt_methods_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),
   ...
   --------------------------------------------------------
--  DDL for Table xxmx_hz_locations_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_locations_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),   
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_party_sites_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_party_sites_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),   
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_party_site_uses_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_party_site_uses_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),   
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_parties_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_parties_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_person_language_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_person_language_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),   
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_cust_profiles_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_cust_profiles_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),   
   ...
   --------------------------------------------------------
--  DDL for Table xxmx_hz_relationships_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_relationships_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),   
...
--------------------------------------------------------
--  DDL for Table xxmx_hz_role_resps_stg
--------------------------------------------------------

  CREATE TABLE xxmx_hz_role_resps_stg 
   ( FILE_SET_ID       VARCHAR2(30),
     MIGRATION_SET_ID NUMBER,
     MIGRATION_SET_NAME VARCHAR2(150),
	 MIGRATION_STATUS	VARCHAR2(50),   
...
-------------------------------------------
-- DDL for xxmx_ar_cust_banks_stg
-------------------------------------------
CREATE TABLE xxmx_ar_cust_banks_stg   
(
   FILE_SET_ID       				   VARCHAR2(30),
   MIGRATION_SET_ID                   NUMBER   ,     
   MIGRATION_SET_NAME                 VARCHAR2(150) ,
...
--
PROMPT
PROMPT Granting permissions on xxmx_hz_cust_acct_sites_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_cust_acct_sites_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_cust_site_uses_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_cust_site_uses_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_cust_acct_relate_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_cust_acct_relate_stg
          TO XXMX_CORE;
		  --
--
PROMPT
PROMPT Granting permissions on xxmx_hz_party_classifs_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_party_classifs_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_org_contacts_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_org_contacts_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_contact_points_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_contact_points_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_org_contact_roles_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_org_contact_roles_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_cust_accounts_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_cust_accounts_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_cust_acct_contacts_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_cust_acct_contacts_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_iby_cust_bank_accts_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_iby_cust_bank_accts_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_ra_cust_rcpt_methods_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_ra_cust_rcpt_methods_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_locations_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_locations_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_party_sites_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_party_sites_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_party_site_uses_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_party_site_uses_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_parties_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_parties_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_person_language_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_person_language_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_cust_profiles_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_cust_profiles_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_relationships_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_relationships_stg
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_hz_role_resps_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_hz_role_resps_stg
          TO XXMX_CORE;
--
--
--
--
PROMPT
PROMPT Granting permissions on xxmx_ar_cust_banks_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_ar_cust_banks_stg
          TO XXMX_CORE;
--
--
--
