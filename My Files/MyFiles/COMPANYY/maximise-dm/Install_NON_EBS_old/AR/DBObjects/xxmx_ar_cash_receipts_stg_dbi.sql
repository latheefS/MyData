...
--**
--**
--** FILENAME  :  xxmx_ar_cash_receipts_stg_dbi.sql
--**
...
--**
--** PURPOSE   :  This script installs the STG tables for the Maximise AR Cash
--**              Receipts Data Migration.
--**              .
--**
--** NOTES     :
--**
...
--**
--**   1.1  16-FEB-2021  Ian S. Vickerstaff  Updated with column level comments.
--**
--**   1.2  14-JUL-2021  Ian S. Vickerstaff  Header comments updated.
--**
--******************************************************************************
--**
...
PROMPT
--
EXEC DropTable ('XXMX_AR_CASH_RECEIPTS_STG')
--
--
PROMPT
PROMPT
...
--
PROMPT
PROMPT Granting permissions on xxmx_ar_cash_receipts_stg to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON xxmx_ar_cash_receipts_stg
          TO XXMX_CORE;
--
--
--
