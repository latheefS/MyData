...
*/
--
CREATE TABLE  xxmx_ar_trx_lines_xfm
     (
...
*/
--
CREATE TABLE  xxmx_ar_trx_dists_xfm
     (
      file_set_id                     VARCHAR2(30)
	 ,migration_set_id                NUMBER
     ,migration_set_name              VARCHAR2(150)
...
*/
--
CREATE TABLE  xxmx_ar_trx_salescredits_xfm
     (
	  file_set_id                     VARCHAR2(30)
     ,migration_set_id                NUMBER
     ,migration_set_name              VARCHAR2(150)
...
PROMPT
--
GRANT ALL ON  xxmx_ar_trx_lines_xfm
          TO XXMX_CORE;
--
--
PROMPT
...
PROMPT
--
GRANT ALL ON  xxmx_ar_trx_dists_xfm
          TO XXMX_CORE;
--
--
PROMPT
...
PROMPT
--
GRANT ALL ON  xxmx_ar_trx_salescredits_xfm
          TO XXMX_CORE;
--
--
PROMPT
