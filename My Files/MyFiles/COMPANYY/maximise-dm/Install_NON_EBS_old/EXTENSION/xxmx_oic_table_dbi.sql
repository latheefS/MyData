...
DROP TABLE XXMX_CORE.XXMX_DM_FUSION_DAS; 

DROP TABLE XXMX_CORE.XXMX_DM_STG_XFM_DATA; 

DROP TABLE XXMX_CORE.XXMX_DM_STG_XFM_HEADER;

DROP TABLE XXMX_CORE.XXMX_DM_ASSET_BOOKS_IN_SCOPE;

DROP TABLE XXMX_CORE.XXMX_DM_ESS_JOB_DEFINITIONS;

DROP TABLE XXMX_CORE.XXMX_FUSION_BUSINESS_UNITS;

DROP TABLE XXMX_CORE.XXMX_MAPPING_MASTER;

DROP TABLE XXMX_CORE.XXMX_DM_SUBENTITY_FILE_MAP;
