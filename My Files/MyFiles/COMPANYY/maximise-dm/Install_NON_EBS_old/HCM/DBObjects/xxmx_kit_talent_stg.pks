...
--**
--**
--** FILENAME  :  xxmx_kit_talent_stg.sql
--**
...
--**               Certifications/Awards from EBS
--**
--** NOTES     :
--**
--******************************************************************************
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -----------------------------------
--** 1.0     26/05/2020   Pallavi Kanajar          Initial Build
--**
--******************************************************************************
--**
...
create or replace PACKAGE xxmx_kit_talent_stg AS
