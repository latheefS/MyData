...
--**
--**
--** FILENAME  : xxmx_hcm_hr_location_stg_dbi.sql
--**
...
--**              Hcm Hr Locations Data Migration.
--**
--** NOTES     :
--**
--******************************************************************************
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  ----------------------------------------------------
--**   1.0  08-FEB-2023  Soundarya Kamatagi  Created HR LOCATION STG tables for Maximise.
--** 
--***********************************************************************************************
--**
...
PROMPT **************************************************************************************
PROMPT **
PROMPT ** Installing Extract Database Objects for Maximise HR LOCATION Data Migration
PROMPT **
PROMPT **************************************************************************************
PROMPT
PROMPT
...
PROMPT
PROMPT Dropping Table XXMX_HCM_HR_LOCATION_STG
PROMPT
--
EXEC DropTable('XXMX_HCM_HR_LOCATION_STG')
--
--
--
PROMPT
...
PROMPT
PROMPT Creating Table XXMX_HCM_HR_LOCATION_STG
PROMPT
--
...
-- **HR LOCATION  Table
-- ***************************
CREATE TABLE XXMX_STG.XXMX_HCM_HR_LOCATION_STG
   (
	...
	OBJECTNAME					                  VARCHAR2(150) DEFAULT 'Location',
    ...
    EMPLOYEE_LOCATION_FLAG						  VARCHAR2(1),
    MAIN_PHONE_AREA_CODE					      VARCHAR2(60),
    MAIN_PHONE_COUNTRY_CODE						  VARCHAR2(30),
    MAIN_PHONE_EXTENSION						  VARCHAR2(60),
    MAIN_PHONE_SUBSCRIBER_NUMBER  				  VARCHAR2(60),
    FAX_AREA_CODE								  VARCHAR2(60),
    FAX_COUNTRY_CODE							  VARCHAR2(30),
    FAX_EXTENSION								  VARCHAR2(60),
    FAX_SUBSCRIBER_NUMBER						  VARCHAR2(60),
    OTHER_PHONE_AREA_CODE                         VARCHAR2(30),
    OTHER_PHONE_COUNTRY_CODE					  VARCHAR2(60),
    OTHER_PHONE_EXTENSION						  VARCHAR2(60),
    OTHER_PHONE_SUBSCRIBER_NUMBER				  VARCHAR2(60),
    OFFICIAL_LANGUAGE_CODE						  VARCHAR2(30),
    EMAIL_ADDRESS								  VARCHAR2(240),
    SHIP_TO_SITE_FLAG							  VARCHAR2(30),
    SHIP_TO_LOCATION_SET_CODE					  VARCHAR2(30),
    SHIP_TO_LOCATION_CODE						  VARCHAR2(120),
    ...
    DESIGNATED_PERSON_NUMBER                      VARCHAR2(255),
    INVENTORY_ORGANIZATION_ID                     NUMBER,
    INVENTORY_ORGANIZATION_NAME                   VARCHAR2(240),
    GEO_HIERARCHY_NODE_ID                         VARCHAR2(30),
    GEO_HIERARCHY_NODE_CODE                       VARCHAR2(32),
    STANDARD_WORKING_HOURS						  NUMBER,
    STANDARD_WORKING_FREQUENCY                    VARCHAR2(30),
    STANDARD_ANNUAL_WORKING_DURATION			  NUMBER, 
    ANNUAL_WORKING_DURATION_UNITS                 VARCHAR2(10),
    LOCATION_CODE								  VARCHAR2(120),
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_HCM_HR_LOCATION_STG FOR XXMX_STG.XXMX_HCM_HR_LOCATION_STG;
--
...
PROMPT
--
GRANT ALL ON XXMX_STG.XXMX_HCM_HR_LOCATION_STG TO XXMX_CORE;
--
--
--
PROMPT
...
PROMPT ****************************************************************************************
PROMPT **                                
PROMPT ** Completed Installing Database Objects for Maximise HCM HR LOCATION  Data Migration
PROMPT **                                
PROMPT ****************************************************************************************
PROMPT
PROMPT
