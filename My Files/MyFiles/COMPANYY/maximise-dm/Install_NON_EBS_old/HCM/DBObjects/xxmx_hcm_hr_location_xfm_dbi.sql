...
--**
--**
--** FILENAME  : xxmx_hcm_hr_location_xfm_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  ----------------------------------------------------
--**   1.0  08-FEB-2023  Soundarya Kamatagi  Created HR LOCATION XFM tables for Maximise.
--** 
--***********************************************************************************************
--**
...
PROMPT
PROMPT Dropping Table XXMX_HCM_HR_LOCATION_XFM
PROMPT
--
EXEC DropTable('XXMX_HCM_HR_LOCATION_XFM')
--
--
--
PROMPT
...
PROMPT
PROMPT Creating Table XXMX_HCM_HR_LOCATION_XFM
PROMPT
--
...
-- **HR LOCATION  Table
-- ***************************
CREATE TABLE XXMX_XFM.XXMX_HCM_HR_LOCATION_XFM
   (
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_HCM_HR_LOCATION_XFM FOR XXMX_XFM.XXMX_HCM_HR_LOCATION_XFM;
--
--
--
PROMPT
...
PROMPT
--
GRANT ALL ON XXMX_XFM.XXMX_HCM_HR_LOCATION_XFM TO XXMX_CORE;
--
--
--
PROMPT
