...
@"&1/CORE/DBObjects/xxmx_stg_populate_ap_inv.sql"
--
--
PROMPT
PROMPT ****************************************
...
@"&1/CORE/DBObjects/xxmx_stg_populate_ap_supp.sql"
--
--
PROMPT
PROMPT ****************************************
...
@"&1/CORE/DBObjects/xxmx_stg_populate_ar_cash_rcpts.sql"
--
--
PROMPT
PROMPT ****************************************
...
@"&1/CORE/DBObjects/xxmx_stg_populate_ar_customers.sql"
--
--
PROMPT
PROMPT ****************************************
...
@"&1/CORE/DBObjects/xxmx_stg_populate_ar_inv.sql"       
--
--
PROMPT
PROMPT ****************************************
...
@"&1/CORE/DBObjects/xxmx_stg_populate_fa_massadd.sql"                    
--
--
PROMPT
PROMPT ****************************************
PROMPT Run script xxmx_stg_populate_gl_journal
PROMPT ****************************************
PROMPT
--
--

@"&1/CORE/DBObjects/xxmx_stg_populate_gl_journal.sql"                
...
@"&1/CORE/DBObjects/xxmx_stg_populate_po.sql"                
--
--
PROMPT
PROMPT ****************************************
