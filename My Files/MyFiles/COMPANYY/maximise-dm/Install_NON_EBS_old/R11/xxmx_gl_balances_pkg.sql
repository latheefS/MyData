...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "XXMX_CORE"."XXMX_GL_BALANCES_PKG" AUTHID CURRENT_USER
AS
     --
     --
     --*****************************
...
/
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "XXMX_CORE"."XXMX_GL_BALANCES_PKG" AUTHID CURRENT_USER
AS
     --
     --**********************
     --** Global Declarations
     ...
     IS
          ...
          IS
               ...
               SELECT  DISTINCT
                     ...
                     ||' '
                     ||gp.period_name                                    reference1                        -- CV040 states this should be the Batch Name  --xxsh check with functional team
                      ,''                                                reference2                        -- CV040 states this should be the Batch Description  --xxsh check with functional team
                      ,''                                                reference3                        -- CV040 does not reference this (FBDI Template has no column for it) --xxsh check with functional team
                      ,'ACTUAL BALANCE MIGRATION'                                                          
                     ||' '                                                                                 
                     ||gp.period_name                                    reference4                        -- CV040 states this should be the Journal Entry Name  --xxsh check with functional team
                      ,''                                                reference5                        -- CV040 states this should be the Journal Entry Description  --xxsh check with functional team
                      ,''                                                reference6                        -- CV040 states this should be the Journal Entry Reference  --xxsh check with functional team
                      ,''                                                reference7                        -- CV040 states this should be the Journal Entry Reversal Flag  --xxsh check with functional team
                      ,''                                                reference8                        -- CV040 states this should be the Journal entry Reversal Period  --xxsh check with functional team
                      ,''                                                reference9                        -- CV040 states this should be the Journal Reversal Method  --xxsh check with functional team
                      ,''                                                reference10                       -- CV040 states this should be the Journal entry Line Description  --xxsh check with functional team
                      ...
                      ,''                                                currency_conversion_rate  --xxsh NB does group_id get populated later in Maximise ??
                      ,''                                                attribute_category
                      ,''                                                attribute1
                      ,''                                                attribute2
                      ,''                                                attribute3
...
--xxsh r12 join               AND    gb.ledger_id             = gl.ledger_id
               AND    gb.set_of_books_id       = gl.set_of_books_id  --xxsh 11i join
                              ...
                              */
                              ...
                              LOOP
                                   ...
                                   */
                                   ...
                                   FROM    apps.gl_sets_of_books@xxmx_extract  gl2  --xxsh 11i table (r12 = gl_ledgers)
                                          ,apps.gl_periods@xxmx_extract  gp
                                   WHERE   1 = 1
