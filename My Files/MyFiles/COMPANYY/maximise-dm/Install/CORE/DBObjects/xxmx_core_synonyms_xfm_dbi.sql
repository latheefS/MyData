...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -----------------------------------
--**   1.0  07-JAN-2021  Ian S. Vickerstaff  Created for Cloudbridge.
--**
...
PROMPT ************************************************************************
PROMPT **
PROMPT ** Performing Grants and Creating Synonyms for the Cloudbridge Core Objects
PROMPT **
PROMPT ************************************************************************
PROMPT
PROMPT
...
CREATE OR REPLACE PUBLIC SYNONYM xxmx_gl_summary_balances_xfm
           FOR xxmx_gl_summary_balances_xfm;

CREATE OR REPLACE PUBLIC SYNONYM xxmx_gl_detail_balances_xfm
           FOR xxmx_gl_detail_balances_xfm;

CREATE OR REPLACE PUBLIC SYNONYM xxmx_gl_opening_balances_xfm
           FOR xxmx_gl_opening_balances_xfm;           
--
--
/*
*********************************************************
