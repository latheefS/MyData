...
--== Source Data for Cloudbridge 1.0 Toolkit. 
--========================================================================================================
...
@"&1/CORE/DBObjects/xxmx_file_zip_utility_pkg.sqlplb"
@"&1/CORE/DBObjects/xxmx_dm_dashboard_cntl_v.sql"
@"&1/CORE/DBObjects/xxmx_utilities_pkg.sqlplb"
@"&1/CORE/DBObjects/xxmx_dynamic_sql_pkg.sqlplb"
...
@"&1/CORE/DBObjects/xxmx_oic_utilities_pkg.sqlplb"
@"&1/CORE/DBObjects/xxmx_request_scheduling_dbi.sql"
@"&1/CORE/DBObjects/xxmx_request_scheduling_pkg.sqlplb"
@"&1/CORE/DBObjects/xxmx_fin_stg_extract_pkg.sqlplb"
@"&1/CORE/DBObjects/xxmx_hcm_stg_extract_pkg.sqlplb"
...
@"&1/CORE/DBObjects/xxmx_fusion_load_gen_pkg.sqlplb"
@"&1/CORE/DBObjects/xxmx_mapping_ext_dbi.sql"
@"&1/GL/DBObjects/xxmx_validate_code_combinations_cvr_pkg.sql"

--==========================================================================
--== Calling External Table Creation Scripts
--==========================================================================
...
@"&1/GL/DBObjects/xmxx_gl_historical_rates_ext_dbi.sql"
@"&1/PO/DBObjects/xxmx_scm_po_rcpt_ext_dbi.sql"
