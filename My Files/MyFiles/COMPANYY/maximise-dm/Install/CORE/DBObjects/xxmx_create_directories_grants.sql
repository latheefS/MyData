...
--PLC
CREATE OR REPLACE DIRECTORY ITEM AS '/home/oracle/scm/plc/item1/output/';
CREATE OR REPLACE DIRECTORY ITEM_STRUCTURE AS '/home/oracle/scm/plc/item_structure1/output/';

--IM
CREATE OR REPLACE DIRECTORY INVENTORY_TRANSACTIONS AS '/home/oracle/scm/im/inventory_transactions1/output/';

--OM
CREATE OR REPLACE DIRECTORY COST_LISTS AS '/home/oracle/scm/om/cost_lists1/output/';
CREATE OR REPLACE DIRECTORY DISCOUNT_LISTS AS '/home/oracle/scm/om/discount_lists1/output/';
CREATE OR REPLACE DIRECTORY PRICE_LIST AS '/home/oracle/scm/om/price_list1/output/';
CREATE OR REPLACE DIRECTORY SALES_ORDERS AS '/home/oracle/scm/om/sales_orders1/output/';

--MF
CREATE OR REPLACE DIRECTORY PROC_WORK_DEF_IMP AS '/home/oracle/scm/mf/proc_work_def_imp1/output/';
CREATE OR REPLACE DIRECTORY WIE_MATERIAL_TRANS AS '/home/oracle/scm/mf/wie_material_trans1/output/';
CREATE OR REPLACE DIRECTORY WIE_OP_TRANS_INT AS '/home/oracle/scm/mf/wie_op_trans_int1/output/';
CREATE OR REPLACE DIRECTORY WIE_ORDER_IMP AS '/home/oracle/scm/mf/wie_order_imp1/output/';
...
--PLC
GRANT ALL ON DIRECTORY ITEM TO xxmx_core;
GRANT ALL ON DIRECTORY ITEM_STRUCTURE TO xxmx_core;

--IM
GRANT ALL ON DIRECTORY INVENTORY_TRANSACTIONS TO xxmx_core;

--OM
GRANT ALL ON DIRECTORY PRICE_LIST TO xxmx_core;
GRANT ALL ON DIRECTORY DISCOUNT_LISTS TO xxmx_core;
GRANT ALL ON DIRECTORY COST_LISTS TO xxmx_core;
GRANT ALL ON DIRECTORY SALES_ORDERS TO xxmx_core;

--MF
GRANT ALL ON DIRECTORY PROC_WORK_DEF_IMP TO xxmx_core;
GRANT ALL ON DIRECTORY WIE_OP_TRANS_INT TO xxmx_core;
GRANT ALL ON DIRECTORY WIE_MATERIAL_TRANS TO xxmx_core;
GRANT ALL ON DIRECTORY WIE_ORDER_IMP TO xxmx_core;
