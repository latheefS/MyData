...
@"&1/PA/DBObjects/xxmx_ppm_projects_stg_dbi.sql" 
@"&1/FA/DBObjects/xxmx_fa_massadd_stg_dbi.sql"  
@"&1/GL/DBObjects/xmxx_gl_daily_rates_stg_dbi.sql"
@"&1/GL/DBObjects/xmxx_gl_historical_rates_stg_dbi.sql"
@"&1/PO/DBObjects/xxmx_scm_po_rcpt_stg_dbi.sql"
@"&1/AP/DBObjects/xxmx_fin_ap_supp_tax_stg_dbi.sql"
@"&1/AR/DBObjects/xxmx_zx_customer_tax_stg_dbi.sql"
...
@"&1/BEN/DBObjects/xxmx_hcm_ben_stg_dbi.sql"
@"&1/LRN/DBObjects/xxmx_hcm_lrn_stg_tab.sql"
@"&1/RECRUIT/DBObjects/xxmx_hcm_rec_stg_dbi.sql"
@"&1/RECRUIT/DBObjects/xxmx_hcm_rec_stg_dbi.sql"
@"&1/HCM/DBObjects/xxmx_hcm_hr_location_stg_dbi.sql"
@"&1/PAY/DBObjects/xxmx_hcm_payroll_stg_dbi.sql"
@"&1/TM/DBObjects/xxmx_hcm_goal_stg_dbi.sql"
@"&1/TM/DBObjects/xxmx_hcm_gpset_stg_dbi.sql"
@"&1/TM/DBObjects/xxmx_hcm_goal_plan_stg_dbi.sql"
@"&1/TM/DBObjects/xxmx_hcm_performance_document_stg_dbi.sql"
