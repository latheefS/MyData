...
--**
--**
--** FILENAME  :  mxdm_utilities_pkg.sql
--**
...
--
PROMPT
PROMPT Dropping Table xxmx_ap_supp_addrs_xfm
PROMPT
--
EXEC DropTable ('XXMX_AP_SUPP_ADDRS_XFM')
--
--
PROMPT
PROMPT Dropping Table xxmx_ap_supp_bank_accts_xfm
PROMPT
--
EXEC DropTable ('XXMX_AP_SUPP_BANK_ACCTS_XFM')
--
--
PROMPT
PROMPT Dropping Table xxmx_ap_supp_cont_addrs_xfm
PROMPT
--
EXEC DropTable ('XXMX_AP_SUPP_CONT_ADDRS_XFM')
--
--
PROMPT
PROMPT Dropping Table xxmx_ap_supp_contacts_xfm
PROMPT
--
EXEC DropTable ('XXMX_AP_SUPP_CONTACTS_XFM')
--
--
PROMPT
PROMPT Dropping Table xxmx_ap_supp_payees_xfm
PROMPT
--
EXEC DropTable ('XXMX_AP_SUPP_PAYEES_XFM')
--
--
PROMPT
PROMPT Dropping Table xxmx_ap_supp_pmt_instrs_xfm
PROMPT
--
EXEC DropTable ('XXMX_AP_SUPP_PMT_INSTRS_XFM')
--
--
PROMPT
PROMPT Dropping Table xxmx_ap_supp_site_assigns_xfm
PROMPT
--
EXEC DropTable ('XXMX_AP_SUPP_SITE_ASSIGNS_XFM')
--
--
PROMPT
PROMPT Dropping Table xxmx_ap_supplier_sites_xfm
PROMPT
--
EXEC DropTable ('XXMX_AP_SUPPLIER_SITES_XFM')
--
--
PROMPT
PROMPT Dropping Table xxmx_ap_suppliers_xfm
--
EXEC DropTable ('XXMX_AP_SUPPLIERS_XFM')
--
--
PROMPT
PROMPT Dropping Table xxmx_ap_supp_3rd_pty_rels_xfm
PROMPT
--
EXEC DropTable ('XXMX_AP_SUPP_3RD_PTY_RELS_XFM')
--
--
PROMPT ******************
...
--
PROMPT
PROMPT Creating Table xxmx_ap_supp_addrs_xfm
PROMPT
--
--------------------------------------------------------
--  DDL for Table xxmx_ap_supp_addrs_xfm
--------------------------------------------------------

  CREATE TABLE XXMX_XFM.XXMX_AP_SUPP_ADDRS_XFM 
   ( 
...
--
PROMPT
PROMPT Creating Table xxmx_ap_supp_bank_accts_xfm
PROMPT
--
--------------------------------------------------------
--  DDL for Table xxmx_ap_supp_bank_accts_xfm
--------------------------------------------------------

  CREATE TABLE XXMX_XFM.XXMX_AP_SUPP_BANK_ACCTS_XFM 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--
PROMPT
PROMPT Creating Table xxmx_ap_supp_cont_addrs_xfm
PROMPT
--
--------------------------------------------------------
...
--
PROMPT
PROMPT Creating Table xxmx_ap_supp_contacts_xfm
PROMPT
--
--------------------------------------------------------
--  DDL for Table xxmx_ap_supp_contacts_xfm
--------------------------------------------------------

  CREATE TABLE XXMX_XFM.XXMX_AP_SUPP_CONTACTS_XFM 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--
PROMPT
PROMPT Creating Table xxmx_ap_supp_payees_xfm
PROMPT
--
--------------------------------------------------------
--  DDL for Table xxmx_ap_supp_payees_xfm
--------------------------------------------------------

  CREATE TABLE XXMX_XFM.XXMX_AP_SUPP_PAYEES_XFM 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--
PROMPT
PROMPT Creating Table xxmx_ap_supp_pmt_instrs_xfm
PROMPT
--
--------------------------------------------------------
--  DDL for Table xxmx_ap_supp_pmt_instrs_xfm
--------------------------------------------------------

  CREATE TABLE XXMX_XFM.XXMX_AP_SUPP_PMT_INSTRS_XFM
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--
PROMPT
PROMPT Creating Table xxmx_ap_supp_site_assigns_xfm
PROMPT
--
--------------------------------------------------------
--  DDL for Table xxmx_ap_supp_site_assigns_xfm
--------------------------------------------------------

  CREATE TABLE XXMX_XFM.XXMX_AP_SUPP_SITE_ASSIGNS_XFM 
   ( 
     file_set_id                    VARCHAR2(30),      
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--
PROMPT
PROMPT Creating Table xxmx_ap_supplier_sites_xfm
PROMPT
--
--------------------------------------------------------
--  DDL for Table xxmx_ap_supplier_sites_xfm
--------------------------------------------------------

  CREATE TABLE XXMX_XFM.XXMX_AP_SUPPLIER_SITES_XFM 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--
PROMPT
PROMPT Creating Table xxmx_ap_suppliers_xfm
PROMPT
--
--------------------------------------------------------
--  DDL for Table xxmx_ap_suppliers_xfm
--------------------------------------------------------

  CREATE TABLE XXMX_XFM.XXMX_AP_SUPPLIERS_XFM 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
--
PROMPT
PROMPT Creating Table xxmx_ap_supp_3rd_pty_rels_xfm
PROMPT
--
--------------------------------------------------------
--  DDL for Table xxmx_ap_supp_3rd_pty_rels_xfm
--------------------------------------------------------

  CREATE TABLE XXMX_XFM.XXMX_AP_SUPP_3RD_PTY_RELS_XFM 
   ( 
     file_set_id                    VARCHAR2(30),
     migration_set_id NUMBER,
     migration_set_name VARCHAR2(100),                 
...
PROMPT
PROMPT *****************
PROMPT ** Grants script
PROMPT *****************

--------------------------------------------------------
--  Grants script for XFM
--------------------------------------------------------

Grant All on XXMX_XFM.xxmx_ap_supp_addrs_xfm to XXMX_CORE;
Grant All on XXMX_XFM.xxmx_ap_supplier_sites_xfm to XXMX_CORE;
Grant All on XXMX_XFM.xxmx_ap_supp_3rd_pty_rels_xfm to XXMX_CORE;
Grant All on XXMX_XFM.xxmx_ap_supp_site_assigns_xfm to XXMX_CORE;
Grant All on XXMX_XFM.xxmx_ap_supp_contacts_xfm to XXMX_CORE;
Grant All on XXMX_XFM.xxmx_ap_supp_cont_addrs_xfm to XXMX_CORE;
Grant All on XXMX_XFM.xxmx_ap_supp_payees_xfm to XXMX_CORE;
Grant All on XXMX_XFM.xxmx_ap_supp_bank_accts_xfm to XXMX_CORE;
Grant All on XXMX_XFM.XXMX_AP_SUPP_PMT_INSTRS_xfm to XXMX_CORE;
Grant All on XXMX_XFM.XXMX_AP_SUPPLIERS_XFM to XXMX_CORE;
--
