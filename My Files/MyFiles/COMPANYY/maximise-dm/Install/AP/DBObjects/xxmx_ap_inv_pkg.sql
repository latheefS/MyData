...
AS
     ...
     **
     ** PURPOSE   :  This script installs the package for the Cloudbridge AP Invoices
     **              Data Migration.
     **
     ** NOTES     :
     **
     ...
     **   Vsn  Change Date  Changed By          Change Description
     ** -----  -----------  ------------------  -----------------------------------
     **   1.0  23-NOV-2020  Ian S. Vickerstaff  Created for Cloudbridge.
     **
...
END xxmx_ap_inv_pkg;
/
SHOW ERRORS PACKAGE BODY xxmx_ap_inv_pkg;
/
--