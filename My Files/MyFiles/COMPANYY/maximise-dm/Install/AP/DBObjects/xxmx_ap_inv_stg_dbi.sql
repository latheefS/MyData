...
--
CREATE TABLE XXMX_STG.xxmx_ap_invoices_stg
     (
...
*/
--
CREATE TABLE  XXMX_STG.xxmx_ap_invoice_lines_stg
     ( 
	   file_set_id                     VARCHAR2(30)
     ,migration_set_id                NUMBER
     ,migration_set_name              VARCHAR2(100)                 
...
--
--
GRANT ALL ON XXMX_STG.xxmx_ap_invoices_stg TO xxmx_core;
--
--
GRANT ALL ON XXMX_STG.xxmx_ap_invoice_lines_stg TO xxmx_core;
--
--
--
PROMPT
