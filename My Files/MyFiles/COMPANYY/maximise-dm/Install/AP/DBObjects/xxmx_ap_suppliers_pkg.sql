...
AS
     ...
     */
     ...
     gct_BusinessEntity                        		xxmx_migration_metadata.business_entity%TYPE := 'SUPPLIERS';
          ...
          IS
               ...
               WITH payee_details AS
                 ...
                 FROM  apps.iby_external_payees_all@MXDM_NVIS_EXTRACT iepa
                      ,apps.iby_ext_party_pmt_mthds@MXDM_NVIS_EXTRACT iepm
                 ...
                 AND iepa.payment_function='PAYABLES_DISB'
                     ...
                     -- ,NULL                                                           AS tax_organization_type
					  ,nvl(aps.ORGANIZATION_TYPE_LOOKUP_CODE, 'CORPORATION')          AS tax_organization_type
                      ,aps.vendor_type_lookup_code                                    AS supplier_type
                      ,aps.end_date_active                                            AS inactive_date
                    --  ,NULL                                                           AS business_relationship
				 	  ,'SPEND_AUTHORIZED'                                             AS business_relationship
                      ,(
               ...
               FROM    xxmx_supplier_scope_v                xssv
                      ...
                      ,(SELECT  DISTINCT  h.party_id,MEANING
                        FROM jai_party_regs@MXDM_NVIS_EXTRACT h,
     ...
     */
     ...
     BEGIN
          ...
          gvv_ReturnStatus  := '';
          gvt_ReturnMessage := '';
          gct_BusinessEntity   := pt_i_SubEntity;
          --
          xxmx_utilities_pkg.clear_messages
               (
                pt_i_ApplicationSuite => gct_ApplicationSuite
...
--                      ,decode(xssv.org_id,142,substr(remit_to_site.vendor_site_id||'-'||remit_to_site.vendor_site_code,1,15),remit_to_site.vendor_site_code) AS remit_to_address
     ...
     BEGIN
          ...
          gvv_ReturnStatus  := '';
          gvt_ReturnMessage := '';
          gct_BusinessEntity:= 'SUPPLIER_SITES';
          --
          xxmx_utilities_pkg.clear_messages
               (
                pt_i_ApplicationSuite => gct_ApplicationSuite
...
--                         ,assa.vendor_site_code                                             AS address_name
     ...
     BEGIN
          ...
          gvv_ReturnStatus  := '';
          gvt_ReturnMessage := '';
          gct_BusinessEntity := 'SUPPLIER_CONTACT';
          --
          xxmx_utilities_pkg.clear_messages
               (
                pt_i_ApplicationSuite => gct_ApplicationSuite
     ...
     */
     ...
     --
      BEGIN
          ...
          gvv_ReturnStatus  := '';
          gvt_ReturnMessage := '';
          gct_BusinessEntity := 'SUPPLIER_BANK_ACCOUNTS';
          --
          xxmx_utilities_pkg.clear_messages
               (
                pt_i_ApplicationSuite => gct_ApplicationSuite
     ...
     IS
          ...
          IS
               ...
               SELECT  DISTINCT
					  ...
					  ,supplier_pmt_instr_uses.supplier_name                                               AS supplier_name
               ...
               FROM   (
                       ...
                       SELECT  ipiua.ext_pmt_party_id                         AS temp_ext_party_id
                              ...
                              ,NULL                                           AS operating_unit_name
							  ,ppiu.supplier_name                             AS supplier_name	
               ...
               LOOP
                    ...
                    IN     1..ap_supplier_pmt_instrs_tbl.COUNT
                         ...
                         VALUES  (
								   ...
								   ,ap_supplier_pmt_instrs_tbl(i).supplier_name			 -- supplier_name
                                   );
                         --
                    --** END FORALL
                    --
