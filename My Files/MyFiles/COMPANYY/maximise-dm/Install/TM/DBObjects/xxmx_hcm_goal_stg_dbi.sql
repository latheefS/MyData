...
--**
--**
--** FILENAME  :  xxmx_hcm_goal_stg_dbi.sql
--**
...
--** -----  -----------  ------------------  -----------------------------------
--** [ 1.0  05-SEP-2023  Soundarya Kamatagi   Adding stg script for Hcm Talent Management Goal]
--******************************************************************************
--**
--******************************************************************************
--
...
--
--
EXEC DropTable ('XXMX_HCM_GOAL_STG')
EXEC DropTable ('XXMX_HCM_GTARGT_OUTCME_PFILE_ITM_STG')
EXEC DropTable ('XXMX_HCM_GOAL_ACCESS_STG')
EXEC DropTable ('XXMX_HCM_GOAL_ACTION_STG')
EXEC DropTable ('XXMX_HCM_GOAL_ALIGNMENT_STG')
EXEC DropTable ('XXMX_HCM_GOAL_PLAN_GOAL_STG')
EXEC DropTable ('XXMX_HCM_GTARGET_OUTCOME_STG')
EXEC DropTable ('XXMX_HCM_GOAL_MEASUREMENT_STG')
--
--
PROMPT
PROMPT Create Table XXMX_HCM_GOAL_STG
PROMPT
--
--
--
--
CREATE TABLE XXMX_HCM_GOAL_STG(
...
--
PROMPT
PROMPT Create Table XXMX_HCM_GTARGT_OUTCME_PFILE_ITM_STG
PROMPT
--
--
CREATE TABLE XXMX_HCM_GTARGT_OUTCME_PFILE_ITM_STG(
    FILE_SET_ID							          VARCHAR2(30)   
	,MIGRATION_SET_ID					              NUMBER
	,MIGRATION_SET_NAME 					          VARCHAR2(150)
	,MIGRATION_STATUS					              VARCHAR2(50)
...
CREATE TABLE XXMX_HCM_GOAL_ACCESS_STG(
    FILE_SET_ID							                VARCHAR2(30)   
	,MIGRATION_SET_ID					                NUMBER
	,MIGRATION_SET_NAME 					            VARCHAR2(150)
	,MIGRATION_STATUS					                VARCHAR2(50)
...
--
PROMPT
PROMPT Create Table XXMX_HCM_GOAL_ACTION_STG
PROMPT
--
--
CREATE TABLE XXMX_HCM_GOAL_ACTION_STG
(
     FILE_SET_ID							            VARCHAR2(30)   
	,MIGRATION_SET_ID					                NUMBER
	,MIGRATION_SET_NAME 					            VARCHAR2(150)
...
--
PROMPT
PROMPT Create Table XXMX_HCM_GOAL_ALIGNMENT_STG
PROMPT
--
--
CREATE TABLE XXMX_HCM_GOAL_ALIGNMENT_STG(
     FILE_SET_ID							            VARCHAR2(30)   
	,MIGRATION_SET_ID					                NUMBER
	,MIGRATION_SET_NAME 					            VARCHAR2(150)
	,MIGRATION_STATUS					                VARCHAR2(50)
...
--
PROMPT
PROMPT Create Table XXMX_HCM_GOAL_PLAN_GOAL_STG
PROMPT
--
--
CREATE TABLE XXMX_HCM_GOAL_PLAN_GOAL_STG
(
     FILE_SET_ID							            	VARCHAR2(30)   
	,MIGRATION_SET_ID					                	NUMBER
	,MIGRATION_SET_NAME 					            	VARCHAR2(150)
...
--
PROMPT
PROMPT Create Table XXMX_HCM_GTARGET_OUTCOME_STG
PROMPT
--
--
CREATE TABLE XXMX_HCM_GTARGET_OUTCOME_STG
(
     FILE_SET_ID							            	    VARCHAR2(30)   
	,MIGRATION_SET_ID					                	    NUMBER
	,MIGRATION_SET_NAME 					            	    VARCHAR2(150)
...
--
PROMPT
PROMPT Create Table XXMX_HCM_GOAL_MEASUREMENT_STG
PROMPT
--
--

CREATE TABLE XXMX_HCM_GOAL_MEASUREMENT_STG
(
     FILE_SET_ID							            	    VARCHAR2(30)   
	,MIGRATION_SET_ID					                	    NUMBER
	,MIGRATION_SET_NAME 					            	    VARCHAR2(150)
...
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GOAL_STG for XXMX_HCM_GOAL_STG;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GTARGT_OUTCME_PFILE_ITM_STG for XXMX_HCM_GTARGT_OUTCME_PFILE_ITM_STG;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GOAL_ACCESS_STG for XXMX_HCM_GOAL_ACCESS_STG;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GOAL_ACTION_STG for XXMX_HCM_GOAL_ACTION_STG;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GOAL_ALIGNMENT_STG for XXMX_HCM_GOAL_ALIGNMENT_STG;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GOAL_PLAN_GOAL_STG for XXMX_HCM_GOAL_PLAN_GOAL_STG ;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GTARGET_OUTCOME_STG for XXMX_HCM_GTARGET_OUTCOME_STG ;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GOAL_MEASUREMENT_STG for XXMX_HCM_GOAL_MEASUREMENT_STG ;
...
--
--
GRANT ALL ON XXMX_HCM_GOAL_STG TO XXMX_CORE; 
GRANT ALL ON XXMX_HCM_GTARGT_OUTCME_PFILE_ITM_STG TO XXMX_CORE; 
GRANT ALL ON XXMX_HCM_GOAL_ACCESS_STG TO XXMX_CORE; 
GRANT ALL ON XXMX_HCM_GOAL_ACTION_STG TO XXMX_CORE;
GRANT ALL ON XXMX_HCM_GOAL_ALIGNMENT_STG TO XXMX_CORE; 
GRANT ALL ON XXMX_HCM_GOAL_PLAN_GOAL_STG TO XXMX_CORE; 
GRANT ALL ON XXMX_HCM_GTARGET_OUTCOME_STG TO XXMX_CORE; 
GRANT ALL ON XXMX_HCM_GOAL_MEASUREMENT_STG TO XXMX_CORE; 
