...
--**
--**
--** FILENAME  :  xxmx_hcm_performance_document_stg_dbi.sql
--**
...
--
PROMPT
PROMPT Dropping Table XXMX_HCM_PERFORMANCE_DOC_STG
PROMPT
--
EXEC DropTable ('XXMX_HCM_PERFORMANCE_DOC_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_HCM_ATTACHMENT_STG
PROMPT
--
EXEC DropTable ('XXMX_HCM_ATTACHMENT_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_HCM_PARTICIPANT_STG
PROMPT
--
EXEC DropTable ('XXMX_HCM_PARTICIPANT_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_HCM_RATINGS_COMMENTS_STG
PROMPT
--
EXEC DropTable ('XXMX_HCM_RATINGS_COMMENTS_STG')
--
--
PROMPT
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_HCM_PERFORMANCE_DOC_STG
PROMPT
--
...
-- **************************************
CREATE TABLE XXMX_STG.XXMX_HCM_PERFORMANCE_DOC_STG
	(
...
--
PROMPT
PROMPT Creating Table XXMX_HCM_ATTACHMENT_STG
PROMPT
--
-- *******************
-- ** Attachment Table
-- *******************
CREATE TABLE XXMX_STG.XXMX_HCM_ATTACHMENT_STG
	(
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID						NUMBER,
	MIGRATION_SET_NAME						VARCHAR2(150),
...
--
PROMPT
PROMPT Creating Table XXMX_HCM_PARTICIPANT_STG
PROMPT
--
-- ********************
-- ** Participant Table
-- ********************
CREATE TABLE XXMX_STG.XXMX_HCM_PARTICIPANT_STG
	(
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID						NUMBER,
	MIGRATION_SET_NAME						VARCHAR2(150),
...
--
PROMPT
PROMPT Creating Table XXMX_HCM_RATINGS_COMMENTS_STG
PROMPT
--
-- *****************************
-- ** Ratings And Comments Table
-- *****************************
CREATE TABLE XXMX_STG.XXMX_HCM_RATINGS_COMMENTS_STG
	(
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID						NUMBER,
	MIGRATION_SET_NAME						VARCHAR2(150),
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_HCM_PERFORMANCE_DOC_STG FOR XXMX_STG.XXMX_HCM_PERFORMANCE_DOC_STG;
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_HCM_ATTACHMENT_STG FOR XXMX_STG.XXMX_HCM_ATTACHMENT_STG;
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_HCM_PARTICIPANT_STG FOR XXMX_STG.XXMX_HCM_PARTICIPANT_STG;
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_HCM_RATINGS_COMMENTS_STG FOR XXMX_STG.XXMX_HCM_RATINGS_COMMENTS_STG;
--
--
...
--
--
GRANT ALL ON XXMX_STG.XXMX_HCM_PERFORMANCE_DOC_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_HCM_ATTACHMENT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_HCM_PARTICIPANT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_HCM_RATINGS_COMMENTS_STG TO XXMX_CORE;
--
--
