...
--**
--**
--** FILENAME  :  xxmx_hcm_performance_document_XFM_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -----------------------------------
--**   1.0  12-SEP-2023  Shaik Latheef  	 Created Performance Document XFM 
...
--
PROMPT
PROMPT Dropping Table XXMX_HCM_PERFORMANCE_DOC_XFM
PROMPT
--
EXEC DropTable ('XXMX_HCM_PERFORMANCE_DOC_XFM')
--
--
PROMPT
PROMPT Dropping Table XXMX_HCM_ATTACHMENT_XFM
PROMPT
--
EXEC DropTable ('XXMX_HCM_ATTACHMENT_XFM')
--
--
PROMPT
PROMPT Dropping Table XXMX_HCM_PARTICIPANT_XFM
PROMPT
--
EXEC DropTable ('XXMX_HCM_PARTICIPANT_XFM')
--
--
PROMPT
PROMPT Dropping Table XXMX_HCM_RATINGS_COMMENTS_XFM
PROMPT
--
EXEC DropTable ('XXMX_HCM_RATINGS_COMMENTS_XFM')
--
--
PROMPT
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_HCM_PERFORMANCE_DOC_XFM
PROMPT
--
...
-- **************************************
CREATE TABLE XXMX_XFM.XXMX_HCM_PERFORMANCE_DOC_XFM
	(
...
--
PROMPT
PROMPT Creating Table XXMX_HCM_ATTACHMENT_XFM
PROMPT
--
-- *******************
-- ** Attachment Table
-- *******************
CREATE TABLE XXMX_XFM.XXMX_HCM_ATTACHMENT_XFM
	(
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID						NUMBER,
	MIGRATION_SET_NAME						VARCHAR2(150),
...
--
PROMPT
PROMPT Creating Table XXMX_HCM_PARTICIPANT_XFM
PROMPT
--
-- ********************
-- ** Participant Table
-- ********************
CREATE TABLE XXMX_XFM.XXMX_HCM_PARTICIPANT_XFM
	(
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID						NUMBER,
	MIGRATION_SET_NAME						VARCHAR2(150),
...
--
PROMPT
PROMPT Creating Table XXMX_HCM_RATINGS_COMMENTS_XFM
PROMPT
--
-- *****************************
-- ** Ratings And Comments Table
-- *****************************
CREATE TABLE XXMX_XFM.XXMX_HCM_RATINGS_COMMENTS_XFM
	(
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID						NUMBER,
	MIGRATION_SET_NAME						VARCHAR2(150),
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_HCM_PERFORMANCE_DOC_XFM FOR XXMX_XFM.XXMX_HCM_PERFORMANCE_DOC_XFM;
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_HCM_ATTACHMENT_XFM FOR XXMX_XFM.XXMX_HCM_ATTACHMENT_XFM;
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_HCM_PARTICIPANT_XFM FOR XXMX_XFM.XXMX_HCM_PARTICIPANT_XFM;
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_HCM_RATINGS_COMMENTS_XFM FOR XXMX_XFM.XXMX_HCM_RATINGS_COMMENTS_XFM;
--
--
...
--
--
GRANT ALL ON XXMX_XFM.XXMX_HCM_PERFORMANCE_DOC_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_HCM_ATTACHMENT_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_HCM_PARTICIPANT_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_HCM_RATINGS_COMMENTS_XFM TO XXMX_CORE;
--
--
