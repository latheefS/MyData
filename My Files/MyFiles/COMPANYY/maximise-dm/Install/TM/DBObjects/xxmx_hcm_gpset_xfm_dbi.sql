...
--**
--**
--** FILENAME  :  xxmx_hcm_gpset_xfm_dbi.sql
--**
...
--** -----  -----------  ------------------  -----------------------------------
--** [1.0 	20-SEP-2023	 Soundarya Kamatagi		Adding XFM script for Hcm Talent Management Goal Plan Set]
--******************************************************************************
--**
--******************************************************************************
--
...
--
--
EXEC DropTable ('XXMX_HCM_GPSET_XFM')
EXEC DropTable ('XXMX_HCM_GPSET_PLAN_XFM')
EXEC DropTable ('XXMX_HCM_GPSET_MASS_REQ_XFM')
EXEC DropTable ('XXMX_HCM_GPSET_EO_PROF_XFM')
EXEC DropTable ('XXMX_HCM_GPSET_MR_HIER_XFM')
EXEC DropTable ('XXMX_HCM_GPSET_MR_EXEM_XFM')
--
--
--
PROMPT
PROMPT Create Table XXMX_HCM_GPSET_XFM
PROMPT
--


CREATE TABLE XXMX_HCM_GPSET_XFM
   (
...
--
PROMPT
PROMPT Create Table XXMX_HCM_GPSET_PLAN_XFM
PROMPT
--

CREATE TABLE XXMX_HCM_GPSET_PLAN_XFM
   (
    FILE_SET_ID							VARCHAR2(30),
	MIGRATION_SET_ID					NUMBER,
	MIGRATION_SET_NAME 					VARCHAR2(150),
...
--
--
CREATE TABLE XXMX_HCM_GPSET_MASS_REQ_XFM
   (
    FILE_SET_ID							VARCHAR2(30),
	MIGRATION_SET_ID					NUMBER,
	MIGRATION_SET_NAME 					VARCHAR2(150),
...
--
--
CREATE TABLE XXMX_HCM_GPSET_EO_PROF_XFM
   (
    FILE_SET_ID							VARCHAR2(30),
	MIGRATION_SET_ID					NUMBER,
	MIGRATION_SET_NAME 					VARCHAR2(150),
...
--
--
CREATE TABLE XXMX_HCM_GPSET_MR_HIER_XFM
   (
    FILE_SET_ID							VARCHAR2(30),
	MIGRATION_SET_ID					NUMBER,
	MIGRATION_SET_NAME 					VARCHAR2(150),
...
--
--
CREATE TABLE XXMX_HCM_GPSET_MR_EXEM_XFM
   (
    FILE_SET_ID							VARCHAR2(30),
	MIGRATION_SET_ID					NUMBER,
	MIGRATION_SET_NAME 					VARCHAR2(150),
...
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GPSET_XFM for XXMX_HCM_GPSET_XFM;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GPSET_PLAN_XFM for XXMX_HCM_GPSET_PLAN_XFM;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GPSET_MASS_REQ_XFM for XXMX_HCM_GPSET_MASS_REQ_XFM;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GPSET_EO_PROF_XFM for XXMX_HCM_GPSET_EO_PROF_XFM;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GPSET_MR_HIER_XFM for XXMX_HCM_GPSET_MR_HIER_XFM;
CREATE OR REPLACE PUBLIC SYNONYM XXMX_HCM_GPSET_MR_EXEM_XFM  for XXMX_HCM_GPSET_MR_EXEM_XFM ;
...
GRANT ALL ON XXMX_HCM_GPSET_XFM TO XXMX_CORE; 
GRANT ALL ON XXMX_HCM_GPSET_PLAN_XFM TO XXMX_CORE; 
GRANT ALL ON XXMX_HCM_GPSET_MASS_REQ_XFM TO XXMX_CORE; 
GRANT ALL ON XXMX_HCM_GPSET_EO_PROF_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_HCM_GPSET_MR_HIER_XFM TO XXMX_CORE; 
GRANT ALL ON XXMX_HCM_GPSET_MR_EXEM_XFM TO XXMX_CORE; 
