...
--**
--**
--** FILENAME  :  xxmx_zx_customer_tax_stg_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  --------------------------------------------
--**   1.0  19-MAY-2022  Shaik Latheef       Created Customer Tax STG tables for Maximise
--***************************************************************************************
--**
...
PROMPT
PROMPT
EXEC DropTable ('XXMX_ZX_TAX_PROFILE_STG')
EXEC DropTable ('XXMX_ZX_TAX_REGISTRATION_STG')
EXEC DropTable ('XXMX_ZX_PARTY_CLASSIFIC_STG')
--
--
PROMPT
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_ZX_TAX_PROFILE_STG
PROMPT
--
...
-- **********************************
CREATE TABLE XXMX_ZX_TAX_PROFILE_STG
	(
...
--
PROMPT
PROMPT Creating Table XXMX_ZX_TAX_REGISTRATION_STG
PROMPT
--
...
-- *************************
CREATE TABLE  XXMX_ZX_TAX_REGISTRATION_STG
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_ZX_PARTY_CLASSIFIC_STG
PROMPT
--
...
-- *****************************
CREATE TABLE  XXMX_ZX_PARTY_CLASSIFIC_STG
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_ZX_TAX_PROFILE_STG FOR XXMX_STG.XXMX_ZX_TAX_PROFILE_STG;
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_ZX_TAX_REGISTRATION_STG FOR XXMX_STG.XXMX_ZX_TAX_REGISTRATION_STG;
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_ZX_PARTY_CLASSIFIC_STG FOR XXMX_STG.XXMX_ZX_PARTY_CLASSIFIC_STG;
--
--
...
--
--
GRANT ALL ON XXMX_STG.XXMX_ZX_TAX_PROFILE_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_ZX_TAX_REGISTRATION_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_ZX_PARTY_CLASSIFIC_STG TO XXMX_CORE;
--
--
