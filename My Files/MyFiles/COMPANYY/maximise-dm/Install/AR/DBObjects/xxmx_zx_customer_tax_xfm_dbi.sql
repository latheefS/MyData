...
--**
--**
--** FILENAME  :  xxmx_zx_customer_tax_xfm_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  --------------------------------------------
--**   1.0  19-MAY-2022  Shaik Latheef       Created Customer Tax XFM tables for Maximise
--***************************************************************************************
--**
...
PROMPT *************************************************************
PROMPT **
PROMPT ** Installing Database Objects for Maximise ZX Data Migration
PROMPT **
PROMPT *************************************************************
PROMPT
PROMPT
...
PROMPT
PROMPT
EXEC DropTable ('XXMX_ZX_TAX_PROFILE_XFM')
EXEC DropTable ('XXMX_ZX_TAX_REGISTRATION_XFM')
EXEC DropTable ('XXMX_ZX_PARTY_CLASSIFIC_XFM')
--
--
PROMPT
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_ZX_TAX_PROFILE_XFM
PROMPT
--
...
--
-- **********************************
-- **Party Tax Profile Controls Table
-- **********************************
CREATE TABLE XXMX_ZX_TAX_PROFILE_XFM
	(
...
--
PROMPT
PROMPT Creating Table XXMX_ZX_TAX_REGISTRATION_XFM
PROMPT
--
...
-- *************************
CREATE TABLE  XXMX_ZX_TAX_REGISTRATION_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_ZX_PARTY_CLASSIFIC_XFM
PROMPT
--
...
-- *****************************
CREATE TABLE  XXMX_ZX_PARTY_CLASSIFIC_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_ZX_TAX_PROFILE_XFM FOR XXMX_XFM.XXMX_ZX_TAX_PROFILE_XFM;
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_ZX_TAX_REGISTRATION_XFM FOR XXMX_XFM.XXMX_ZX_TAX_REGISTRATION_XFM;
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_ZX_PARTY_CLASSIFIC_XFM FOR XXMX_XFM.XXMX_ZX_PARTY_CLASSIFIC_XFM;
--
--
...
--
--
GRANT ALL ON XXMX_XFM.XXMX_ZX_TAX_PROFILE_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_ZX_TAX_REGISTRATION_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_ZX_PARTY_CLASSIFIC_XFM TO XXMX_CORE;
--
--
...
PROMPT ***********************************************************************
PROMPT **                                
PROMPT ** Completed Installing Database Objects for Maximise ZX Data Migration
PROMPT **                                
PROMPT ***********************************************************************
PROMPT
PROMPT
