...
--**
--**
--** FILENAME  :  xxmx_ar_trx_xfm_dbi.sql
--**
...
--**
--** PURPOSE   :  This script installs the XXMX_XFM schema database objects for
...
--**                                         Limited version.
--**
--**   1.1  17-NOV-2020  David Fuller        Add LEDGER_NAME to xxmx_ar_trx_dists_xfm
--**
--**   1.2  12-MAY-2021  Ian S. Vickerstaff  Added XXMX_CUSTOMER_TRX_ID,
--**                                         XXMX_CUSTOMER_TRX_LINE_ID,
--**                                         XXMX_LINE_NUMBER and
--**                                         XXMX_ORIG_TRX_LINE_AMOUNT columns
--**                                         to the XXMX_AR_TRX_LINES_XFM table.
--**
--**                                         Added XXMX_CUSTOMER_TRX_ID, 
--**                                         XXMX_CUSTOMER_TRX_LINE_ID,
--**                                         XXMX_CUST_TRX_LINE_GL_DIST_ID and
--**                                         XXMX_ORIG_AMOUNT columns to the
--**                                         the XXMX_AR_TRX_DISTS_XFM table.
--**
--**                                         Added XXMX_CUSTOMER_TRX_ID and 
--**                                         XXMX_CUSTOMER_TRX_LINE_ID columns
--**                                         to the XXMX_AR_TRX_SALESCREDITS_XFM
--**                                         table.
--**
--**   1.3  16-JUN-2021  Ian S. Vickerstaff  Added XXMX_CUST_TRX_LINE_SALESREP_ID
--**                                         and XXMX_ORIG_SC_AMOUNT_SPLIT columns
--**                                         to the XXMX_AR_TRX_SALESCREDITS_XFM
--**                                         table.
--**
--**   1.4  08-JUL-2021  Ian S. Vickerstaff  Added XXMX_ORIG_UNIT_SELLING_PRICE
--**                                         columns to the XXMX_AR_TRX_LINES_XFM
--**                                         table.
--**
...
PROMPT
--
EXEC DropTable (' XXMX_AR_TRX_LINES_XFM')
EXEC DropTable (' XXMX_AR_TRX_DISTS_XFM')
EXEC DropTable (' XXMX_AR_TRX_SALESCREDITS_XFM')
--
--
--
PROMPT
...
--
/*
** TABLE : xxmx_ar_trx_lines_xfm
*/
--
CREATE TABLE  xxmx_xfm.xxmx_ar_trx_lines_xfm
     (
...
--
/*
** TABLE : xxmx_ar_trx_dists_xfm
*/
--
CREATE TABLE  xxmx_xfm.xxmx_ar_trx_dists_xfm
     (
      file_set_id                     VARCHAR2(30)
	 ,migration_set_id                NUMBER
     ,migration_set_name              VARCHAR2(150)
...
--
PROMPT
PROMPT Granting permissions on xxmx_ar_trx_lines_xfm to the XXMX_CORE Schema
PROMPT
--
GRANT ALL ON  xxmx_xfm.xxmx_ar_trx_lines_xfm
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_ar_trx_dists_xfm to the XXMX_CORE Schema
PROMPT
--
GRANT ALL ON  xxmx_xfm.xxmx_ar_trx_dists_xfm
          TO XXMX_CORE;
--
--
PROMPT
PROMPT Granting permissions on xxmx_ar_trx_salescredits_xfm to the XXMX_CORE Schema
PROMPT
--
GRANT ALL ON  xxmx_xfm.xxmx_ar_trx_salescredits_xfm
          TO XXMX_CORE;
--
--
PROMPT
