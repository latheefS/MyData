...
--**
--**
--** FILENAME  :  xxmx_ppm_projects_xfm_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  ----------------------------------------------------
--**   1.0  10-JAN-2023    Shaik Latheef  	 Created PPM Projects XFM tables for Cloudbridge.
--** 
--***********************************************************************************************
--**
...
PROMPT
--
EXEC DropTable ('XXMX_PPM_PROJECTS_XFM')
EXEC DropTable ('XXMX_PPM_PRJ_TASKS_XFM')
EXEC DropTable ('XXMX_PPM_PRJ_TRX_CONTROL_XFM')
EXEC DropTable ('XXMX_PPM_PRJ_TEAM_MEM_XFM')
EXEC DropTable ('XXMX_PPM_PRJ_CLASS_XFM')
EXEC DropTable ('XXMX_PPM_PLANRBS_HEADER_XFM')
EXEC DropTable ('XXMX_PPM_RESOURCES_XFM')
EXEC DropTable ('XXMX_PPM_PRJ_BILLEVENT_XFM')
EXEC DropTable ('XXMX_PPM_PRJ_MISCCOST_XFM')
EXEC DropTable ('XXMX_PPM_PRJ_LBRCOST_XFM')
EXEC DropTable ('XXMX_PPM_PRJ_SUPCOST_XFM')
EXEC DropTable ('XXMX_PPM_PRJ_NONLABCOST_XFM')
--
--
--
PROMPT
...
-- **Projects Table
-- ****************
CREATE TABLE  XXMX_PPM_PROJECTS_XFM
    (
...
-- **Tasks Table
-- *************
CREATE TABLE  XXMX_PPM_PRJ_TASKS_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
-- ****************************
CREATE TABLE  XXMX_PPM_PRJ_TRX_CONTROL_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
-- **Team Members Table
-- ********************
CREATE TABLE  XXMX_PPM_PRJ_TEAM_MEM_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
-- *****************************
CREATE TABLE  XXMX_PPM_PRJ_CLASS_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
-- **RBS Header Table
-- ******************
CREATE TABLE  XXMX_PPM_PLANRBS_HEADER_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
-- **Resources Table
-- *****************
CREATE TABLE  XXMX_PPM_RESOURCES_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
-- **********************
CREATE TABLE  XXMX_PPM_PRJ_BILLEVENT_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
-- **************************
CREATE TABLE  XXMX_PPM_PRJ_MISCCOST_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
-- **Labor Cost Table
-- ******************
CREATE TABLE  XXMX_PPM_PRJ_LBRCOST_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
-- **Supplier Cost Table
-- *********************
CREATE TABLE  XXMX_PPM_PRJ_SUPCOST_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
...
-- **********************
CREATE TABLE  XXMX_PPM_PRJ_NONLABCOST_XFM
    (
	FILE_SET_ID								VARCHAR2(30),
	MIGRATION_SET_ID                		NUMBER,
	MIGRATION_SET_NAME              		VARCHAR2(100),
