...
--
 ...
 ORDER BY asg_person_id, asg_effective_start_date, asg_assignment_sequence;
  ...
  SELECT  DISTINCT
        ...
        ,wrs.PERSONNUMBER                                   wrs_person_number  
  ...
  SELECT  DISTINCT 
        ...
        ,TO_CHAR(pp.effective_start_date,'RRRR/MM/DD')     effective_start_date
        ,TO_CHAR(pp.effective_end_date,'RRRR/MM/DD')       effective_end_date
        ,pp.PERSONNUMBER				    pps_person_number
        ,TO_CHAR(PP.start_date,'RRRR/MM/DD')               pps_start_date
       ...
       WHERE  pp.BG_name = nid.BG_name
         AND nid.migration_set_id = pp.migration_set_id
