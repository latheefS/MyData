create or replace PACKAGE xxmx_hcm_person_ext_pkg 
AS
--*****************************************************************************
--**
...
--**
--**
--** FILENAME  :  xxmx_hcm_person_ext_pkg.sql
--**
...
--**
--** PURPOSE   :  This script installs the package specification for the HCM Extensions
--**
--** NOTES     :
--**
--******************************************************************************
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -----------------------------------
--**   1.0  27-JAN-2022  Pallavi              Created from original V1 Solutions
--**                                         Limited version.
--******************************************************************************
--**
...
create or replace PACKAGE BODY xxmx_hcm_person_ext_pkg 
AS
    --
	 --
     /*
...
/
SHOW ERRORS PACKAGE BODY xxmx_hcm_person_ext_pkg;
/