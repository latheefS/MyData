...
--**
--**
--** FILENAME  : xxmx_scm_work_order_imp_xfm_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  17-SEP-2024  Sinchana Ramesh     Created Process Work Order Import XFM tables for Cloudbridge.
--**
--**************************************************************************************
--**
...
--
--
PROMPT Dropping Table XXMX_SCM_WORK_ORDER_BATCHES_XFM
PROMPT
EXEC DropTable('XXMX_SCM_WORK_ORDER_BATCHES_XFM');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_WORK_ORDER_HEADER_XFM
PROMPT
EXEC DropTable('XXMX_SCM_WORK_ORDER_HEADER_XFM');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_WORK_ORDER_OPERATIONS_XFM
PROMPT
EXEC DropTable('XXMX_SCM_WORK_ORDER_OPERATIONS_XFM');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_WORK_ORDER_OPERATION_RESOURCES_XFM
PROMPT
EXEC DropTable('XXMX_SCM_WORK_ORDER_OPERATION_RESOURCES_XFM');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_WORK_ORDER_OPN_RES_INSTANCES_XFM
PROMPT
EXEC DropTable('XXMX_SCM_WORK_ORDER_OPN_RES_INSTANCES_XFM');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_WORK_ORDER_OPERATION_MATERIALS_XFM
PROMPT
EXEC DropTable('XXMX_SCM_WORK_ORDER_OPERATION_MATERIALS_XFM');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_WORK_ORDER_OPERATION_OUTPUTS_XFM
PROMPT
EXEC DropTable('XXMX_SCM_WORK_ORDER_OPERATION_OUTPUTS_XFM');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_WORK_ORDER_PRODUCT_LOT_NUMBERS_XFM
PROMPT
EXEC DropTable('XXMX_SCM_WORK_ORDER_PRODUCT_LOT_NUMBERS_XFM');
--
--
--
--
PROMPT
PROMPT Creating Table XXMX_SCM_WORK_ORDER_BATCHES_XFM
PROMPT
...
-- ** Work Order Batches
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_WORK_ORDER_BATCHES_XFM 
(
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_WORK_ORDER_HEADER_XFM
PROMPT
...
-- ** Work Order Header
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_WORK_ORDER_HEADER_XFM 
(
    FILE_SET_ID                        VARCHAR2(30),
    MIGRATION_SET_ID                   NUMBER,
    MIGRATION_SET_NAME                 VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_WORK_ORDER_OPERATIONS_XFM
PROMPT
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATIONS_XFM 
(
    FILE_SET_ID                     VARCHAR2(30),
    MIGRATION_SET_ID                NUMBER,
    MIGRATION_SET_NAME              VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_WORK_ORDER_OPERATION_RESOURCES_XFM
PROMPT
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATION_RESOURCES_XFM 
(
    FILE_SET_ID                          VARCHAR2(30),
    MIGRATION_SET_ID                     NUMBER,
    MIGRATION_SET_NAME                   VARCHAR2(100),
...
--
PROMPT 
PROMPT Please create table XXMX_SCM_WORK_ORDER_OPN_RES_INSTANCES_XFM
PROMPT
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_WORK_ORDER_OPN_RES_INSTANCES_XFM 
(
    FILE_SET_ID                  VARCHAR2(30),
    MIGRATION_SET_ID             NUMBER,
    MIGRATION_SET_NAME           VARCHAR2(100),
...
--
PROMPT 
PROMPT Creating Table XXMX_SCM_WORK_ORDER_OPERATION_MATERIALS_XFM
PROMPT
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATION_MATERIALS_XFM 
(
    FILE_SET_ID                  VARCHAR2(30),
    MIGRATION_SET_ID             NUMBER,
    MIGRATION_SET_NAME           VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_WORK_ORDER_OPERATION_OUTPUTS_XFM
PROMPT
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATION_OUTPUTS_XFM 
(
    FILE_SET_ID                      VARCHAR2(30),
    MIGRATION_SET_ID                 NUMBER,
    MIGRATION_SET_NAME               VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_WORK_ORDER_PRODUCT_LOT_NUMBERS_XFM
PROMPT
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_WORK_ORDER_PRODUCT_LOT_NUMBERS_XFM 
(
    FILE_SET_ID            VARCHAR2(30),
    MIGRATION_SET_ID       NUMBER,
    MIGRATION_SET_NAME     VARCHAR2(100),
...
--
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_WORK_ORDER_BATCHES_XFM for XXMX_XFM.XXMX_SCM_WORK_ORDER_BATCHES_XFM;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_WORK_ORDER_HEADER_XFM for XXMX_XFM.XXMX_SCM_WORK_ORDER_HEADER_XFM;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_WORK_ORDER_OPERATIONS_XFM for XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATIONS_XFM;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_WORK_ORDER_OPERATION_RESOURCES_XFM for XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATION_RESOURCES_XFM;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_WORK_ORDER_OPN_RES_INSTANCES_XFM for XXMX_XFM.XXMX_SCM_WORK_ORDER_OPN_RES_INSTANCES_XFM;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_WORK_ORDER_OPERATION_MATERIALS_XFM for XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATION_MATERIALS_XFM;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_WORK_ORDER_OPERATION_OUTPUTS_XFM for XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATION_OUTPUTS_XFM;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_WORK_ORDER_PRODUCT_LOT_NUMBERS_XFM for XXMX_XFM.XXMX_SCM_WORK_ORDER_PRODUCT_LOT_NUMBERS_XFM;
--
--
--
PROMPT
...
--
--
GRANT ALL ON XXMX_XFM.XXMX_SCM_WORK_ORDER_BATCHES_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_WORK_ORDER_HEADER_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATIONS_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATION_RESOURCES_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_WORK_ORDER_OPN_RES_INSTANCES_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATION_MATERIALS_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_WORK_ORDER_OPERATION_OUTPUTS_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_WORK_ORDER_PRODUCT_LOT_NUMBERS_XFM TO XXMX_CORE;
--
PROMPT
PROMPT
PROMPT *************************************************************************************************************************
PROMPT **
PROMPT ** Completed Installing Database Objects for Cloudbridge Process Process Work Order Import Data Migration
PROMPT **
PROMPT *************************************************************************************************************************
PROMPT
PROMPT
