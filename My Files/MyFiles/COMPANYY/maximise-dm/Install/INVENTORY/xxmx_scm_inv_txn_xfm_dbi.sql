...
--**
--**
--** FILENAME  :  xxmx_scm_inv_txn_xfm_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -----------------------------------
--**   1.0  19-JUL-2024  Sinchana Ramesh     Created Inventory Transaction XFM tables for Maximise.
--**   
--******************************************************************************
--**
...
PROMPT ******************************************************************
PROMPT **
PROMPT ** Installing Database Objects for Maximise INV TXN Data Migration
PROMPT **
PROMPT ******************************************************************
PROMPT
PROMPT
...
--
PROMPT
PROMPT Dropping Table XXMX_SCM_INV_TXNS_XFM
PROMPT
--
DROP TABLE XXMX_SCM_INV_TXNS_XFM;
--
PROMPT
PROMPT Dropping Table XXMX_SCM_INV_TXN_LOTS_XFM
PROMPT
--
DROP TABLE XXMX_SCM_INV_TXN_LOTS_XFM;
--
PROMPT
PROMPT Dropping Table XXMX_SCM_INV_SER_NUMS_XFM
PROMPT
--
DROP TABLE XXMX_SCM_INV_SER_NUMS_XFM;
--
PROMPT
PROMPT Dropping Table XXMX_SCM_INV_TXN_COSTS_XFM
PROMPT
--
DROP TABLE XXMX_SCM_INV_TXN_COSTS_XFM;
--
PROMPT
PROMPT
PROMPT ******************
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_INV_TXNS_XFM
PROMPT
...
-- ******************************
CREATE TABLE XXMX_XFM.XXMX_SCM_INV_TXNS_XFM
    (
...
---
PROMPT
PROMPT Creating Table XXMX_SCM_INV_TXN_LOTS_XFM
PROMPT
---
-- **********************
-- **Inventory Lots Table
-- **********************
CREATE TABLE XXMX_XFM.XXMX_SCM_INV_TXN_LOTS_XFM
    (
    FILE_SET_ID                                 VARCHAR2(30),
    MIGRATION_SET_ID                            NUMBER,
    MIGRATION_SET_NAME                          VARCHAR2(100),
...
---
PROMPT
PROMPT Creating Table XXMX_SCM_INV_SER_NUMS_XFM
PROMPT
---
-- ********************************
-- **Inventory Serial Numbers Table
-- ********************************
CREATE TABLE XXMX_XFM.XXMX_SCM_INV_SER_NUMS_XFM
    (
    FILE_SET_ID                                 VARCHAR2(30),
    MIGRATION_SET_ID                            NUMBER,
    MIGRATION_SET_NAME                          VARCHAR2(100),
...
--- 
PROMPT
PROMPT Creating Table XXMX_SCM_INV_TXN_COSTS_XFM
PROMPT
---
-- *************************
-- **Transaction Costs Table
-- *************************
CREATE TABLE XXMX_XFM.XXMX_SCM_INV_TXN_COSTS_XFM
    (
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_INV_TXNS_XFM FOR XXMX_XFM.XXMX_SCM_INV_TXNS_XFM;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_INV_TXN_LOTS_XFM FOR XXMX_XFM.XXMX_SCM_INV_TXN_LOTS_XFM;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_INV_SER_NUMS_XFM FOR XXMX_XFM.XXMX_SCM_INV_SER_NUMS_XFM;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_INV_TXN_COSTS_XFM FOR XXMX_XFM.XXMX_SCM_INV_TXN_COSTS_XFM;
--
--
...
--
--
GRANT ALL ON XXMX_XFM.XXMX_SCM_INV_TXNS_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_INV_TXN_LOTS_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_INV_SER_NUMS_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_INV_TXN_COSTS_XFM TO XXMX_CORE;
--
--
...
PROMPT ****************************************************************************
PROMPT **                                
PROMPT ** Completed Installing Database Objects for Maximise INV TXN Data Migration
PROMPT **                                
PROMPT ****************************************************************************
PROMPT
PROMPT
