...
--**
--**
--** FILENAME  : xxmx_scm_sales_orders_stg_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  20-AUG-2024  Sinchana Ramesh     Created SALES ORDERS STG tables for Cloudbridge.
--**
--**************************************************************************************
--**
...
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_HEADERS_ALL_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_HEADERS_ALL_INT_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_LINES_ALL_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_LINES_ALL_INT_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_ADDRESSES_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_ADDRESSES_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_TXN_ATTRIBUTES_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_TXN_ATTRIBUTES_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_SALES_CREDITS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_SALES_CREDITS_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_PAYMENTS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_PAYMENTS_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_LOT_SERIALS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_LOT_SERIALS_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_DOC_REFERENCES_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_DOC_REFERENCES_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_CHARGES_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_CHARGES_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_CHARGE_COMPS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_CHARGE_COMPS_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_BILLING_PLANS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_BILLING_PLANS_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_MANUAL_PRICE_ADJ_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_MANUAL_PRICE_ADJ_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_HDRS_ALL_EFF_B_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_HDRS_ALL_EFF_B_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_LINES_ALL_EFF_B_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_LINES_ALL_EFF_B_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_PROJECTS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_PROJECTS_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_TERMS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_TERMS_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_DOO_ORDER_CHARGE_TIERS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_DOO_ORDER_CHARGE_TIERS_INT_STG')
--
--
--
--
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_HEADERS_ALL_INT_STG
PROMPT
...
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_HEADERS_ALL_INT_STG 
(
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_LINES_ALL_INT_STG
PROMPT
...
-- ** Order Lines Import
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_LINES_ALL_INT_STG 
(
    FILE_SET_ID                                                     VARCHAR2(30),
    MIGRATION_SET_ID                                                NUMBER,
    MIGRATION_SET_NAME                                              VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_ADDRESSES_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_ADDRESSES_INT_STG 
(
    FILE_SET_ID                                          VARCHAR2(30),
    MIGRATION_SET_ID                                     NUMBER,
    MIGRATION_SET_NAME                                   VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_TXN_ATTRIBUTES_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_TXN_ATTRIBUTES_INT_STG 
(
    FILE_SET_ID                                        VARCHAR2(30),
    MIGRATION_SET_ID                                   NUMBER,
    MIGRATION_SET_NAME                                 VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_SALES_CREDITS_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_SALES_CREDITS_INT_STG 
(
    FILE_SET_ID                                        VARCHAR2(30),
    MIGRATION_SET_ID                                   NUMBER,
    MIGRATION_SET_NAME                                 VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_PAYMENTS_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_PAYMENTS_INT_STG (
    FILE_SET_ID                                         VARCHAR2(30),
    MIGRATION_SET_ID                                    NUMBER,
    MIGRATION_SET_NAME                                  VARCHAR2(100),
    MIGRATION_STATUS                                    VARCHAR2(50),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_LOT_SERIALS_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_LOT_SERIALS_INT_STG 
(
    FILE_SET_ID                                      VARCHAR2(30),
    MIGRATION_SET_ID                                 NUMBER,
    MIGRATION_SET_NAME                               VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_DOC_REFERENCES_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_DOC_REFERENCES_INT_STG 
(
    FILE_SET_ID                                      VARCHAR2(30),
    MIGRATION_SET_ID                                 NUMBER,
    MIGRATION_SET_NAME                               VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_CHARGES_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_CHARGES_INT_STG 
(
    FILE_SET_ID                                         VARCHAR2(30),
    MIGRATION_SET_ID                                    NUMBER,
    MIGRATION_SET_NAME                                  VARCHAR2(100),
...
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_CHARGE_COMPS_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_CHARGE_COMPS_INT_STG 
(
    FILE_SET_ID                                     VARCHAR2(30),
    MIGRATION_SET_ID                                NUMBER,
    MIGRATION_SET_NAME                              VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_BILLING_PLANS_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_BILLING_PLANS_INT_STG 
(
    FILE_SET_ID                                     VARCHAR2(30),
    MIGRATION_SET_ID                                NUMBER,
    MIGRATION_SET_NAME                              VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_MANUAL_PRICE_ADJ_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_MANUAL_PRICE_ADJ_INT_STG 
(
    FILE_SET_ID                                        VARCHAR2(30),
    MIGRATION_SET_ID                                   NUMBER,
    MIGRATION_SET_NAME                                 VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_HDRS_ALL_EFF_B_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_HDRS_ALL_EFF_B_INT_STG 
(
    FILE_SET_ID                                       VARCHAR2(30),
    MIGRATION_SET_ID                                  NUMBER,
    MIGRATION_SET_NAME                                VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_LINES_ALL_EFF_B_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_LINES_ALL_EFF_B_INT_STG 
(
    FILE_SET_ID                                       VARCHAR2(30),
    MIGRATION_SET_ID                                  NUMBER,
    MIGRATION_SET_NAME                                VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_PROJECTS_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_PROJECTS_INT_STG 
(
    FILE_SET_ID                                       VARCHAR2(30),
    MIGRATION_SET_ID                                  NUMBER,
    MIGRATION_SET_NAME                                VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_TERMS_INT_STG
PROMPT
...
-- ** Order Terms Import
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_TERMS_INT_STG 
(
    FILE_SET_ID                                     VARCHAR2(30),
    MIGRATION_SET_ID                                NUMBER,
    MIGRATION_SET_NAME                              VARCHAR2(100),
...
--
PROMPT
PROMPT CREATING TABLE XXMX_SCM_DOO_ORDER_CHARGE_TIERS_INT_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_DOO_ORDER_CHARGE_TIERS_INT_STG 
(
    FILE_SET_ID                                     VARCHAR2(30),
    MIGRATION_SET_ID                                NUMBER,
    MIGRATION_SET_NAME                              VARCHAR2(100),
...
--
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_HEADERS_ALL_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_HEADERS_ALL_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_LINES_ALL_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_LINES_ALL_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_ADDRESSES_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_ADDRESSES_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_TXN_ATTRIBUTES_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_TXN_ATTRIBUTES_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_SALES_CREDITS_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_SALES_CREDITS_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_PAYMENTS_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_PAYMENTS_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_LOT_SERIALS_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_LOT_SERIALS_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_DOC_REFERENCES_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_DOC_REFERENCES_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_CHARGES_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_CHARGES_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_CHARGE_COMPS_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_CHARGE_COMPS_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_BILLING_PLANS_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_BILLING_PLANS_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_MANUAL_PRICE_ADJ_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_MANUAL_PRICE_ADJ_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_HDRS_ALL_EFF_B_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_HDRS_ALL_EFF_B_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_LINES_ALL_EFF_B_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_LINES_ALL_EFF_B_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_PROJECTS_INT_STG for XXMX_STG.XXMX_SCM_DOO_PROJECTS_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_TERMS_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_TERMS_INT_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_DOO_ORDER_CHARGE_TIERS_INT_STG for XXMX_STG.XXMX_SCM_DOO_ORDER_CHARGE_TIERS_INT_STG;
--
--
--
PROMPT
...
--
--
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_HEADERS_ALL_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_LINES_ALL_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_ADDRESSES_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_TXN_ATTRIBUTES_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_SALES_CREDITS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_PAYMENTS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_LOT_SERIALS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_DOC_REFERENCES_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_CHARGES_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_CHARGE_COMPS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_BILLING_PLANS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_MANUAL_PRICE_ADJ_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_HDRS_ALL_EFF_B_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_LINES_ALL_EFF_B_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_PROJECTS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_TERMS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_DOO_ORDER_CHARGE_TIERS_INT_STG TO XXMX_CORE;
--
--
--
PROMPT
