...
--**
--**
--** FILENAME  : xxmx_scm_work_def_imp_stg_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  16-SEP-2024  Sinchana Ramesh     Created WORK DEFINITION IMPORT STG tables for Cloudbridge.
--**
--**************************************************************************************
--**
...
--
--
PROMPT Dropping Table XXMX_SCM_IMPORT_BATCHES_STG
PROMPT
EXEC DropTable('XXMX_SCM_IMPORT_BATCHES_STG');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_WORK_DEFINITION_HEADERS_STG
PROMPT
EXEC DropTable('XXMX_SCM_WORK_DEFINITION_HEADERS_STG');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_WORK_DEFINITION_OPERATIONS_STG
PROMPT
EXEC DropTable('XXMX_SCM_WORK_DEFINITION_OPERATIONS_STG');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_OPERATION_ITEMS_STG
PROMPT
EXEC DropTable('XXMX_SCM_OPERATION_ITEMS_STG');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_OPERATION_OUTPUTS_STG
PROMPT
EXEC DropTable('XXMX_SCM_OPERATION_OUTPUTS_STG');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_OPERATION_RESOURCES_STG
PROMPT
EXEC DropTable('XXMX_SCM_OPERATION_RESOURCES_STG');
--
--
--
--
PROMPT Dropping Table XXMX_SCM_OPERATION_ALTERNATE_RESOURCES_STG
PROMPT
EXEC DropTable('XXMX_SCM_OPERATION_ALTERNATE_RESOURCES_STG');
--
--
--
--
PROMPT
PROMPT Creating Table XXMX_SCM_IMPORT_BATCHES_STG
PROMPT
...
-- ** Import Batches
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_IMPORT_BATCHES_STG 
(
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_WORK_DEFINITION_HEADERS_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_WORK_DEFINITION_HEADERS_STG 
(
    FILE_SET_ID                    VARCHAR2(30),
    MIGRATION_SET_ID               NUMBER,
    MIGRATION_SET_NAME             VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_WORK_DEFINITION_OPERATIONS_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_WORK_DEFINITION_OPERATIONS_STG 
(
    FILE_SET_ID                      VARCHAR2(30),
    MIGRATION_SET_ID                 NUMBER,
    MIGRATION_SET_NAME               VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_OPERATION_ITEMS_STG
PROMPT
...
CREATE TABLE XXMX_STG.XXMX_SCM_OPERATION_ITEMS_STG 
(
    FILE_SET_ID                    VARCHAR2(30),
    MIGRATION_SET_ID               NUMBER,
    MIGRATION_SET_NAME             VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_OPERATION_OUTPUTS_STG
PROMPT
...
CREATE TABLE XXMX_STG.XXMX_SCM_OPERATION_OUTPUTS_STG 
(
    FILE_SET_ID                    VARCHAR2(30),
    MIGRATION_SET_ID               NUMBER,
    MIGRATION_SET_NAME             VARCHAR2(100),
...
PROMPT
PROMPT Creating Table XXMX_SCM_OPERATION_RESOURCES_STG
PROMPT
...
CREATE TABLE XXMX_STG.XXMX_SCM_OPERATION_RESOURCES_STG 
(
    FILE_SET_ID                  VARCHAR2(30),
    MIGRATION_SET_ID             NUMBER,
    MIGRATION_SET_NAME           VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_OPERATION_ALTERNATE_RESOURCES_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_OPERATION_ALTERNATE_RESOURCES_STG 
(
    FILE_SET_ID              VARCHAR2(30),
    MIGRATION_SET_ID         NUMBER,
    MIGRATION_SET_NAME       VARCHAR2(100),
...
--
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_IMPORT_BATCHES_STG for XXMX_STG.XXMX_SCM_IMPORT_BATCHES_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_WORK_DEFINITION_HEADERS_STG for XXMX_STG.XXMX_SCM_WORK_DEFINITION_HEADERS_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_WORK_DEFINITION_OPERATIONS_STG for XXMX_STG.XXMX_SCM_WORK_DEFINITION_OPERATIONS_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_OPERATION_ITEMS_STG for XXMX_STG.XXMX_SCM_OPERATION_ITEMS_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_OPERATION_OUTPUTS_STG for XXMX_STG.XXMX_SCM_OPERATION_OUTPUTS_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_OPERATION_RESOURCES_STG for XXMX_STG.XXMX_SCM_OPERATION_RESOURCES_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_OPERATION_ALTERNATE_RESOURCES_STG for XXMX_STG.XXMX_SCM_OPERATION_ALTERNATE_RESOURCES_STG;
--
--
--
PROMPT
...
--
--
GRANT ALL ON XXMX_STG.XXMX_SCM_IMPORT_BATCHES_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_WORK_DEFINITION_HEADERS_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_WORK_DEFINITION_OPERATIONS_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_OPERATION_ITEMS_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_OPERATION_OUTPUTS_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_OPERATION_RESOURCES_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_OPERATION_ALTERNATE_RESOURCES_STG TO XXMX_CORE;
--
--
--
PROMPT
