...
--**
--**
--** FILENAME  : xxmx_scm_work_order_mat_trasac_xfm_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  17-SEP-2024  Sinchana Ramesh     Created Process Work Order Material Transaction XFM tables for Cloudbridge.
--**
--**************************************************************************************
--**
...
--
--
PROMPT Dropping Table XXMX_SCM_INTERFACE_BATCH_XFM
PROMPT
EXEC DropTable('XXMX_SCM_INTERFACE_BATCH_XFM');
--
--
--
PROMPT Dropping Table XXMX_SCM_MATERIAL_TRANSACTION_HEADER_XFM
PROMPT
EXEC DropTable('XXMX_SCM_MATERIAL_TRANSACTION_HEADER_XFM');
--
--
--
PROMPT Dropping Table XXMX_SCM_MATERIAL_TRANSACTION_LOTS_XFM
PROMPT
EXEC DropTable('XXMX_SCM_MATERIAL_TRANSACTION_LOTS_XFM');
--
--
--
PROMPT Dropping Table XXMX_SCM_MATERIAL_TRANSACTION_SERIALS_XFM
PROMPT
EXEC DropTable('XXMX_SCM_MATERIAL_TRANSACTION_SERIALS_XFM');
--
--
--
--
PROMPT
PROMPT Creating Table XXMX_SCM_INTERFACE_BATCH_XFM
PROMPT
...
-- ** Interface Batch
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_INTERFACE_BATCH_XFM 
(
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_MATERIAL_TRANSACTION_HEADER_XFM
PROMPT
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_MATERIAL_TRANSACTION_HEADER_XFM 
(
    FILE_SET_ID                        VARCHAR2(30),
    MIGRATION_SET_ID                   NUMBER,
    MIGRATION_SET_NAME                 VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_MATERIAL_TRANSACTION_LOTS_XFM
PROMPT
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_MATERIAL_TRANSACTION_LOTS_XFM 
(
    FILE_SET_ID                        VARCHAR2(30),
    MIGRATION_SET_ID                   NUMBER,
    MIGRATION_SET_NAME                 VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_MATERIAL_TRANSACTION_SERIALS_XFM
PROMPT
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_MATERIAL_TRANSACTION_SERIALS_XFM 
(
    FILE_SET_ID                        VARCHAR2(30),
    MIGRATION_SET_ID                   NUMBER,
    MIGRATION_SET_NAME                 VARCHAR2(100),
...
--
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_INTERFACE_BATCH_XFM FOR XXMX_XFM.XXMX_SCM_INTERFACE_BATCH_XFM;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_MATERIAL_TRANSACTION_HEADER_XFM FOR XXMX_XFM.XXMX_SCM_MATERIAL_TRANSACTION_HEADER_XFM;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_MATERIAL_TRANSACTION_LOTS_XFM FOR XXMX_XFM.XXMX_SCM_MATERIAL_TRANSACTION_LOTS_XFM;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_MATERIAL_TRANSACTION_SERIALS_XFM FOR XXMX_XFM.XXMX_SCM_MATERIAL_TRANSACTION_SERIALS_XFM;
--
--
--
--
...
--
--
GRANT ALL ON XXMX_XFM.XXMX_SCM_INTERFACE_BATCH_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_MATERIAL_TRANSACTION_HEADER_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_MATERIAL_TRANSACTION_LOTS_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_MATERIAL_TRANSACTION_SERIALS_XFM TO XXMX_CORE;
--
PROMPT
PROMPT
PROMPT *************************************************************************************************************************
