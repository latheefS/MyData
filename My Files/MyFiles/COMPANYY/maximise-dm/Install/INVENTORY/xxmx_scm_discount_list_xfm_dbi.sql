...
--**
--**
--** FILENAME  : xxmx_scm_discount_list_xfm_dbi.sql
--**
...
--**              SCM DISCOUNT LIST Data Migration.
--**
--** NOTES     :
--**
--******************************************************************************
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  30-JUL-2024  Sinchana Ramesh     Created DISCOUNT LIST XFM tables for Cloudbridge.
--**
--**************************************************************************************
--**
...
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_DISCOUNT_LISTS_INT_XFM
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_DISCOUNT_LISTS_INT_XFM')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_XFM
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_XFM')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_XFM
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_XFM')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_PRICING_TERMS_INT_XFM
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_PRICING_TERMS_INT_XFM')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_XFM
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_XFM')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_MATRIX_RULES_INT_XFM
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_MATRIX_RULES_INT_XFM')
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_DISCOUNT_LISTS_INT_XFM
PROMPT
--
...
CREATE TABLE XXMX_XFM.XXMX_SCM_QP_DISCOUNT_LISTS_INT_XFM
(
    ...
    SOURCE_DISCOUNT_LIST_ID                 VARCHAR2(240),
    NAME                                    VARCHAR2(80),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_XFM
PROMPT
--
--
-- **************
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_XFM
(
    ...
    OPERATION_CODE                          VARCHAR2(30),
    SOURCE_DISCOUNT_LIST_ID                 VARCHAR2(240),
    SOURCE_DISCOUNT_LIST_SET_ID             VARCHAR2(240),
    SET_ID                                  NUMBER(18),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_XFM
PROMPT
--
--
-- **************
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_XFM
(
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
    ...
    OPERATION_CODE                          VARCHAR2(30),
    SOURCE_DISCOUNT_LIST_ID                 VARCHAR2(240),
    SOURCE_DISCOUNT_LIST_ITEM_ID            VARCHAR2(240),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_PRICING_TERMS_INT_XFM
PROMPT
--
--
-- **************
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_QP_PRICING_TERMS_INT_XFM
(
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
    ...
    SOURCE_TERM_ID                          VARCHAR2(240),
    NAME                                    VARCHAR2(80),
    PRICING_RULE_TYPE_CODE                  VARCHAR2(30),
    ...
    ADJUSTMENT_BASIS_ID                     NUMBER,
    APPLY_TO_ROLLUP_FLAG                    VARCHAR2(30),
    START_DATE                              TIMESTAMP(6),
    END_DATE                                TIMESTAMP(6),
    ATTRIBUTE_CATEGORY                      VARCHAR2(150),
    ATTRIBUTE_CHAR1                         VARCHAR2(150),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_XFM
PROMPT
--
--
-- **************
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_XFM
(
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_MATRIX_RULES_INT_XFM
PROMPT
--
--
-- **************
...
-- **************
CREATE TABLE XXMX_XFM.XXMX_SCM_QP_MATRIX_RULES_INT_XFM
(
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
...
--
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_DISCOUNT_LISTS_INT_XFM for XXMX_XFM.XXMX_SCM_QP_DISCOUNT_LISTS_INT_XFM;
--                               
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_XFM for XXMX_XFM.XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_XFM;
--                               
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_XFM for XXMX_XFM.XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_XFM;
--                               
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_PRICING_TERMS_INT_XFM for XXMX_XFM.XXMX_SCM_QP_PRICING_TERMS_INT_XFM;
--                               
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_XFM for XXMX_XFM.XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_XFM;
--                               
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_MATRIX_RULES_INT_XFM for XXMX_XFM.XXMX_SCM_QP_MATRIX_RULES_INT_XFM;
--
--
--
PROMPT
...
PROMPT
--
GRANT ALL ON XXMX_XFM.XXMX_SCM_QP_DISCOUNT_LISTS_INT_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_QP_PRICING_TERMS_INT_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_QP_MATRIX_RULES_INT_XFM TO XXMX_CORE;
--
--
--
PROMPT
...
PROMPT ***********************************************************************************
PROMPT **
PROMPT ** Completed Installing Database Objects for Cloudbridge Discount List Data Migration
PROMPT **
PROMPT ***********************************************************************************
PROMPT
PROMPT
