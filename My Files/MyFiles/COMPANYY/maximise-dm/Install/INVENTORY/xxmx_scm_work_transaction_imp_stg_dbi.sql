...
--**
--**
--** FILENAME  : xxmx_scm_work_transaction_imp_stg_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  16-SEP-2024  Sinchana Ramesh     Created WORK TRANSACTION IMPORT STG tables for Cloudbridge.
--**
--**************************************************************************************
--**
...
PROMPT ******************
--
PROMPT Dropping Table XXMX_SCM_BATCH_DETAILS_STG
PROMPT
EXEC DropTable('XXMX_SCM_BATCH_DETAILS_STG');
--
PROMPT Dropping Table XXMX_SCM_OPERATION_TRANSACTION_HEADER_STG
PROMPT
EXEC DropTable('XXMX_SCM_OPERATION_TRANSACTION_HEADER_STG');
--
--
--
PROMPT
PROMPT Creating Table XXMX_SCM_BATCH_DETAILS_STG
PROMPT
...
-- ** Batch Details
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_BATCH_DETAILS_STG 
(
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_OPERATION_TRANSACTION_HEADER_STG
PROMPT
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_OPERATION_TRANSACTION_HEADER_STG 
(
    FILE_SET_ID                    VARCHAR2(30),
    MIGRATION_SET_ID               NUMBER,
    MIGRATION_SET_NAME             VARCHAR2(100),
...
--
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_BATCH_DETAILS_STG FOR XXMX_STG.XXMX_SCM_BATCH_DETAILS_STG;
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_SCM_OPERATION_TRANSACTION_HEADER_STG FOR XXMX_STG.XXMX_SCM_OPERATION_TRANSACTION_HEADER_STG;
--
--
--
PROMPT
...
--
--
GRANT ALL ON XXMX_STG.XXMX_SCM_BATCH_DETAILS_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_OPERATION_TRANSACTION_HEADER_STG TO XXMX_CORE;
--
--
--
PROMPT
