...
--**
--**
--** FILENAME  : xxmx_scm_plc_item_structure_xfm_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  18-JUL-2024  Sinchana Ramesh     Created ITEM STRUCTURE XFM tables for Cloudbridge.
--** 
--**************************************************************************************
--**
...
PROMPT
PROMPT Dropping Table XXMX_SCM_STRUCTURE_HEADERS_XFM
PROMPT
--
EXEC DropTable('XXMX_SCM_STRUCTURE_HEADERS_XFM')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_COMPONENTS_IMP_XFM                                   
PROMPT
--
EXEC DropTable('XXMX_SCM_COMPONENTS_IMP_XFM')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_SUBSTITUTE_COMP_XFM                              
PROMPT
--
EXEC DropTable('XXMX_SCM_SUBSTITUTE_COMP_XFM')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_REF_DESIGN_XFM                               
PROMPT
--
EXEC DropTable('XXMX_SCM_REF_DESIGN_XFM')
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_STRUCTURE_HEADERS_XFM
PROMPT
--
...
*/
--
CREATE TABLE XXMX_XFM.XXMX_SCM_STRUCTURE_HEADERS_XFM 
(
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_COMPONENTS_IMP_XFM
PROMPT
--
--
/*
...
--
--
CREATE TABLE XXMX_XFM.XXMX_SCM_COMPONENTS_IMP_XFM 
(
    FILE_SET_ID                            VARCHAR2(30),
    MIGRATION_SET_ID                       NUMBER,
    MIGRATION_SET_NAME                     VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_SUBSTITUTE_COMP_XFM
PROMPT
--
--
/*
...
--
--
CREATE TABLE XXMX_XFM.XXMX_SCM_SUBSTITUTE_COMP_XFM 
(
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_REF_DESIGN_XFM
PROMPT
--
--
/*
...
--
--
CREATE TABLE XXMX_XFM.XXMX_SCM_REF_DESIGN_XFM 
(
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_STRUCTURE_HEADERS_XFM FOR XXMX_XFM.XXMX_SCM_STRUCTURE_HEADERS_XFM;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_COMPONENTS_IMP_XFM FOR XXMX_XFM.XXMX_SCM_COMPONENTS_IMP_XFM;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_SUBSTITUTE_COMP_XFM FOR XXMX_XFM.XXMX_SCM_SUBSTITUTE_COMP_XFM;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_REF_DESIGN_XFM FOR XXMX_XFM.XXMX_SCM_REF_DESIGN_XFM;
--
--
PROMPT
PROMPT
...
--
--
GRANT ALL ON XXMX_XFM.XXMX_SCM_STRUCTURE_HEADERS_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_COMPONENTS_IMP_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_SUBSTITUTE_COMP_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_SCM_REF_DESIGN_XFM TO XXMX_CORE;
--
--
PROMPT
PROMPT
