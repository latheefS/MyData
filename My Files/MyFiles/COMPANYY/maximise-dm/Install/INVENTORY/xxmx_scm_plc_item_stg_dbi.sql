...
--**
--**
--** FILENAME  : xxmx_scm_plc_item_stg_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  16-JUL-2024  Sinchana Ramesh     Created ITEM STG tables for Cloudbridge.
--** 
--**************************************************************************************
--**
...
PROMPT
PROMPT Dropping Table XXMX_SCM_SYS_ITEMS_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_SYS_ITEMS_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_REV_STG									
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_REV_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_CAT_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_CAT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_ASSOC_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_ASSOC_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_REL_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_REL_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_EFF_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_EFF_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_EFF_TL_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_EFF_TL_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_REV_EFF_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_REV_EFF_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_REV_EFF_TL_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_REV_EFF_TL_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_SUPP_EFF_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_SUPP_EFF_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_SUPP_EFF_TL_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_SUPP_EFF_TL_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_ITEM_STYL_ATTR_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_ITEM_STYL_ATTR_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_TP_ITEMS_STG								
PROMPT
--
EXEC DropTable('XXMX_SCM_TP_ITEMS_STG')
--
--
PROMPT
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_SYS_ITEMS_STG
PROMPT
--
...
-- ** Items table 
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_SYS_ITEMS_STG
    (
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_REV_STG
PROMPT
--
-- **********************
-- **Item Revisions Table
-- **********************
CREATE TABLE  XXMX_STG.XXMX_SCM_ITEM_REV_STG
    (
     FILE_SET_ID                                     VARCHAR2(30)
    ,MIGRATION_SET_ID                                NUMBER
    ,MIGRATION_SET_NAME                              VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_CAT_STG
PROMPT
--
-- ************************
-- **Item Categories Table
-- ************************
CREATE TABLE  XXMX_STG.XXMX_SCM_ITEM_CAT_STG
    (
     FILE_SET_ID                VARCHAR2(30)
    ,MIGRATION_SET_ID           NUMBER
    ,MIGRATION_SET_NAME         VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_ASSOC_STG
PROMPT
--
-- **************************
-- **Item Associations Table
-- **************************
CREATE TABLE XXMX_STG.XXMX_SCM_ITEM_ASSOC_STG
    (
     FILE_SET_ID                           VARCHAR2(30)
    ,MIGRATION_SET_ID                      NUMBER
    ,MIGRATION_SET_NAME                    VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_REL_STG
PROMPT
--
-- ****************************
-- **Item Releationships Table
-- ****************************
CREATE TABLE  XXMX_STG.XXMX_SCM_ITEM_REL_STG
    (
     FILE_SET_ID                           VARCHAR2(30)
    ,MIGRATION_SET_ID                      NUMBER
    ,MIGRATION_SET_NAME                    VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_EFF_STG
PROMPT
--
-- ***********************************
-- **Item Extensible Flexfields Table
-- ***********************************
CREATE TABLE  XXMX_SCM_ITEM_EFF_STG
    (
     FILE_SET_ID                    VARCHAR2(30)
    ,MIGRATION_SET_ID               NUMBER
    ,MIGRATION_SET_NAME             VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_EFF_TL_STG
PROMPT
--
-- ***********************************************
-- **Item Translatable Extensible Flexfields Table
-- ***********************************************
CREATE TABLE  XXMX_SCM_ITEM_EFF_TL_STG
    (
     FILE_SET_ID                    VARCHAR2(30)
    ,MIGRATION_SET_ID               NUMBER
    ,MIGRATION_SET_NAME             VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_REV_EFF_STG
PROMPT
--
-- *******************************************
-- **Item Revision Extensible Flexfields Table
-- ********************************************
CREATE TABLE  XXMX_SCM_ITEM_REV_EFF_STG
    (
     FILE_SET_ID                    VARCHAR2(30)
    ,MIGRATION_SET_ID               NUMBER
    ,MIGRATION_SET_NAME             VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_REV_EFF_TL_STG
PROMPT
--
-- *********************************************************
-- **Item Revision Translatable Extensible Flexfields Table
-- *********************************************************
CREATE TABLE  XXMX_SCM_ITEM_REV_EFF_TL_STG
    (
     FILE_SET_ID                    VARCHAR2(30)
    ,MIGRATION_SET_ID               NUMBER
    ,MIGRATION_SET_NAME             VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_SUPP_EFF_STG
PROMPT
--
-- *******************************************
-- **Item Supplier Extensible Flexfields Table
-- *******************************************
CREATE TABLE XXMX_SCM_ITEM_SUPP_EFF_STG
    (
     FILE_SET_ID                        VARCHAR2(30)
    ,MIGRATION_SET_ID                   NUMBER
    ,MIGRATION_SET_NAME                 VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_SUPP_EFF_TL_STG
PROMPT
--
-- ********************************************************
-- **Item Supplier Translatable Extensible Flexfields Table
-- ********************************************************
CREATE TABLE  XXMX_SCM_ITEM_SUPP_EFF_TL_STG
    (
     FILE_SET_ID                    VARCHAR2(30)
    ,MIGRATION_SET_ID               NUMBER
    ,MIGRATION_SET_NAME             VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_ITEM_STYL_ATTR_STG
PROMPT
--
-- ***********************************************
-- **Item Style Variant Attribute Value Sets Table
-- ***********************************************
CREATE TABLE  XXMX_SCM_ITEM_STYL_ATTR_STG
    (
     FILE_SET_ID                    VARCHAR2(30)
    ,MIGRATION_SET_ID               NUMBER
    ,MIGRATION_SET_NAME             VARCHAR2(100)
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_TP_ITEMS_STG
PROMPT
--
-- *****************************
-- **Trading Partner Items Table
-- *****************************
CREATE TABLE  XXMX_SCM_TP_ITEMS_STG
    (
     FILE_SET_ID                    VARCHAR2(30)
    ,MIGRATION_SET_ID               NUMBER
    ,MIGRATION_SET_NAME             VARCHAR2(100)
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_SYS_ITEMS_STG FOR XXMX_STG.XXMX_SCM_SYS_ITEMS_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_REV_STG FOR XXMX_STG.XXMX_SCM_ITEM_REV_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_CAT_STG FOR XXMX_STG.XXMX_SCM_ITEM_CAT_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_ASSOC_STG FOR XXMX_STG.XXMX_SCM_ITEM_ASSOC_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_REL_STG FOR XXMX_STG.XXMX_SCM_ITEM_REL_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_EFF_STG FOR XXMX_STG.XXMX_SCM_ITEM_EFF_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_EFF_TL_STG FOR XXMX_STG.XXMX_SCM_ITEM_EFF_TL_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_REV_EFF_STG FOR XXMX_STG.XXMX_SCM_ITEM_REV_EFF_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_REV_EFF_TL_STG FOR XXMX_STG.XXMX_SCM_ITEM_REV_EFF_TL_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_SUPP_EFF_STG FOR XXMX_STG.XXMX_SCM_ITEM_SUPP_EFF_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_SUPP_EFF_TL_STG FOR XXMX_STG.XXMX_SCM_ITEM_SUPP_EFF_TL_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_ITEM_STYL_ATTR_STG FOR XXMX_STG.XXMX_SCM_ITEM_STYL_ATTR_STG;
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_SCM_TP_ITEMS_STG FOR XXMX_STG.XXMX_SCM_TP_ITEMS_STG;    
--
--
PROMPT
PROMPT
...
PROMPT
--
GRANT ALL ON XXMX_STG.XXMX_SCM_SYS_ITEMS_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_REV_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_CAT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_ASSOC_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_REL_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_EFF_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_EFF_TL_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_REV_EFF_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_REV_EFF_TL_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_SUPP_EFF_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_SUPP_EFF_TL_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_ITEM_STYL_ATTR_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_TP_ITEMS_STG TO XXMX_CORE;
--
--
--
PROMPT
