...
--**
--**
--** FILENAME  : xxmx_scm_discount_list_stg_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  30-JUL-2024  Sinchana Ramesh     Created DISCOUNT LIST STG tables for Cloudbridge.
--**
--**************************************************************************************
--**
...
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_DISCOUNT_LISTS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_DISCOUNT_LISTS_INT_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_STG')
--
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_PRICING_TERMS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_PRICING_TERMS_INT_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_STG')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_QP_MATRIX_RULES_INT_STG
PROMPT
--
EXEC DropTable('XXMX_SCM_QP_MATRIX_RULES_INT_STG')
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_DISCOUNT_LISTS_INT_STG
PROMPT
--
...
CREATE TABLE XXMX_STG.XXMX_SCM_QP_DISCOUNT_LISTS_INT_STG
(
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_STG
PROMPT
--
--
-- **************
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_STG
(
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_STG
PROMPT
--
--
-- **************
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_STG
(
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_PRICING_TERMS_INT_STG
PROMPT
--
--
-- **************
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_QP_PRICING_TERMS_INT_STG
(
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_STG
PROMPT
--
--
-- **************
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_STG
(
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_QP_MATRIX_RULES_INT_STG
PROMPT
--
--
-- **************
...
-- **************
CREATE TABLE XXMX_STG.XXMX_SCM_QP_MATRIX_RULES_INT_STG
(
    FILE_SET_ID                             VARCHAR2(30),
    MIGRATION_SET_ID                        NUMBER,
    MIGRATION_SET_NAME                      VARCHAR2(100),
...
--
--
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_DISCOUNT_LISTS_INT_STG for XXMX_STG.XXMX_SCM_QP_DISCOUNT_LISTS_INT_STG;
--                               
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_STG for XXMX_STG.XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_STG;
--                               
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_STG for XXMX_STG.XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_STG;
--                               
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_PRICING_TERMS_INT_STG for XXMX_STG.XXMX_SCM_QP_PRICING_TERMS_INT_STG;
--                               
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_STG for XXMX_STG.XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_STG;
--                               
CREATE OR REPLACE PUBLIC SYNONYM XXMX_CORE.XXMX_SCM_QP_MATRIX_RULES_INT_STG for XXMX_STG.XXMX_SCM_QP_MATRIX_RULES_INT_STG;
--
--
--
PROMPT
...
PROMPT
--
GRANT ALL ON XXMX_STG.XXMX_SCM_QP_DISCOUNT_LISTS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_QP_DISCOUNT_LIST_SETS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_QP_DISCOUNT_LIST_ITEMS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_QP_PRICING_TERMS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_QP_MATRIX_DIMENSIONS_INT_STG TO XXMX_CORE;
GRANT ALL ON XXMX_STG.XXMX_SCM_QP_MATRIX_RULES_INT_STG TO XXMX_CORE;
--
--
--
PROMPT
