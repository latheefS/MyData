...
GRANT ALL ON  xxmx_gl_opening_balances_xfm              to XXMX_CORE;
GRANT ALL ON  xxmx_gl_summary_balances_xfm              to XXMX_CORE;
GRANT ALL ON  xxmx_gl_detail_balances_xfm              to XXMX_CORE;
