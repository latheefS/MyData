...
pt_common_load_column=>'ADDRESS_LINE_1',
pv_o_ReturnStatus=> pv_o_ReturnStatus);
...
pt_common_load_column=>'CANDIDATE_NUMBER',
pv_o_ReturnStatus=> pv_o_ReturnStatus);
...
pt_fusion_template_sheet_order=>1,
pt_common_load_column=>'POOL_NAME',
pv_o_ReturnStatus=> pv_o_ReturnStatus);
...
pt_fusion_template_sheet_order=>1,
pt_common_load_column=>'REQUISITION_NUMBER',
pv_o_ReturnStatus=> pv_o_ReturnStatus);
...
pt_fusion_template_sheet_order=>1,
pt_common_load_column=>'LOCATION_CODE',
pv_o_ReturnStatus=> pv_o_ReturnStatus);
