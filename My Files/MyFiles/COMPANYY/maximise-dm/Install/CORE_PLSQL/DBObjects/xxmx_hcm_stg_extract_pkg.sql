  CREATE OR REPLACE PACKAGE "XXMX_CORE"."XXMX_HCM_STG_EXTRACT_PKG" 
AS
     --
     /*
     *****************************************************************************
     ...
     **   1.1  15-NOV-2023  Pallavi Kanajar  Changes for NonEBS
     ******************************************************************************
     **
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PACKAGE BODY "XXMX_CORE"."XXMX_HCM_STG_EXTRACT_PKG" 
AS
    /*
     ******************************************************************************
     **
   ...
   CURSOR batch_cur (
     ...
     BEGIN
          ...
          --
 						/* Batch_Process */                 
        FOR batch_rec  IN batch_cur(vt_ApplicationSuite
                                    ,vt_Application
                                    ,vt_BusinessEntity)
                                           
                LOOP             
                    xxmx_utilities_pkg.batch_extract_data 
                   ( p_application_suite => vt_ApplicationSuite
                    ,p_business_entity   => vt_BusinessEntity
                    ,p_sub_entity        => batch_rec.sub_entity
                    ,p_batch_count       => 100
                    ,p_ct_phase          => 'EXTRACT'
                   );
               ...
               */
               ...
               THEN
                    ...
                    */
                    --
                    IF   pt_i_BusinessEntity IS NULL
                    AND  pt_i_MigrationSetID IS NULL -- V1.1
                    THEN
                         --
                    ...
                    THEN
                         ...
                         --
                    ELSIF pt_i_MigrationSetID IS NULL  -- V1.1
                    THEN
                         --
                         vt_ParameterMessage := vt_ParameterMessage
                    ...
                    gvt_MigrationSetID := pt_i_MigrationSetID; -- V1.1
                    --
                ELSE  /* STG_POPULATION_METHOD = 'DB_LINK */
                    --
                    /*
...
/
show errors package body xxmx_hcm_stg_extract_pkg;
/