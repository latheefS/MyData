...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -----------------------------------
--** 1.1    26/05/2020     Ian               Initial Build
--** 1.2    14/04/2021     Pallavi           Changes to include all banks - External
--**
--** 1.3    25/08/2022     Pallavi           Add Parameters to get internal , external or
--**                                          HCM bank only.
--******************************************************************************
--**
...
AS
      ...
      --//                                                   Internal and HCM 
        --// 1.3         Pallavi            25/08/2022         Add Parameters to get internal , external or HCM bank only.
        --// 1.4         Ayush				24/04/2024		   Added CITCO changes		--//================================================================================
		--//================================================================================
		--
		--
     --
...
/
SHOW ERRORS PACKAGE BODY XXMX_BANKS_AND_BRANCHES_PKG;
/