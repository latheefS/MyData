...
@"&1/AP/DBObjects/xxmx_xfm_populate_ap_inv.sql"
--
--
PROMPT
PROMPT ****************************************
...
@"&1/AP/DBObjects/xxmx_xfm_populate_ap_supp.sql"	
--
--
PROMPT
PROMPT ****************************************
...
@"&1/AR/DBObjects/xxmx_xfm_populate_ar_cash_rcpts.sql"
--
--
PROMPT
PROMPT ****************************************
...
@"&1/AR/DBObjects/xxmx_xfm_populate_ar_customers.sql"
--
--
PROMPT
PROMPT ****************************************
...
@"&1/AR/DBObjects/xxmx_xfm_populate_ar_inv.sql"       
--
--
PROMPT
PROMPT ****************************************
...
@"&1/FA/DBObjects/xxmx_xfm_populate_fa_massadd.sql"                    
--

PROMPT
PROMPT ****************************************
PROMPT Run script xxmx_xfm_populate_gl_balances
PROMPT ****************************************
PROMPT
--              
@"&1/GL/DBObjects/xxmx_xfm_populate_gl_balances.sql"    
--
PROMPT
PROMPT ****************************************
PROMPT Run script xxmx_xfm_populate_gl_daily_rates
PROMPT ****************************************
PROMPT
--
@"&1/GL/DBObjects/xxmx_xfm_populate_gl_daily_rates.sql" 
--
PROMPT
PROMPT ****************************************
PROMPT Run script xxmx_xfm_populate_gl_historical_rates
PROMPT ****************************************
PROMPT
--
@"&1/GL/DBObjects/xxmx_xfm_populate_gl_historical_rates.sql"
...
@"&1/PO/DBObjects/xxmx_xfm_populate_po.sql" 
--
PROMPT
PROMPT ****************************************
...
--
PROMPT ****************************************
PROMPT Run script xxmx_xfm_populate_zx_customer_tax
PROMPT ****************************************
--
@"&1/AR/DBObjects/xxmx_xfm_populate_zx_customer_tax.sql"
--
--
PROMPT ****************************************
PROMPT Run script xxmx_xfm_populate_supp_tax
PROMPT ****************************************
--
@"&1/AP/DBObjects/xxmx_xfm_populate_supp_tax.sql"
--
--
PROMPT ****************************************
PROMPT Run script xxmx_xfm_populate_hr
PROMPT ****************************************
--
@"&1/HCM/DBObjects/xxmx_xfm_populate_hr.sql"
--
PROMPT
PROMPT ****************************************
