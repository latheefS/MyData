...
--**
--**
--** FILENAME  :  xmxx_gl_historical_rates_xfm_dbi.sql
--**
...
--**              GL Historical Rates Data Migration.
--**
--** NOTES     :
--**
--******************************************************************************
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  ----------------------------------------------------
--**   1.0  10-JAN-2023    Shaik Latheef  	 Created GL Historical Rates XFM tables for Maximise.
--** 
--***********************************************************************************************
--**
...
PROMPT **************************************************************************************
PROMPT **
PROMPT ** Installing Extract Database Objects for Maximise GL Historical Rates Data Migration
PROMPT **
PROMPT **************************************************************************************
PROMPT
PROMPT
...
--
PROMPT
PROMPT Dropping Table XXMX_GL_HISTORICAL_RATES_XFM
PROMPT
--
EXEC DropTable('XXMX_GL_HISTORICAL_RATES_XFM')
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_GL_HISTORICAL_RATES_XFM
PROMPT
--
...
--
-- ***************************
-- **GL HISTORICAL RATES Table
-- ***************************
CREATE TABLE XXMX_XFM.XXMX_GL_HISTORICAL_RATES_XFM
   (
	...
	IMPORT_ACTION_CODE				VARCHAR2(30),
	...
	TARGET_CURRENCY_CODE			VARCHAR2(15),
	VALUE_TYPE_CODE					VARCHAR2(30),
	CREDIT_AMOUNT_RATE				NUMBER,
	AUTO_ROLL_FORWARD_FLAG			VARCHAR2(3),
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_GL_HISTORICAL_RATES_XFM FOR XXMX_XFM.XXMX_GL_HISTORICAL_RATES_XFM;
--
...
--
PROMPT
PROMPT Granting permissions on XXMX_GL_HISTORICAL_RATES_XFM to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON XXMX_XFM.XXMX_GL_HISTORICAL_RATES_XFM TO XXMX_CORE;
--
--
--
PROMPT
...
PROMPT ****************************************************************************************
PROMPT **                                
PROMPT ** Completed Installing Database Objects for Maximise GL Historical Rates Data Migration
PROMPT **                                
PROMPT ****************************************************************************************
PROMPT
PROMPT
