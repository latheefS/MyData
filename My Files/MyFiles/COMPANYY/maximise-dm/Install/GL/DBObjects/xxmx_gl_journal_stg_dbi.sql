...
-- **GL JOURNAL Table
-- ******************
CREATE TABLE xxmx_stg.xxmx_gl_journal_stg
     (
...
--
--
CREATE OR replace public synonym xxmx_gl_journal_stg FOR xxmx_stg.xxmx_gl_journal_stg;
--
...
PROMPT
--
GRANT ALL ON  xxmx_stg.xxmx_gl_journal_stg TO XXMX_CORE;
--
--
--
PROMPT
