...
PROMPT *********************
--
EXEC DROPSEQUENCE ('XXMX_GL_ACCOUNT_TRANSFORMS_SEQ')
--
--
PROMPT
PROMPT
...
--
--
  CREATE SEQUENCE XXMX_GL_ACCOUNT_TRANSFORMS_SEQ
  START WITH 1
  INCREMENT BY 1
  NOCACHE
  NOCYCLE;
  ...
  UPDATE XXMX_GL_ACCOUNT_TRANSFORMS
  SET S_NO = XXMX_GL_ACCOUNT_TRANSFORMS_SEQ.nextval;
--
--PROMPT
--PROMPT
--PROMPT *****************
