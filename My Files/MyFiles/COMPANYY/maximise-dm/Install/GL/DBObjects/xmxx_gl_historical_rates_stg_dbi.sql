...
--**
--**
--** FILENAME  :  xmxx_gl_historical_rates_stg_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  ----------------------------------------------------
--**   1.0  10-JAN-2023    Shaik Latheef  	 Created GL Historical Rates STG tables for Maximise.
--** 
--***********************************************************************************************
--**
...
--
PROMPT
PROMPT Dropping Table XXMX_GL_HISTORICAL_RATES_STG
PROMPT
--
EXEC DropTable('XXMX_GL_HISTORICAL_RATES_STG')
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_GL_HISTORICAL_RATES_STG
PROMPT
--
...
-- ***************************
CREATE TABLE XXMX_STG.XXMX_GL_HISTORICAL_RATES_STG
   (
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_GL_HISTORICAL_RATES_STG FOR XXMX_STG.XXMX_GL_HISTORICAL_RATES_STG;
--
...
--
PROMPT
PROMPT Granting permissions on XXMX_GL_HISTORICAL_RATES_STG to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON XXMX_STG.XXMX_GL_HISTORICAL_RATES_STG TO XXMX_CORE;
--
--
--
PROMPT
