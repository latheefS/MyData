...
--**
--**
--** FILENAME  :  xmxx_gl_journal_xfm_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  24-NOV-2021  Shaik Latheef  	 Created GL Journal XFM tables for Maximise.
--**
--**************************************************************************************
--
--
...
--
PROMPT
PROMPT Dropping Table xxmx_gl_journal_XFM
PROMPT
--
EXEC DropTable ('XXMX_GL_JOURNAL_XFM')
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table xxmx_gl_journal_XFM
PROMPT
--
...
-- **GL JOURNAL Table
-- ******************
CREATE TABLE XXMX_XFM.xxmx_gl_journal_XFM
     (
...
--
--
CREATE OR replace public synonym xxmx_gl_journal_XFM FOR XXMX_XFM.xxmx_gl_journal_xfm;
--
...
--
PROMPT
PROMPT Granting permissions on xxmx_gl_journal_XFM to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON  XXMX_XFM.xxmx_gl_journal_XFM TO XXMX_CORE;
--
--
--
PROMPT
