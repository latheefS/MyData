...
--
PROMPT
PROMPT Dropping Table XXMX_GL_OPENING_BALANCES_XFM
PROMPT
--
EXEC DropTable ('XXMX_GL_OPENING_BALANCES_XFM')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_GL_SUMMARY_BALANCES_XFM
PROMPT
--
EXEC DropTable ('XXMX_GL_SUMMARY_BALANCES_XFM')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_GL_DETAIL_BALANCES_XFM
PROMPT
--
EXEC DropTable ('XXMX_GL_DETAIL_BALANCES_XFM')
--
--
--
PROMPT
...
PROMPT
--
CREATE TABLE xxmx_xfm.xxmx_gl_balances_xfm
     (
...
CREATE TABLE "XXMX_XFM"."XXMX_GL_OPENING_BALANCES_XFM" 
  ...
  CREATE TABLE "XXMX_XFM"."XXMX_GL_DETAIL_BALANCES_XFM" 
   (	"FILE_SET_ID" VARCHAR2(30 BYTE), 
	"MIGRATION_SET_ID" NUMBER, 
	"MIGRATION_SET_NAME" VARCHAR2(100 BYTE), 
	"MIGRATION_STATUS" VARCHAR2(50 BYTE), 
  ...
  CREATE TABLE "XXMX_XFM"."XXMX_GL_SUMMARY_BALANCES_XFM" 
   (	"FILE_SET_ID" VARCHAR2(30 BYTE), 
	"MIGRATION_SET_ID" NUMBER, 
	"MIGRATION_SET_NAME" VARCHAR2(100 BYTE), 
	"MIGRATION_STATUS" VARCHAR2(50 BYTE), 
...
PROMPT
--
GRANT ALL ON xxmx_xfm.xxmx_gl_balances_xfm TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_GL_OPENING_BALANCES_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_GL_DETAIL_BALANCES_XFM TO XXMX_CORE;
GRANT ALL ON XXMX_XFM.XXMX_GL_SUMMARY_BALANCES_XFM TO XXMX_CORE;
