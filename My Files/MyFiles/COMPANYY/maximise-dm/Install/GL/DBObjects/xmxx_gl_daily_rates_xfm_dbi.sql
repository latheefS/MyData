...
--**
--**
--** FILENAME  :  xmxx_gl_daily_rates_xfm_dbi.sql
--**
...
--
PROMPT
PROMPT Dropping Table XXMX_GL_DAILY_RATES_XFM
PROMPT
--
EXEC DropTable('XXMX_GL_DAILY_RATES_XFM')
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_GL_DAILY_RATES_XFM
PROMPT
--
...
-- **********************
CREATE TABLE XXMX_GL_DAILY_RATES_XFM
   (
...
--
PROMPT
PROMPT Granting permissions on XXMX_GL_DAILY_RATES_XFM to the XXMX_CORE Schema 
PROMPT
--
