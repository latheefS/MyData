...
--**
--**
--** FILENAME  :  xxmx_gl_balances_pkg.sql
--**
...
--** AUTHORS   :  Ian 
--**
--** PURPOSE   :  This script creates extract package for for the Maximise
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -----------------------------------
--**   1.0  07-OCT-2020  Ian  	            Initial Draft
--**   1.1  08-JUN-2022  Shireesha  	    Added Scripts for Detailed and Opening Balances
--**   1.3  10-NOV-2023  Sinchana           Added Separate Business Entity for Open,Summ,Detail
--**--******************************************************************************
--**
...
--                        FROM   gl.gl_periods@MXDM_NVIS_EXTRACT gp
--                        WHERE  gp.period_name = xbal.period_name)        date_created
                     ,TRUNC(SYSDATE)                                    date_created                       ,'A'                                               actual_flag
                      ,gcc.segment1                                      segment1
                      ,gcc.segment2                                      segment2
                      ,gcc.segment3                                      segment3
                      ,gcc.segment4                                      segment4
...
BEGIN
    --
    gvv_ProgressIndicator := '0010';
	gct_BusinessEntity := 'SUMM_BAL';--1.3--Commented by Sinchana---
    --
    vb_OkayToExtract  := TRUE;
    gvv_ReturnStatus  := '';
    gvt_ReturnMessage := '';
...
--                      ,(SELECT gp.start_date
--                        FROM   gl.gl_periods@MXDM_NVIS_EXTRACT gp
--                        WHERE  gp.period_name = gjh.period_name)        date_created
                      ,TRUNC(SYSDATE)                                    date_created                       ,'A'                                               actual_flag
                      ,gcc.segment1                                      segment1
                      ,gcc.segment2                                      segment2
                      ,gcc.segment3                                      segment3
...
--                      ,gjh.currency_conversion_type                      user_currency_conversion_type
                      ,gldct.user_conversion_type                        user_currency_conversion_type
                      --,gjh.currency_conversion_date                    currency_conversion_date
                      ,gjh.currency_conversion_date                      currency_conversion_date
...
--                      ,gjb.average_journal_flag                          average_journal_flag
             ...
             FROM
                    gl.gl_je_sources_tl@MXDM_NVIS_EXTRACT                 gjst,
                    gl.gl_je_categories_tl@MXDM_NVIS_EXTRACT              gjct,
                    gl.gl_ledgers@MXDM_NVIS_EXTRACT                       gl,
                    gl.gl_je_headers@MXDM_NVIS_EXTRACT                    gjh,
                    gl.gl_je_lines@MXDM_NVIS_EXTRACT                      gjl,
                    gl.gl_je_batches@MXDM_NVIS_EXTRACT                    gjb,
                    apps.gl_code_combinations_kfv@MXDM_NVIS_EXTRACT       gcc,
                    gl.gl_daily_conversion_types@MXDM_NVIS_EXTRACT        gldct
             where   gl.name                                         = pv_LedgerName
...
BEGIN
    --
    gvv_ProgressIndicator := '0010';
	gct_BusinessEntity := 'DETAIL_BAL';--1.3--Commented by Sinchana---
    --
    vb_OkayToExtract  := TRUE;
    gvv_ReturnStatus  := '';
    gvt_ReturnMessage := '';
