...
--
--
CREATE OR REPLACE PACKAGE xxmx_gl_utilities_pkg AUTHID CURRENT_USER
AS
     --
     --
     /*
...
--
--
CREATE OR REPLACE PACKAGE BODY xxmx_gl_utilities_pkg
AS
     --
     --**********************
     --** Global Declarations
          ...
          */
          ...
          IS
               ...
               FROM      apps.gl_ledgers@MXDM_NVIS_EXTRACT                 gl
                        ,apps.fnd_id_flexs@MXDM_NVIS_EXTRACT               fif
                        ,apps.fnd_id_flex_structures@MXDM_NVIS_EXTRACT     fifs
               WHERE     1 = 1
          ...
          IS
               ...
               FROM      apps.gl_ledgers@MXDM_NVIS_EXTRACT                 gl
                        ,apps.fnd_id_flexs@MXDM_NVIS_EXTRACT               fif
                        ,apps.fnd_id_flex_structures@MXDM_NVIS_EXTRACT     fifs
                        ,apps.fnd_id_flex_segments@MXDM_NVIS_EXTRACT       fifse
               WHERE     1 = 1
          ...
          */
          ...
          IS
               ...
               FROM      apps.gl_ledgers@MXDM_NVIS_EXTRACT                 gl
                        ,apps.fnd_id_flexs@MXDM_NVIS_EXTRACT               fif
                        ,apps.fnd_id_flex_structures@MXDM_NVIS_EXTRACT     fifs
                        ,apps.fnd_id_flex_structures_tl@MXDM_NVIS_EXTRACT  fifst
                        ,apps.fnd_id_flex_segments@MXDM_NVIS_EXTRACT       fifse
                        ,apps.fnd_flex_value_sets@MXDM_NVIS_EXTRACT        ffvs
               WHERE     1 = 1
               AND       gl.name                     = pt_LedgerName
               AND       fif.id_flex_name            = 'Accounting Flexfield'
               AND       fifs.id_flex_code           = fif.id_flex_code
          ...
          IS
               ...
               SELECT    ffv.flex_value
                        ,ffv.enabled_flag
                        ,ffv.summary_flag
               FROM      apps.fnd_flex_values@MXDM_NVIS_EXTRACT  ffv
               WHERE     1 = 1
          ...
          IS
               ...
               AS
                    (
                     ...
                     FROM   apps.fnd_lookup_values@MXDM_NVIS_EXTRACT
                     WHERE  1 = 1
