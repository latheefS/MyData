...
--**
--**
--** FILENAME  :  xmxx_gl_daily_rates_ext_dbi.sql
--**
...
--**
--** PURPOSE   :  This script installs the External table DB Objects for the Maximise
--**              GL Daily Rates Data Migration.
--**
--** NOTES     :
--**
--******************************************************************************
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -----------------------------------------------
--**   1.0  24-NOV-2021    Shaik Latheef  	 Created GL Daily Rates XFM tables for Maximise.
--** 
--******************************************************************************************
--**
...
PROMPT *********************************************************************************
PROMPT **
PROMPT ** Installing Extract Database Objects for Maximise GL Daily Rates Data Migration
PROMPT **
PROMPT *********************************************************************************
PROMPT
PROMPT
...
--
PROMPT
PROMPT Dropping Table XXMX_GL_DAILY_RATES_EXT
PROMPT
--
EXEC DropTable('XXMX_GL_DAILY_RATES_EXT')
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_GL_DAILY_RATES_EXT
PROMPT
--
...
-- **********************
CREATE TABLE XXMX_GL_DAILY_RATES_EXT
   (
	...
	FROM_CONVERSION_DATE			VARCHAR2(20),
	TO_CONVERSION_DATE				VARCHAR2(20),
   ...
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_GL_DAILY_RATES_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_GL_DAILY_RATES_STG.csv'
       )
    )
...
--
--
--CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_GL_DAILY_RATES_XFM FOR XXMX_XFM.XXMX_GL_DAILY_RATES_XFM;
--
...
--
PROMPT
PROMPT Granting permissions on XXMX_GL_DAILY_RATES_EXT to the XXMX_CORE Schema 
PROMPT
--
--GRANT ALL ON XXMX_XFM.XXMX_GL_DAILY_RATES_XFM TO XXMX_CORE;
--
--
--
PROMPT
...
PROMPT ***********************************************************************************
PROMPT **                                
PROMPT ** Completed Installing Database Objects for Maximise GL Daily Rates Data Migration
PROMPT **                                
PROMPT ***********************************************************************************
PROMPT
PROMPT
