...
--**
--**
--** FILENAME  :  xmxx_gl_daily_rates_stg_dbi.sql
--**
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -----------------------------------------------
--**   1.0  24-NOV-2021    Shaik Latheef  	 Created GL Daily Rates STG tables for Maximise.
--** 
--******************************************************************************************
--**
...
--
PROMPT
PROMPT Dropping Table XXMX_GL_DAILY_RATES_STG
PROMPT
--
EXEC DropTable('XXMX_GL_DAILY_RATES_STG')
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_GL_DAILY_RATES_STG
PROMPT
--
...
-- **********************
CREATE TABLE XXMX_STG.XXMX_GL_DAILY_RATES_STG
   (
...
--
--
CREATE OR REPLACE SYNONYM XXMX_CORE.XXMX_GL_DAILY_RATES_STG FOR XXMX_STG.XXMX_GL_DAILY_RATES_STG;
--
...
--
PROMPT
PROMPT Granting permissions on XXMX_GL_DAILY_RATES_STG to the XXMX_CORE Schema 
PROMPT
--
GRANT ALL ON XXMX_STG.XXMX_GL_DAILY_RATES_STG TO XXMX_CORE;
--
--
--
PROMPT
