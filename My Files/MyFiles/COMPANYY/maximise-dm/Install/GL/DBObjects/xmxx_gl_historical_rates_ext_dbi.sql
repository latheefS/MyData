...
--**
--**
--** FILENAME  :  xmxx_gl_historical_rates_ext_dbi.sql
--**
...
--
PROMPT
PROMPT Dropping Table XXMX_GL_HISTORICAL_RATES_EXT
PROMPT
--
EXEC DropTable('XXMX_GL_HISTORICAL_RATES_EXT')
--
--
--
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_GL_HISTORICAL_RATES_EXT
PROMPT
--
...
-- ***************************
CREATE TABLE XXMX_CORE.XXMX_GL_HISTORICAL_RATES_EXT
   (
  ...
  ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_GL_HISTORICAL_RATES_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_GL_HISTORICAL_RATES_STG.csv'
       )
    )
