...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_HEADERS_STD_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINES_STD_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINE_LOCATIONS_STD_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_DISTRIBUTIONS_STD_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_HEADERS_BPA_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINES_BPA_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINE_LOCATIONS_BPA_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_ATTR_VALUES_BPA_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_HEADERS_CPA_XFM')
--
--
PROMPT
...
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_GA_ORG_ASSIGN_CPA_XFM')
--
--
PROMPT
PROMPT
...
-- **********************
CREATE TABLE XXMX_XFM.XXMX_SCM_PO_HEADERS_STD_XFM
(
...
-- **STD PO Lines Table
-- ********************
CREATE TABLE  XXMX_XFM.XXMX_SCM_PO_LINES_STD_XFM
(
FILE_SET_ID                             VARCHAR2(30),   
MIGRATION_SET_ID                        NUMBER,
MIGRATION_SET_NAME                      VARCHAR2(100),
...
-- *****************************
CREATE TABLE  XXMX_XFM.XXMX_SCM_PO_LINE_LOCATIONS_STD_XFM
(
FILE_SET_ID                             VARCHAR2(30),   
MIGRATION_SET_ID                        NUMBER,
MIGRATION_SET_NAME                      VARCHAR2(100),
...
-- ****************************
CREATE TABLE  XXMX_XFM.XXMX_SCM_PO_DISTRIBUTIONS_STD_XFM
(
FILE_SET_ID                             VARCHAR2(30),   
MIGRATION_SET_ID                        NUMBER,
MIGRATION_SET_NAME                      VARCHAR2(100),
...
-- **********************
CREATE TABLE XXMX_XFM.XXMX_SCM_PO_HEADERS_BPA_XFM
(
FILE_SET_ID                                     VARCHAR2(30),
MIGRATION_SET_ID                                NUMBER,
MIGRATION_SET_NAME                              VARCHAR2(100),
...
-- **BPA PO Lines Table
-- ********************
CREATE TABLE  XXMX_XFM.XXMX_SCM_PO_LINES_BPA_XFM
(
FILE_SET_ID                                     VARCHAR2(30),   
MIGRATION_SET_ID                                NUMBER,
MIGRATION_SET_NAME                              VARCHAR2(100),
...
-- *****************************
CREATE TABLE  XXMX_XFM.XXMX_SCM_PO_LINE_LOCATIONS_BPA_XFM
(
FILE_SET_ID                                     VARCHAR2(30),   
MIGRATION_SET_ID                                NUMBER,
MIGRATION_SET_NAME                              VARCHAR2(100),
...
-- ***************************
CREATE TABLE  XXMX_XFM.XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_XFM
(
FILE_SET_ID                                     VARCHAR2(30),   
MIGRATION_SET_ID                                NUMBER,
MIGRATION_SET_NAME                              VARCHAR2(100),
...
-- ****************************
CREATE TABLE  XXMX_XFM.XXMX_SCM_PO_ATTR_VALUES_BPA_XFM
(
FILE_SET_ID                                     VARCHAR2(30),   
MIGRATION_SET_ID                                NUMBER,
MIGRATION_SET_NAME                              VARCHAR2(100),
...
-- ***************************************
CREATE TABLE  XXMX_XFM.XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_XFM
(
 FILE_SET_ID                                     VARCHAR2(30),   
 MIGRATION_SET_ID                                NUMBER,
 MIGRATION_SET_NAME                              VARCHAR2(100),
...
-- **********************
CREATE TABLE XXMX_XFM.XXMX_SCM_PO_HEADERS_CPA_XFM
(
FILE_SET_ID                                     VARCHAR2(30),
MIGRATION_SET_ID                                NUMBER,
MIGRATION_SET_NAME                              VARCHAR2(100),
