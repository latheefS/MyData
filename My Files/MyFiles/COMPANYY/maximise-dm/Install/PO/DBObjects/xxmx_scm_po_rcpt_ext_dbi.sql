...
--**
--**
--** FILENAME  : xxmx_scm_po_rcpt_ext_dbi.sql
--**
...
--**
--** PURPOSE   :  This script installs the XXMX_CORE DB Objects for the Maximise
...
--**   Vsn  Change Date  Changed By          Change Description
--** -----  -----------  ------------------  -------------------------------------------
--**   1.0  08-FEB-2023  Soundarya Kamatagi  Created PO Receipt STG tables for Maximise.
--** 
--**************************************************************************************
--**
...
PROMPT *****************************************************************************
PROMPT **
PROMPT ** Installing Extract Database Objects for Maximise PO Receipt Data Migration
PROMPT **
PROMPT *****************************************************************************
PROMPT
PROMPT
...
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_RCPT_HDR_EXT
PROMPT
--
EXEC DropTable('XXMX_SCM_PO_RCPT_HDR_EXT')
--
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_RCPT_TXN_EXT								
PROMPT
--
EXEC DropTable('XXMX_SCM_PO_RCPT_TXN_EXT')
--
PROMPT
PROMPT
PROMPT ******************
...
PROMPT
PROMPT Creating Table XXMX_SCM_PO_RCPT_HDR_EXT
PROMPT
--
...
-- ***************************
CREATE TABLE XXMX_CORE.XXMX_SCM_PO_RCPT_HDR_EXT
   (
    ...
    NOTICE_CREATION_DATE                          VARCHAR2(20),
    ...
    EXPECTED_RECEIPT_DATE	                      VARCHAR2(20),
    ...
    CONVERSION_RATE_DATE                          VARCHAR2(20),
    ...
    RA_DOC_REVISION_DATE                          VARCHAR2(20),
    RA_DOC_CREATION_DATE                          VARCHAR2(20),
    RA_DOC_LAST_UPDATE_DATE                       VARCHAR2(20),
  ...
  ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_RCPT_HDR_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_RCPT_HDR_STG.csv'
       )
    )
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_RCPT_TXN_EXT
PROMPT
--
...
-- ******************************
CREATE TABLE XXMX_CORE.XXMX_SCM_PO_RCPT_TXN_EXT
   (
	    FILE_SET_ID                                     VARCHAR2(30),
	    MIGRATION_SET_ID                                NUMBER,
	    MIGRATION_SET_NAME                              VARCHAR2(100),
  ...
  ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_RCPT_TXN_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_RCPT_TXN_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
