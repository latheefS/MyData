...
--**   1.4  25-OCT-2023  Sinchana Ramesh     Added new columns.
...
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_HEADERS_STD_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_HEADERS_STD_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_LINES_STD_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINES_STD_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_LINE_LOCATIONS_STD_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINE_LOCATIONS_STD_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_DISTRIBUTIONS_STD_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_DISTRIBUTIONS_STD_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_HEADERS_BPA_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_HEADERS_BPA_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_LINES_BPA_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINES_BPA_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_LINE_LOCATIONS_BPA_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINE_LOCATIONS_BPA_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_ATTR_VALUES_BPA_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_ATTR_VALUES_BPA_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_HEADERS_CPA_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_HEADERS_CPA_STG')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_GA_ORG_ASSIGN_CPA_STG
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_GA_ORG_ASSIGN_CPA_STG')
--
--
PROMPT
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_HEADERS_STD_STG
PROMPT
--
...
-- **********************
CREATE TABLE XXMX_STG.XXMX_SCM_PO_HEADERS_STD_STG
(
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_LINES_STD_STG
PROMPT
--
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_LINE_LOCATIONS_STD_STG
PROMPT
--
...
LOAD_BATCH                       VARCHAR2(300),      
GLOBAL_ATTRIBUTE1                VARCHAR2(150),        
GLOBAL_ATTRIBUTE_NUMBER1         NUMBER(20)       
);

--
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_DISTRIBUTIONS_STD_STG
PROMPT
--  
...
-- ****************************
CREATE TABLE  XXMX_STG.XXMX_SCM_PO_DISTRIBUTIONS_STD_STG
(
FILE_SET_ID                         VARCHAR2(30),   
MIGRATION_SET_ID                    NUMBER,
MIGRATION_SET_NAME                  VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_HEADERS_BPA_STG
PROMPT
--  
...
-- **********************
CREATE TABLE XXMX_STG.XXMX_SCM_PO_HEADERS_BPA_STG
(
FILE_SET_ID                             VARCHAR2(30),
MIGRATION_SET_ID                        NUMBER,
MIGRATION_SET_NAME                      VARCHAR2(100),
...
PO_HEADER_ID                            NUMBER,
LOAD_BATCH                              VARCHAR2(300),
USE_ORDER_DATE_IN_PRICING_FLAG          VARCHAR2(1)    
);

--
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_LINES_BPA_STG
PROMPT
--
...
-- **BPA PO Lines Table
-- ********************
CREATE TABLE  XXMX_STG.XXMX_SCM_PO_LINES_BPA_STG
(
FILE_SET_ID                       VARCHAR2(30), 
MIGRATION_SET_ID                  NUMBER,
MIGRATION_SET_NAME                VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_LINE_LOCATIONS_BPA_STG
PROMPT
--
...
-- *****************************
CREATE TABLE  XXMX_STG.XXMX_SCM_PO_LINE_LOCATIONS_BPA_STG
(
FILE_SET_ID                                       VARCHAR2(30), 
MIGRATION_SET_ID                                  NUMBER,
MIGRATION_SET_NAME                                VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_STG
PROMPT
--
...
-- ***************************
CREATE TABLE  XXMX_STG.XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_STG
(
FILE_SET_ID                                      VARCHAR2(30),  
MIGRATION_SET_ID                                 NUMBER,
MIGRATION_SET_NAME                               VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_ATTR_VALUES_BPA_STG
PROMPT
--
...
-- ****************************
CREATE TABLE  XXMX_STG.XXMX_SCM_PO_ATTR_VALUES_BPA_STG
(
FILE_SET_ID                                      VARCHAR2(30),  
MIGRATION_SET_ID                                 NUMBER,
MIGRATION_SET_NAME                               VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_STG
PROMPT
--
...
-- ***************************************
CREATE TABLE  XXMX_STG.XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_STG
(
FILE_SET_ID                                      VARCHAR2(30),  
MIGRATION_SET_ID                                 NUMBER,
MIGRATION_SET_NAME                               VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_HEADERS_CPA_STG
PROMPT
--
...
-- **********************
CREATE TABLE XXMX_STG.XXMX_SCM_PO_HEADERS_CPA_STG
(
FILE_SET_ID                                      VARCHAR2(30),
MIGRATION_SET_ID                                 NUMBER,
MIGRATION_SET_NAME                               VARCHAR2(100),
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_GA_ORG_ASSIGN_CPA_STG
PROMPT
--
