...
--**
--**
--** FILENAME  :  xxmx_scm_po_ext_dbi.sql
--**
...
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_HEADERS_STD_EXT
PROMPT
--
EXEC DropTable('XXMX_SCM_PO_HEADERS_STD_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_LINES_STD_EXT
PROMPT
--
EXEC DropTable('XXMX_SCM_PO_LINES_STD_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_LINE_LOCATIONS_STD_EXT
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINE_LOCATIONS_STD_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_DISTRIBUTIONS_STD_EXT
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_DISTRIBUTIONS_STD_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_HEADERS_BPA_EXT
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_HEADERS_BPA_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_LINES_BPA_EXT
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINES_BPA_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_LINE_LOCATIONS_BPA_EXT
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_LINE_LOCATIONS_BPA_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_EXT
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_ATTR_VALUES_BPA_EXT
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_ATTR_VALUES_BPA_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_EXT
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_HEADERS_CPA_EXT
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_HEADERS_CPA_EXT')
--
--
PROMPT
PROMPT Dropping Table XXMX_SCM_PO_GA_ORG_ASSIGN_CPA_EXT
PROMPT
--
EXEC DropTable ('XXMX_SCM_PO_GA_ORG_ASSIGN_CPA_EXT')
--
--
PROMPT
PROMPT
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_HEADERS_STD_EXT
PROMPT
--
...
-- **********************
CREATE TABLE XXMX_SCM_PO_HEADERS_STD_EXT
	(
	...
	ATTRIBUTE_DATE4							VARCHAR2(30),
	ATTRIBUTE_DATE5							VARCHAR2(30),
	ATTRIBUTE_DATE6							VARCHAR2(30),
	ATTRIBUTE_DATE7							VARCHAR2(30),
	ATTRIBUTE_DATE8							VARCHAR2(30),
	ATTRIBUTE_DATE9							VARCHAR2(30),
	ATTRIBUTE_DATE10						VARCHAR2(30),
  ...
  ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_HEADERS_STD_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_HEADERS_STD_STG.csv'
       )
    )
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_LINES_STD_EXT
PROMPT
--
...
-- **STD PO Lines Table
-- ********************
CREATE TABLE  XXMX_SCM_PO_LINES_STD_EXT
    (
	FILE_SET_ID								VARCHAR2(30),	
	...
	UNIT_OF_MEASURE2                 VARCHAR2(25)
    )  
    ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_LINES_STD_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_LINES_STD_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_LINE_LOCATIONS_STD_EXT
PROMPT
--
...
-- *****************************
CREATE TABLE  XXMX_SCM_PO_LINE_LOCATIONS_STD_EXT
    (
	FILE_SET_ID								VARCHAR2(30),	
	...
	AMOUNT									NUMBER,
	QUANTITY								NUMBER,
	NEED_BY_DATE							VARCHAR2(30),
	PROMISED_DATE							VARCHAR2(30),
	SECONDARY_QUANTITY						NUMBER,
	SECONDARY_UNIT_OF_MEASURE				VARCHAR2(18),
	...
	REQUESTED_SHIP_DATE						VARCHAR2(30),
	PROMISED_SHIP_DATE						VARCHAR2(30),
	REQUESTED_DELIVERY_DATE					VARCHAR2(30),
	PROMISED_DELIVERY_DATE					VARCHAR2(30),
    ...
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_LINE_LOCATIONS_STD_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_LINE_LOCATIONS_STD_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_DISTRIBUTIONS_STD_EXT
PROMPT
--	
...
-- ****************************
CREATE TABLE  XXMX_SCM_PO_DISTRIBUTIONS_STD_EXT
    (
	FILE_SET_ID								VARCHAR2(30),	
	...
	TASK									VARCHAR2(100),
	PJC_EXPENDITURE_ITEM_DATE				VARCHAR2(30),
    ...
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_DISTRIBUTIONS_STD_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_DISTRIBUTIONS_STD_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_HEADERS_BPA_EXT
PROMPT
--	
...
-- **********************
CREATE TABLE XXMX_SCM_PO_HEADERS_BPA_EXT
	(
	FILE_SET_ID										VARCHAR2(30),
	INTERFACE_HEADER_KEY							VARCHAR2(50),
	ACTION											VARCHAR2(25),
	...
	BILLING_CYCLE_CLOSING_DATE						VARCHAR2(30),
    ...
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_HEADERS_BPA_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_HEADERS_BPA_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_LINES_BPA_EXT
PROMPT
--
...
-- **BPA PO Lines Table
-- ********************
CREATE TABLE  XXMX_SCM_PO_LINES_BPA_EXT
    (
	FILE_SET_ID										VARCHAR2(30),	
	INTERFACE_LINE_KEY								VARCHAR2(50),
	INTERFACE_HEADER_KEY							VARCHAR2(50),	
    ...
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_LINES_BPA_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_LINES_BPA_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_LINE_LOCATIONS_BPA_EXT
PROMPT
--
...
-- *****************************
CREATE TABLE  XXMX_SCM_PO_LINE_LOCATIONS_BPA_EXT
    (
	FILE_SET_ID										VARCHAR2(30),	
	INTERFACE_LINE_LOCATION_KEY						VARCHAR2(50),
	INTERFACE_LINE_KEY								VARCHAR2(50),
  ...
  ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_LINE_LOCATIONS_BPA_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_LINE_LOCATIONS_BPA_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;    
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_EXT
PROMPT
--
...
-- ***************************
CREATE TABLE  XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_EXT
    (
	FILE_SET_ID										VARCHAR2(30),	
    ...
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_GA_ORG_ASSIGN_BPA_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_ATTR_VALUES_BPA_EXT
PROMPT
--
...
-- ****************************
CREATE TABLE  XXMX_SCM_PO_ATTR_VALUES_BPA_EXT
    (
	FILE_SET_ID										VARCHAR2(30),	
    ...
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_ATTR_VALUES_BPA_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_ATTR_VALUES_BPA_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_EXT
PROMPT
--
...
-- ***************************************
CREATE TABLE  XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_EXT
    (
	FILE_SET_ID										VARCHAR2(30),	
	INTERFACE_ATTRIBUTE_KEY							VARCHAR2(50),
	INTERFACE_LINE_KEY								VARCHAR2(50),
    ...
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_ATTR_VALUES_TLP_BPA_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_HEADERS_CPA_EXT
PROMPT
--
...
-- **********************
CREATE TABLE XXMX_SCM_PO_HEADERS_CPA_EXT
	(
	FILE_SET_ID										VARCHAR2(30),
	INTERFACE_HEADER_KEY							VARCHAR2(50),	
	ACTION											VARCHAR2(25),
    ...
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_HEADERS_CPA_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_HEADERS_CPA_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
...
--
PROMPT
PROMPT Creating Table XXMX_SCM_PO_GA_ORG_ASSIGN_CPA_EXT
PROMPT
--
...
-- ***************************
CREATE TABLE  XXMX_SCM_PO_GA_ORG_ASSIGN_CPA_EXT
    (
	FILE_SET_ID										VARCHAR2(30),	
	INTERFACE_BU_ASSIGNMENT_KEY						VARCHAR2(50),
	INTERFACE_HEADER_KEY							VARCHAR2(50),
    ...
    ( TYPE ORACLE_LOADER
      DEFAULT DIRECTORY "SOURCE_DATAFILE"
      ACCESS PARAMETERS
      ( records delimited by newline skip 1 logfile 'XXMX_SCM_PO_GA_ORG_ASSIGN_CPA_STG.log' fields terminated by "," optionally enclosed by '"' missing field values are null )
      LOCATION
       ( 'XXMX_SCM_PO_GA_ORG_ASSIGN_CPA_STG.csv'
       )
    )
   REJECT LIMIT UNLIMITED 
  PARALLEL 5 ;
