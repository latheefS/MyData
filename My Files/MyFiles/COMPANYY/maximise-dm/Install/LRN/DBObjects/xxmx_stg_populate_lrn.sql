...
pt_i_Application=> 'LRN',
pt_i_BusinessEntity=> 'LEARNING',
pt_i_SubEntity=> 'NON_CATALOG_LEARNING_ITEM_TRASNLATION',
pt_import_data_file_name => 'XXMX_OLC_NONCAT_LEARN_TL_STG.dat',
pt_control_file_name => 'XXMX_OLC_NONCAT_LEARN_TL_STG.ctl',
pt_control_file_delimiter => '|',
pv_o_ReturnStatus=> pv_o_ReturnStatus);
