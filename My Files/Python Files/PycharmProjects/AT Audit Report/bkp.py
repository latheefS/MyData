...
try:
    ...
    purpose_heading = doc.add_heading('1.1 Purpose ', level=2)
    ...
    Scope_heading=doc.add_heading('2.Scope', level=1)
    ...
    doc.add_heading('2.1 Test Scenarios ', level=2)
    ...
    doc.add_heading('2.1.1 Scenario Scope (Regression and Targeted Tests)', level=2)
    ...
    chart_heading = doc.add_heading('3.Test Overview', level=1)
    ...
    tf_heading=doc.add_heading('3.1 Tests not executed', level=2)
    ...
    doc.add_heading('3.2 Tools and processes', level=2)
    ...
    doc.add_heading('3.3 Environment set up and testing approach', level=2)
    ...
    doc.add_heading('3.4 Test execution entry criteria', level=2)
    ...
    doc.add_heading('3.5 Test execution exit criteria', level=2)
    ...
    doc.add_heading('3.6 Evidence of Regression Test Completion', level=2)
    ...
    doc.add_heading('4.Defects', level=1)
    # chart_heading.style.font.name = 'Verdana'
    # chart_heading.style.font.size = Pt(16)
    # chart_heading.style.font.bold = True
    # chart_heading.style.font.color.rgb = docx.shared.RGBColor(0, 182, 181)
    ...
    doc.add_heading('4.1 Failed tests', level=2)
    doc.add_heading('4.2 Defect Status Summary', level=2)

    doc.add_heading('5.Communications', level=1)
    ...
    doc.add_heading('6.1 Issues and Recommended Actions', level=2)

    doc.save('AT Report.docx')
