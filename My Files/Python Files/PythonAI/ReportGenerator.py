...
try:
    ...
    #csv_file_path = r'C:\Users\LatheefS\Pictures\Maximise\audit-report\input\x_ve1_maximise_test_results.csv'
    ...
    #doc = Document(r'C:\Users\LatheefS\Pictures\Maximise\audit-report\input\AT_Report_Template.docx')
    input_doc_path = os.environ.get('inputTemplate')
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    print("Progress 4")
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    ...
    output_pie_path = os.environ.get('outputPieChart')
    print(output_pie_path)
    piechart_image_path = output_pie_path
    ...
    #bargraph_image_path = r'C:\Users\LatheefS\Pictures\Maximise\audit-report\output\bar_chart.png'
    output_bar_path = os.environ.get('outputBarChart')
    print(output_bar_path)
    bargraph_image_path = output_bar_path
    ...
    promptreply = CallOpenAi.output1
    ...
    #doc.save(r'C:\Users\LatheefS\Pictures\Maximise\audit-report\output\AT_Audit_Report.docx')
    output_doc_path = os.environ.get('outputFile')
